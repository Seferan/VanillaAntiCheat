...
public class BlockBaseRailLogic
{
    ...
    {
        return BlockRailBase.isRailBlockAt(this.field_94516_b, par1ChunkPosition.x, par1ChunkPosition.y, par1ChunkPosition.z) ? new BlockBaseRailLogic(this.theRail, this.field_94516_b, par1ChunkPosition.x, par1ChunkPosition.y, par1ChunkPosition.z) : (BlockRailBase.isRailBlockAt(this.field_94516_b, par1ChunkPosition.x, par1ChunkPosition.y + 1, par1ChunkPosition.z) ? new BlockBaseRailLogic(this.theRail, this.field_94516_b, par1ChunkPosition.x, par1ChunkPosition.y + 1, par1ChunkPosition.z) : (BlockRailBase.isRailBlockAt(this.field_94516_b, par1ChunkPosition.x, par1ChunkPosition.y - 1, par1ChunkPosition.z) ? new BlockBaseRailLogic(this.theRail, this.field_94516_b, par1ChunkPosition.x, par1ChunkPosition.y - 1, par1ChunkPosition.z) : null));
    }
    ...
    private void connectToNeighbor(BlockBaseRailLogic par1BlockBaseRailLogic)
    {
        ...
        if (var6 == 0)
        {
            if (BlockRailBase.isRailBlockAt(this.field_94516_b, this.railX, this.railY + 1, this.railZ - 1))
            {
                var6 = 4;
            }
        ...
        if (var6 == 1)
        {
            if (BlockRailBase.isRailBlockAt(this.field_94516_b, this.railX + 1, this.railY + 1, this.railZ))
            {
                var6 = 2;
            }
        ...
        if (this.isStraightRail)
        {
            var7 = this.field_94516_b.getBlockMetadata(this.railX, this.railY, this.railZ) & 8 | var6;
        }

        this.field_94516_b.setBlockMetadata(this.railX, this.railY, this.railZ, var7, 3);
    }
    ...
    public void func_94511_a(boolean par1, boolean par2)
    {
        ...
        if (this.isStraightRail)
        {
            var8 = this.field_94516_b.getBlockMetadata(this.railX, this.railY, this.railZ) & 8 | var7;
        }

        if (par2 || this.field_94516_b.getBlockMetadata(this.railX, this.railY, this.railZ) != var8)
        {
            this.field_94516_b.setBlockMetadata(this.railX, this.railY, this.railZ, var8, 3);
