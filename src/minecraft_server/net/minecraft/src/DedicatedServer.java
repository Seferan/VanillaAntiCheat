...
public class DedicatedServer extends MinecraftServer implements IServer
{
    ...
    protected boolean startServer() throws IOException
    {
        ...
        var1.setDaemon(true);
        var1.start();
        this.getLogAgent().func_98233_a("Starting minecraft server version 1.5.1");
        this.getLogAgent().func_98233_a("This server is running VanillaAntiCheat version " + VanillaAntiCheat.version);
