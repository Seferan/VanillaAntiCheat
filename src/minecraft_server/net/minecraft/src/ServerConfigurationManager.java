...
import tk.afffsdd.vanillaanticheat.hooks.HookEntityPlayerMP;
...
public abstract class ServerConfigurationManager
{
    ...
    public EntityPlayerMP createPlayerForUser(String par1Str)
    {
        ...
        return new HookEntityPlayerMP(this.mcServer, this.mcServer.worldServerForDimension(0), par1Str, (ItemInWorldManager)var6);
    }
    ...
    public EntityPlayerMP recreatePlayerEntity(EntityPlayerMP par1EntityPlayerMP, int par2, boolean par3)
    {
        ...
        EntityPlayerMP var7 = new HookEntityPlayerMP(this.mcServer, this.mcServer.worldServerForDimension(par1EntityPlayerMP.dimension), par1EntityPlayerMP.username, (ItemInWorldManager)var6);
