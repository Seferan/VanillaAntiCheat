                ...
                else
                {
                    ...
                    if (var16 != null)
                    {
                        ...
                        if (var17 == null)
                        {
                            ...
                            {
                                var21 = par2 == 0 ? var20.stackSize : 1;
                ...
                if (var17 != null && (var16 == null || !var16.getHasStack() || !var16.canTakeStack(par4EntityPlayer)))
                {
                    ...
                    for (int var19 = 0; var19 < 2; ++var19)
                    {
                        for (int var22 = var9; var22 >= 0 && var22 < this.inventorySlots.size() && var17.stackSize < var17.getMaxStackSize(); var22 += var21)
                        {
                            ...
                            if (var24.getHasStack() && func_94527_a(var24, var17, true) && var24.canTakeStack(par4EntityPlayer) && this.func_94530_a(var17, var24) && (var19 != 0 || var24.getStack().stackSize != var24.getStack().getMaxStackSize()))
                            {
