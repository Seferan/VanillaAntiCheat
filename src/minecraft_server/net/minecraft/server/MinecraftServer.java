...
import tk.afffsdd.servermods.hooks.HookDedicatedServer;
import tk.afffsdd.servermods.hooks.HookServerCommandManager;
...
public abstract class MinecraftServer implements ICommandSender, Runnable, IPlayerUsage
{
    ...
    /** Determines whether the level of restriction for greentexting.
     * 0 = off, 1 = admins only, 2 = everybody
     */
    private int greentextRestrictionLevel;
    
    /** Determines whether the level of restriction for using all characters in chat.
     * 0 = off, 1 = admins only, 2 = everybody
     */
    private int allCharactersRestrictionLevel;
    ...
    public MinecraftServer(File par1File)
    {
        ...
        this.commandManager = new HookServerCommandManager();
    ...
    public static void main(String[] par0ArrayOfStr)
    {
        ...
        try
        {
            ...
            DedicatedServer var16 = new HookDedicatedServer(new File(var4));
    ...
    public int getGreentextRestrictionLevel()
    {
		return greentextRestrictionLevel;
	}
    
    public void setGreentextRestrictionLevel(int par1)
    {
    	greentextRestrictionLevel = par1;
    }
    
	public int getAllCharactersRestrictionLevel()
	{
		return allCharactersRestrictionLevel;
	}
    
	public void setAllCharactersRestrictionLevel(int par1)
	{
		allCharactersRestrictionLevel = par1;
	}
