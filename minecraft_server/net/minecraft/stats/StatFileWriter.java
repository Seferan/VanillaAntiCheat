...
public class StatFileWriter
{
    ...
    {
        return func_77444_a(p_77443_1_) > 0;
    }

    public boolean func_77442_b(Achievement p_77442_1_)
    {
        return p_77442_1_.parentAchievement == null || func_77443_a(p_77442_1_.parentAchievement);
    }

    public void func_150871_b(EntityPlayer p_150871_1_, StatBase p_150871_2_, int p_150871_3_)
    {
        if (!p_150871_2_.func_75967_d() || func_77442_b((Achievement)p_150871_2_))
        {
            func_150873_a(p_150871_1_, p_150871_2_, func_77444_a(p_150871_2_) + p_150871_3_);
        }
    }
