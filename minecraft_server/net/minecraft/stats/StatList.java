...
public class StatList
{
    ...
    public static StatBase distanceWalkedStat = (new StatBasic(
            "stat.walkOneCm", new ChatComponentTranslation("stat.walkOneCm",
    ...
    public static StatBase distanceFallenStat = (new StatBasic(
            "stat.fallOneCm", new ChatComponentTranslation("stat.fallOneCm",
                    new Object[0]), StatBase.distanceStatType))
            .initIndependentStat().registerStat();
    ...
    public static StatBase distanceByBoatStat = (new StatBasic(
            "stat.boatOneCm", new ChatComponentTranslation("stat.boatOneCm",
                    new Object[0]), StatBase.distanceStatType))
            .initIndependentStat().registerStat();
        ...
        while (var0.hasNext())
        {
            ...
            if (var1 != null)
            {
                ...
                objectUseStats[var2] = (new StatCrafting(
                        "stat.useItem." + var2, new ChatComponentTranslation(
                                "stat.useItem", new Object[] {(new ItemStack(
                                        var1)).func_151000_E()}), var1))
                        .registerStat();
    ...
    private static void replaceAllSimilarBlocks(StatBase[] par0ArrayOfStatBase)
    {
        ...
        func_151180_a(par0ArrayOfStatBase, Blocks.lit_redstone_ore,
                Blocks.redstone_ore);
        func_151180_a(par0ArrayOfStatBase, Blocks.powered_repeater,
                Blocks.unpowered_repeater);
        func_151180_a(par0ArrayOfStatBase, Blocks.powered_comparator,
                Blocks.unpowered_comparator);
        func_151180_a(par0ArrayOfStatBase, Blocks.redstone_torch,
                Blocks.unlit_redstone_torch);
        func_151180_a(par0ArrayOfStatBase, Blocks.lit_redstone_lamp,
                Blocks.redstone_lamp);
        func_151180_a(par0ArrayOfStatBase, Blocks.red_mushroom,
                Blocks.brown_mushroom);
        func_151180_a(par0ArrayOfStatBase, Blocks.double_stone_slab,
                Blocks.stone_slab);
        func_151180_a(par0ArrayOfStatBase, Blocks.double_wooden_slab,
                Blocks.wooden_slab);
    ...
    public static StatBase func_151176_b(EntityList.EntityEggInfo p_151176_0_)
    {
        ...
        return var1 == null ? null : (new StatBase("stat.entityKilledBy."
                + var1, new ChatComponentTranslation("stat.entityKilledBy",
                new Object[] {new ChatComponentTranslation("entity." + var1
