...
public class NetHandlerHandshakeTCP implements INetHandlerHandshakeServer
{
    ...
    public void processHandshake(C00Handshake p_147383_1_)
    {
        ...
        case 1:
            ...
            if (p_147383_1_.func_149595_d() > 4)
            {
                var2 = new ChatComponentText(
                        "Outdated server! I\'m still on 1.7.2");
                this.field_147386_b.scheduleOutboundPacket(
                        new S00PacketDisconnect(var2),
            ...
            {
                var2 = new ChatComponentText(
                        "Outdated client! Please use 1.7.2");
                this.field_147386_b.scheduleOutboundPacket(
                        new S00PacketDisconnect(var2),
                        new GenericFutureListener[0]);
                this.field_147386_b.closeChannel(var2);
            ...
            {
                this.field_147386_b.setNetHandler(new NetHandlerLoginServer(
                        this.field_147387_a, this.field_147386_b));
            }
        ...
        case 2:
            ...
            this.field_147386_b.setNetHandler(new NetHandlerStatusServer(
                    this.field_147387_a, this.field_147386_b));
            break;
            ...
            EnumConnectionState p_147232_2_)
    {
        if (p_147232_2_ != EnumConnectionState.LOGIN
                && p_147232_2_ != EnumConnectionState.STATUS) { throw new UnsupportedOperationException(
                "Invalid state " + p_147232_2_); }
    }
