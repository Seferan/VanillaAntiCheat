...
public class NetHandlerHandshakeTCP implements INetHandlerHandshakeServer
{
    ...
    public void processHandshake(C00Handshake p_147383_1_)
    {
        ...
        case 1:
            ...
            if (p_147383_1_.func_149595_d() > 4)
            {
                ...
                field_147386_b.scheduleOutboundPacket(new S00PacketDisconnect(var2), new GenericFutureListener[0]);
    ...
    {
        if (p_147232_2_ != EnumConnectionState.LOGIN && p_147232_2_ != EnumConnectionState.STATUS) { throw new UnsupportedOperationException("Invalid state " + p_147232_2_); }
    }
