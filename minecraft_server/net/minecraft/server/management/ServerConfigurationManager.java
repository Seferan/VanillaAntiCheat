...
public abstract class ServerConfigurationManager
{
    ...
    private final BanList bannedPlayers = new BanList(new File(
            "banned-players.txt"));
    ...
    public void initializeConnectionToPlayer(
            NetworkManager par1INetworkManager,
            EntityPlayerMP par2EntityPlayerMP)
    {
        NBTTagCompound var3 = this.readPlayerDataFromFile(par2EntityPlayerMP);
        par2EntityPlayerMP.setWorld(this.mcServer
                .worldServerForDimension(par2EntityPlayerMP.dimension));
        par2EntityPlayerMP.theItemInWorldManager
                .setWorld((WorldServer)par2EntityPlayerMP.worldObj);
        String var4 = "local";
        ...
        logger.info(par2EntityPlayerMP.getCommandSenderName() + "[" + var4
                + "] logged in with entity id "
                + par2EntityPlayerMP.getEntityId() + " at ("
                + par2EntityPlayerMP.posX + ", " + par2EntityPlayerMP.posY
                + ", " + par2EntityPlayerMP.posZ + ")");
        WorldServer var5 = this.mcServer
                .worldServerForDimension(par2EntityPlayerMP.dimension);
        ChunkCoordinates var6 = var5.getSpawnPoint();
        this.func_72381_a(par2EntityPlayerMP, (EntityPlayerMP)null, var5);
        NetHandlerPlayServer var7 = new NetHandlerPlayServer(this.mcServer,
                par1INetworkManager, par2EntityPlayerMP);
        var7.sendPacket(new S01PacketJoinGame(par2EntityPlayerMP.getEntityId(),
                par2EntityPlayerMP.theItemInWorldManager.getGameType(), var5
                        .getWorldInfo().isHardcoreModeEnabled(),
                var5.provider.dimensionId, var5.difficultySetting, this
                        .getMaxPlayers(), var5.getWorldInfo().getTerrainType()));
        var7.sendPacket(new S3FPacketCustomPayload("MC|Brand", this
                .getServerInstance().getServerModName()
                .getBytes(Charsets.UTF_8)));
        var7.sendPacket(new S05PacketSpawnPosition(var6.posX, var6.posY,
                var6.posZ));
        var7.sendPacket(new S39PacketPlayerAbilities(
                par2EntityPlayerMP.capabilities));
        var7.sendPacket(new S09PacketHeldItemChange(
                par2EntityPlayerMP.inventory.currentItem));
        par2EntityPlayerMP.func_147099_x().func_150877_d();
        par2EntityPlayerMP.func_147099_x().func_150884_b(par2EntityPlayerMP);
        this.func_96456_a((ServerScoreboard)var5.getScoreboard(),
                par2EntityPlayerMP);
        this.mcServer.func_147132_au();
        ChatComponentTranslation var8 = new ChatComponentTranslation(
                "multiplayer.player.joined",
                new Object[] {par2EntityPlayerMP.getUsernameAsIChatComponent()});
        var8.getChatStyle().setColor(EnumChatFormatting.YELLOW);
        this.func_148539_a(var8);
        this.playerLoggedIn(par2EntityPlayerMP);
        var7.setPlayerLocation(par2EntityPlayerMP.posX,
        ...
        while (var9.hasNext())
        {
            ...
            var7.sendPacket(new S1DPacketEntityEffect(par2EntityPlayerMP
                    .getEntityId(), var10));
        }
        ...
        {
            Entity var11 = EntityList.createEntityFromNBT(
                    var3.getCompoundTag("Riding"), var5);
    ...
    protected void func_96456_a(ServerScoreboard par1ServerScoreboard,
            EntityPlayerMP par2EntityPlayerMP)
    {
        ...
        while (var4.hasNext())
        {
            ...
            par2EntityPlayerMP.playerNetServerHandler
                    .sendPacket(new S3EPacketTeams(var5, 0));
        }
    ...
    {
        this.playerNBTManagerObj = par1ArrayOfWorldServer[0].getSaveHandler()
                .getPlayerNBTManager();
    }
            ...
            WorldServer par2WorldServer)
    {
        ...
        var3.theChunkProviderServer.loadChunk(
                (int)par1EntityPlayerMP.posX >> 4,
                (int)par1EntityPlayerMP.posZ >> 4);
    }
     ...
     */
    public NBTTagCompound readPlayerDataFromFile(
            EntityPlayerMP par1EntityPlayerMP)
    {
        NBTTagCompound var2 = this.mcServer.worldServers[0].getWorldInfo()
    ...
    protected void writePlayerData(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        StatisticsFile var2 = (StatisticsFile)this.field_148547_k
                .get(par1EntityPlayerMP.getCommandSenderName());
    ...
    {
        this.sendPacketToAllPlayers(new S38PacketPlayerListItem(
                par1EntityPlayerMP.getCommandSenderName(), true, 1000));
        ...
        {
            EntityPlayerMP var4 = (EntityPlayerMP)this.playerEntityList
                    .get(var3);
        ...
        if (mcServer.shouldTellIp())
        {
            ...
            MinecraftServer.anonymousTell(par1EntityPlayerMP,
                    "Welcome! Your external IP appears to be: " + ip);
            MinecraftServer
                    .anonymousTell(par1EntityPlayerMP,
     ...
     * cart, boat)
     */
    public void serverUpdateMountedMovingPlayer(
            EntityPlayerMP par1EntityPlayerMP)
    {
        par1EntityPlayerMP.getServerForPlayer().getPlayerManager()
                .updateMountedMovingPlayer(par1EntityPlayerMP);
    }
    ...
    public void playerLoggedOut(EntityPlayerMP par1EntityPlayerMP)
    {
        ...
        this.sendPacketToAllPlayers(new S38PacketPlayerListItem(
                par1EntityPlayerMP.getCommandSenderName(), false, 9999));
    }
            ...
            GameProfile p_148542_2_)
    {
        ...
        {
            BanEntry var6 = (BanEntry)this.bannedPlayers.getBannedList().get(
                    p_148542_2_.getName());
            ...
            if (var6.getBanEndDate() != null)
            {
                var7 = var7 + "\nYour ban will be removed on "
                        + dateFormat.format(var6.getBanEndDate());
            }
        ...
        else
        {
            ...
            {
                BanEntry var4 = (BanEntry)this.bannedIPs.getBannedList().get(
                        var3);
                ...
                {
                    var5 = var5 + "\nYour ban will be removed on "
                            + dateFormat.format(var4.getBanEndDate());
                }
            ...
            {
                return this.playerEntityList.size() >= this.maxPlayers ? "The server is full!"
                        : null;
            }
        }
    }
    ...
    public EntityPlayerMP func_148545_a(GameProfile p_148545_1_)
    {
        ...
        for (int var3 = 0; var3 < this.playerEntityList.size(); ++var3)
        {
            ...
            if (var4.getCommandSenderName().equalsIgnoreCase(
                    p_148545_1_.getName()))
            {
                var2.add(var4);
            }
        ...
        return new EntityPlayerMP(this.mcServer,
                this.mcServer.worldServerForDimension(0), p_148545_1_,
    ...
    public EntityPlayerMP recreatePlayerEntity(
            EntityPlayerMP par1EntityPlayerMP, int par2, boolean par3)
    {
        par1EntityPlayerMP.getServerForPlayer().getEntityTracker()
                .removePlayerFromTrackers(par1EntityPlayerMP);
        par1EntityPlayerMP.getServerForPlayer().getEntityTracker()
        ...
        EntityPlayerMP var7 = new EntityPlayerMP(this.mcServer,
                this.mcServer
                        .worldServerForDimension(par1EntityPlayerMP.dimension),
                par1EntityPlayerMP.getGameProfile(), (ItemInWorldManager)var6);
        ...
        WorldServer var8 = this.mcServer
                .worldServerForDimension(par1EntityPlayerMP.dimension);
        ...
        if (var4 != null)
        {
            var9 = EntityPlayer.verifyRespawnCoordinates(this.mcServer
                    .worldServerForDimension(par1EntityPlayerMP.dimension),
                    var4, var5);

            if (var9 != null)
            {
                var7.setLocationAndAngles((double)((float)var9.posX + 0.5F),
            ...
            int par2)
    {
        ...
        WorldServer var4 = this.mcServer
                .worldServerForDimension(par1EntityPlayerMP.dimension);
        par1EntityPlayerMP.dimension = par2;
        WorldServer var5 = this.mcServer
                .worldServerForDimension(par1EntityPlayerMP.dimension);
        par1EntityPlayerMP.playerNetServerHandler
                .sendPacket(new S07PacketRespawn(par1EntityPlayerMP.dimension,
                        par1EntityPlayerMP.worldObj.difficultySetting,
                        par1EntityPlayerMP.worldObj.getWorldInfo()
                                .getTerrainType(),
        ...
        par1EntityPlayerMP.playerNetServerHandler.setPlayerLocation(
                par1EntityPlayerMP.posX, par1EntityPlayerMP.posY,
                par1EntityPlayerMP.posZ, par1EntityPlayerMP.rotationYaw,
        ...
        while (var6.hasNext())
        {
            ...
            par1EntityPlayerMP.playerNetServerHandler
                    .sendPacket(new S1DPacketEntityEffect(par1EntityPlayerMP
                            .getEntityId(), var7));
        }
    }
     ...
     */
    public void transferEntityToWorld(Entity par1Entity, int par2,
            WorldServer par3WorldServer, WorldServer par4WorldServer)
    {
        ...
        if (par1Entity.dimension == -1)
        {
            var5 /= var9;
            var7 /= var9;
            par1Entity.setLocationAndAngles(var5, par1Entity.posY, var7,
                    par1Entity.rotationYaw, par1Entity.rotationPitch);

            if (par1Entity.isEntityAlive())
            {
                par3WorldServer
                        .updateEntityWithOptionalForce(par1Entity, false);
            }
        }
        ...
        else
        {
            ...
            par1Entity.setLocationAndAngles(var5, par1Entity.posY, var7, 90.0F,
                    0.0F);
        ...
        if (par2 != 1)
        {
            ...
            if (par1Entity.isEntityAlive())
            {
                par1Entity.setLocationAndAngles(var5, par1Entity.posY, var7,
                        par1Entity.rotationYaw, par1Entity.rotationPitch);
                par4WorldServer.getDefaultTeleporter().placeInPortal(
                        par1Entity, var11, var13, var15, var17);
    ...
    public void onTick()
    {
        ...
        {
            EntityPlayerMP var1 = (EntityPlayerMP)this.playerEntityList
                    .get(this.playerPingIndex);
            this.sendPacketToAllPlayers(new S38PacketPlayerListItem(var1
                    .getCommandSenderName(), true, var1.ping));
        }
    }
    ...
    public void sendPacketToAllPlayers(Packet p_148540_1_)
    {
        ...
        {
            ((EntityPlayerMP)this.playerEntityList.get(var2)).playerNetServerHandler
    ...
    public String getPlayerListAsString()
    {
        ...
        for (int var2 = 0; var2 < this.playerEntityList.size(); ++var2)
        {
            ...
            var1 = var1
                    + ((EntityPlayerMP)this.playerEntityList.get(var2))
    ...
    public String[] getAllUsernames()
    {
        ...
        for (int var2 = 0; var2 < this.playerEntityList.size(); ++var2)
        {
            var1[var2] = ((EntityPlayerMP)this.playerEntityList.get(var2))
                    .getCommandSenderName();
        }
    ...
    public boolean isAllowedToLogin(String par1Str)
    {
        ...
        return !this.whiteListEnforced || this.ops.contains(par1Str)
    ...
    {
        return this.owners.contains(name.trim().toLowerCase())
                || this.isPlayerPossibleOp(name);
    }
    ...
    {
        return this.mcServer.isSinglePlayer()
                && this.mcServer.worldServers[0].getWorldInfo()
                        .areCommandsAllowed()
                && this.mcServer.getServerOwner().equalsIgnoreCase(name)
     ...
     * parameters
     */
    public List findPlayers(ChunkCoordinates par1ChunkCoordinates, int par2,
            int par3, int par4, int par5, int par6, int par7, Map par8Map,
            String par9Str, String par10Str, World par11World)
    {
        ...
        else
        {
            ...
            {
                EntityPlayerMP var19 = (EntityPlayerMP)this.playerEntityList
                        .get(var18);

                if ((par11World == null || var19.worldObj == par11World)
                        && (par9Str == null || var14 != par9Str
                                .equalsIgnoreCase(var19.getCommandSenderName())))
                {
                    if (par10Str != null)
                    {
                        Team var20 = var19.getTeam();
                        String var21 = var20 == null ? "" : var20
                                .getRegisteredName();
                    ...
                    {
                        float var22 = par1ChunkCoordinates
                                .getDistanceSquaredToChunkCoordinates(var19
                                        .getCommandSenderPosition());

                        if (par2 > 0 && var22 < (float)var16 || par3 > 0
                                && var22 > (float)var17)
                        {
                            continue;
                        }
                    ...
                    if (this.func_96457_a(var19, par8Map)
                            && (par5 == WorldSettings.GameType.NOT_SET.getID() || par5 == var19.theItemInWorldManager
                                    .getGameType().getID())
                            && (par6 <= 0 || var19.experienceLevel >= par6)
                            && var19.experienceLevel <= par7)
                    {
    ...
    private boolean func_96457_a(EntityPlayer par1EntityPlayer, Map par2Map)
    {
        if (par2Map != null && par2Map.size() != 0)
        {
            ...
            do
            {
                ...
                Score var9 = par1EntityPlayer.getWorldScoreboard()
                        .func_96529_a(par1EntityPlayer.getCommandSenderName(),
                                var8);
    ...
    public void func_148541_a(double p_148541_1_, double p_148541_3_,
            ...
            Packet p_148541_10_)
    {
        this.func_148543_a((EntityPlayer)null, p_148541_1_, p_148541_3_,
            ...
            int p_148543_10_, Packet p_148543_11_)
    {
        ...
        {
            EntityPlayerMP var13 = (EntityPlayerMP)this.playerEntityList
                    .get(var12);
    ...
    public void saveAllPlayerData()
    {
        ...
        {
            this.writePlayerData((EntityPlayerMP)this.playerEntityList
                    .get(var1));
        }
    }
    ...
    {
        par1EntityPlayerMP.playerNetServerHandler
                .sendPacket(new S03PacketTimeUpdate(par2WorldServer
                        .getTotalWorldTime(), par2WorldServer.getWorldTime(),
                        par2WorldServer.getGameRules().getGameRuleBooleanValue(
                                "doDaylightCycle")));
        ...
        if (par2WorldServer.isRaining())
        {
            ...
            par1EntityPlayerMP.playerNetServerHandler
                    .sendPacket(new S2BPacketChangeGameState(7, par2WorldServer
                            .getRainStrength(1.0F)));
            par1EntityPlayerMP.playerNetServerHandler
                    .sendPacket(new S2BPacketChangeGameState(8, par2WorldServer
    ...
    {
        par1EntityPlayerMP
                .sendContainerToPlayer(par1EntityPlayerMP.inventoryContainer);
    ...
    {
        return this.mcServer.worldServers[0].getSaveHandler()
                .getPlayerNBTManager().getAvailablePlayerDat();
    }
    ...
    private void func_72381_a(EntityPlayerMP par1EntityPlayerMP,
            EntityPlayerMP par2EntityPlayerMP, World par3World)
    {
        if (par2EntityPlayerMP != null)
        {
            par1EntityPlayerMP.theItemInWorldManager
                    .setGameType(par2EntityPlayerMP.theItemInWorldManager
                            .getGameType());
        }
        ...
        par1EntityPlayerMP.theItemInWorldManager.initializeGameType(par3World
     ...
     * @param p_148544_2_
     */
    public void sendChatMessageToAllPlayersAndLog(IChatComponent p_148544_1_,
            boolean p_148544_2_)
    {
    ...
    {
        this.sendChatMessageToAllPlayersAndLog(p_148539_1_, true);
    }
    ...
    public StatisticsFile func_148538_i(String p_148538_1_)
    {
        ...
        if (var2 == null)
        {
            var2 = new StatisticsFile(this.mcServer, new File(this.mcServer
                    .worldServerForDimension(0).getSaveHandler()
                    .getWorldDirectory(), "stats/" + p_148538_1_ + ".json"));
            var2.func_150882_a();
