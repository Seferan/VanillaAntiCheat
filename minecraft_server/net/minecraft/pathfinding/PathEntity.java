...
public class PathEntity
{
    ...
    public boolean isSamePath(PathEntity par1PathEntity)
    {
        ...
        else
        {
            ...
            {
                if (this.points[var2].xCoord != par1PathEntity.points[var2].xCoord || this.points[var2].yCoord != par1PathEntity.points[var2].yCoord || this.points[var2].zCoord != par1PathEntity.points[var2].zCoord) { return false; }
            }
