...
public class PathFinder
{
    ...
    public PathEntity createEntityPathTo(Entity par1Entity, int par2, int par3,
            int par4, float par5)
    {
        return this.createEntityPathTo(par1Entity,
            ...
            double par4, double par6, float par8)
    {
        ...
        if (this.canEntityDrown && par1Entity.isInWater())
        {
            ...
            for (Block var11 = this.worldMap.getBlock(
                    MathHelper.floor_double(par1Entity.posX), var10,
                    MathHelper.floor_double(par1Entity.posZ)); var11 == Blocks.flowing_water
        ...
        PathPoint var13 = new PathPoint(
                ...
                MathHelper.floor_float(par1Entity.width + 1.0F));
        PathEntity var14 = this
                .addToPath(par1Entity, var15, var12, var13, par8);
            ...
            PathPoint par3PathPoint, PathPoint par4PathPoint, float par5)
    {
        ...
        while (!this.path.isPathEmpty())
        {
            ...
            if (var7.equals(par3PathPoint)) { return this.createEntityPath(
                    par2PathPoint, par3PathPoint); }
            ...
            var7.isFirst = true;
            int var8 = this.findPathOptions(par1Entity, var7, par4PathPoint,
                    par3PathPoint, par5);
            ...
            for (int var9 = 0; var9 < var8; ++var9)
            {
                ...
                if (!var10.isAssigned() || var11 < var10.totalPathDistance)
                {
                    ...
                    if (var10.isAssigned())
                    {
                        this.path.changeDistance(var10, var10.totalPathDistance
            ...
            PathPoint par3PathPoint, PathPoint par4PathPoint, float par5)
    {
        ...
        if (this.getVerticalOffset(par1Entity, par2PathPoint.xCoord,
                par2PathPoint.yCoord + 1, par2PathPoint.zCoord, par3PathPoint) == 1)
        {
            var7 = 1;
        }

        PathPoint var8 = this.getSafePoint(par1Entity, par2PathPoint.xCoord,
                par2PathPoint.yCoord, par2PathPoint.zCoord + 1, par3PathPoint,
                var7);
        PathPoint var9 = this.getSafePoint(par1Entity,
                par2PathPoint.xCoord - 1, par2PathPoint.yCoord,
                par2PathPoint.zCoord, par3PathPoint, var7);
        PathPoint var10 = this.getSafePoint(par1Entity,
                par2PathPoint.xCoord + 1, par2PathPoint.yCoord,
                par2PathPoint.zCoord, par3PathPoint, var7);
        PathPoint var11 = this.getSafePoint(par1Entity, par2PathPoint.xCoord,
                par2PathPoint.yCoord, par2PathPoint.zCoord - 1, par3PathPoint,
                var7);
    ...
    {
        PathPoint var7 = null;
        int var8 = this.getVerticalOffset(par1Entity, par2, par3, par4,
                par5PathPoint);
        ...
        else
        {
            ...
            if (var7 == null
                    ...
                    && var8 != -3
                    && var8 != -4
                    && this.getVerticalOffset(par1Entity, par2, par3 + par6,
            ...
            if (var7 != null)
            {
                ...
                while (par3 > 0)
                {
                    var10 = this.getVerticalOffset(par1Entity, par2, par3 - 1,
                            par4, par5PathPoint);

                    if (this.isPathingInWater && var10 == -1) { return null; }
    ...
    {
        return func_82565_a(par1Entity, par2, par3, par4, par5PathPoint,
                this.isPathingInWater, this.isMovementBlockAllowed,
                this.isWoddenDoorAllowed);
    }

    public static int func_82565_a(Entity par0Entity, int par1, int par2,
            int par3, PathPoint par4PathPoint, boolean par5, boolean par6,
            boolean par7)
    {
        boolean var8 = false;
        ...
        for (int var9 = par1; var9 < par1 + par4PathPoint.xCoord; ++var9)
        {
            for (int var10 = par2; var10 < par2 + par4PathPoint.yCoord; ++var10)
            {
                ...
                {
                    Block var12 = par0Entity.worldObj.getBlock(var9, var10,
                            var11);
                    ...
                    if (var12.getMaterial() != Material.air)
                    {
                        ...
                        if (par0Entity.worldObj.getBlock(var9, var10, var11)
                                .getRenderType() == 9)
                        {
                            int var17 = MathHelper
                                    .floor_double(par0Entity.posX);
                            int var15 = MathHelper
                                    .floor_double(par0Entity.posY);
                            int var16 = MathHelper
                                    .floor_double(par0Entity.posZ);

                            if (par0Entity.worldObj.getBlock(var17, var15,
                                    var16).getRenderType() != 9
                                    && par0Entity.worldObj.getBlock(var17,
                                            var15 - 1, var16).getRenderType() != 9) { return -3; }
                        }
                        else if (!var12.getBlocksMovement(par0Entity.worldObj,
                                var9, var10, var11)
                                && (!par6 || var12 != Blocks.wooden_door))
                        {
