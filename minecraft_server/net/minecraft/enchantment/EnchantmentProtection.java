...
public class EnchantmentProtection extends Enchantment
{
    ...
    private static final String[] protectionName = new String[] {"all", "fire",
            "fall", "explosion", "projectile"};
     ...
     */
    private static final int[] thresholdEnchantability = new int[] {20, 12, 10,
            12, 15};
    ...
    {
        return baseEnchantability[this.protectionType] + (par1 - 1)
                * levelEnchantability[this.protectionType];
    }
    ...
    public int getMaxEnchantability(int par1)
    {
        return this.getMinEnchantability(par1)
                + thresholdEnchantability[this.protectionType];
    }
    ...
    public int calcModifierDamage(int par1, DamageSource par2DamageSource)
    {
        ...
        else
        {
            ...
            return this.protectionType == 0 ? MathHelper
                    .floor_float(var3 * 0.75F) : (this.protectionType == 1
                    && par2DamageSource.isFireDamage() ? MathHelper
                    .floor_float(var3 * 1.25F) : (this.protectionType == 2
                    && par2DamageSource == DamageSource.fall ? MathHelper
                    .floor_float(var3 * 2.5F) : (this.protectionType == 3
                    && par2DamageSource.isExplosion() ? MathHelper
                    .floor_float(var3 * 1.5F) : (this.protectionType == 4
                    && par2DamageSource.isProjectile() ? MathHelper
    ...
    {
        int var2 = EnchantmentHelper.getMaxEnchantmentLevel(
    ...
    {
        int var3 = EnchantmentHelper
                .getMaxEnchantmentLevel(Enchantment.blastProtection.effectId,
                        par0Entity.getInventory());

        if (var3 > 0)
        {
            par1 -= (double)MathHelper.floor_double(par1
                    * (double)((float)var3 * 0.15F));
        }
