    ...
    static void func_151353_a()
    {
        ...
        BlockDispenser.field_149943_a.putObject(Items.potionitem, new IBehaviorDispenseItem()
        {
            ...
            public ItemStack dispense(IBlockSource par1IBlockSource, final ItemStack par2ItemStack)
            {
                ...
                }).dispense(par1IBlockSource, par2ItemStack) : field_150843_b.dispense(par1IBlockSource, par2ItemStack);
            }
        });
        ...
        BlockDispenser.field_149943_a.putObject(Items.boat, new BehaviorDefaultDispenseItem()
        {
            ...
            public ItemStack dispenseStack(IBlockSource par1IBlockSource, ItemStack par2ItemStack)
            {
                ...
                {
                    if (!Material.air.equals(var14) || !Material.field_151586_h.equals(var4.getBlock(var11, var12 - 1, var13).getMaterial())) { return field_150842_b.dispense(par1IBlockSource, par2ItemStack); }
        ...
        BehaviorDefaultDispenseItem var0 = new BehaviorDefaultDispenseItem()
        {
            ...
            public ItemStack dispenseStack(IBlockSource par1IBlockSource, ItemStack par2ItemStack)
            {
                ...
                {
                    return field_150841_b.dispense(par1IBlockSource, par2ItemStack);
                }
            }
        };
        ...
        BlockDispenser.field_149943_a.putObject(Items.bucket, new BehaviorDefaultDispenseItem()
        {
            ...
            public ItemStack dispenseStack(IBlockSource par1IBlockSource, ItemStack par2ItemStack)
            {
                ...
                {
                    if (!Material.field_151587_i.equals(var8) || var9 != 0) { return super.dispenseStack(par1IBlockSource, par2ItemStack); }
                ...
                {
                    field_150840_b.dispense(par1IBlockSource, new ItemStack(var10));
                }
