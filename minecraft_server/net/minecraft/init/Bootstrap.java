...
public class Bootstrap
{
    ...
    {
        BlockDispenser.field_149943_a.putObject(Items.arrow,
                new BehaviorProjectileDispense()
                {
                    private static final String __OBFID = "CL_00001398";

                    protected IProjectile getProjectileEntity(World par1World,
                            IPosition par2IPosition)
                    {
                        EntityArrow var3 = new EntityArrow(par1World,
        ...
        BlockDispenser.field_149943_a.putObject(Items.egg,
                new BehaviorProjectileDispense()
                {
                    ...
                    protected IProjectile getProjectileEntity(World par1World,
                            IPosition par2IPosition)
                    {
                        return new EntityEgg(par1World, par2IPosition.getX(),
                                par2IPosition.getY(), par2IPosition.getZ());
                    }
                });
        BlockDispenser.field_149943_a.putObject(Items.snowball,
                new BehaviorProjectileDispense()
                {
                    ...
                    protected IProjectile getProjectileEntity(World par1World,
                            IPosition par2IPosition)
                    {
                        return new EntitySnowball(par1World, par2IPosition
                                .getX(), par2IPosition.getY(), par2IPosition
                                .getZ());
                    }
                });
        BlockDispenser.field_149943_a.putObject(Items.experience_bottle,
                new BehaviorProjectileDispense()
                {
                    ...
                    protected IProjectile getProjectileEntity(World par1World,
                            IPosition par2IPosition)
                    {
                        return new EntityExpBottle(par1World, par2IPosition
                                .getX(), par2IPosition.getY(), par2IPosition
                                .getZ());
                    }
        ...
        BlockDispenser.field_149943_a.putObject(Items.potionitem,
                new IBehaviorDispenseItem()
                {
                    ...
                    {
                        return ItemPotion.isSplash(par2ItemStack
                                .getItemDamage()) ? (new BehaviorProjectileDispense()
                        {
                            ...
                            {
                                return new EntityPotion(par1World,
                                        par2IPosition.getX(), par2IPosition
                                                .getY(), par2IPosition.getZ(),
                                        par2ItemStack.copy());
                            }
                        ...
                        }).dispense(par1IBlockSource, par2ItemStack)
                                : this.field_150843_b.dispense(
                                        par1IBlockSource, par2ItemStack);
                    }
                });
        BlockDispenser.field_149943_a.putObject(Items.spawn_egg,
                new BehaviorDefaultDispenseItem()
                {
                    private static final String __OBFID = "CL_00001410";

                    public ItemStack dispenseStack(
                            IBlockSource par1IBlockSource,
                            ItemStack par2ItemStack)
                    {
                        EnumFacing var3 = BlockDispenser
                                .func_149937_b(par1IBlockSource
                                        .getBlockMetadata());
                        double var4 = par1IBlockSource.getX()
                                + (double)var3.getFrontOffsetX();
                        double var6 = (double)((float)par1IBlockSource
                                .getYInt() + 0.2F);
                        double var8 = par1IBlockSource.getZ()
                                + (double)var3.getFrontOffsetZ();
                        Entity var10 = ItemMonsterPlacer.spawnCreature(
                                par1IBlockSource.getWorld(),
                                par2ItemStack.getItemDamage(), var4, var6, var8);

                        if (var10 instanceof EntityLivingBase
                                && par2ItemStack.hasDisplayName())
                        {
                            ((EntityLiving)var10)
                                    .setCustomNameTag(par2ItemStack
                                            .getDisplayName());
                        }
        ...
        BlockDispenser.field_149943_a.putObject(Items.fireworks,
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            ItemStack par2ItemStack)
                    {
                        ...
                        double var8 = par1IBlockSource.getZ()
                                + (double)var3.getFrontOffsetZ();
                        EntityFireworkRocket var10 = new EntityFireworkRocket(
                                par1IBlockSource.getWorld(), var4, var6, var8,
                                par2ItemStack);
                    ...
                    protected void playDispenseSound(
                            IBlockSource par1IBlockSource)
                    {
        ...
        BlockDispenser.field_149943_a.putObject(Items.fire_charge,
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            ItemStack par2ItemStack)
                    {
                        EnumFacing var3 = BlockDispenser
                                .func_149937_b(par1IBlockSource
                                        .getBlockMetadata());
                        IPosition var4 = BlockDispenser
                                .func_149939_a(par1IBlockSource);
                        double var5 = var4.getX()
                                + (double)((float)var3.getFrontOffsetX() * 0.3F);
                        double var7 = var4.getY()
                                + (double)((float)var3.getFrontOffsetX() * 0.3F);
                        double var9 = var4.getZ()
                                + (double)((float)var3.getFrontOffsetZ() * 0.3F);
                        World var11 = par1IBlockSource.getWorld();
                        Random var12 = var11.rand;
                        double var13 = var12.nextGaussian() * 0.05D
                                + (double)var3.getFrontOffsetX();
                        double var15 = var12.nextGaussian() * 0.05D
                                + (double)var3.getFrontOffsetY();
                        double var17 = var12.nextGaussian() * 0.05D
                                + (double)var3.getFrontOffsetZ();
        ...
        BlockDispenser.field_149943_a.putObject(Items.boat,
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            ItemStack par2ItemStack)
                    {
                        ...
                        double var5 = par1IBlockSource.getX()
                                + (double)((float)var3.getFrontOffsetX() * 1.125F);
                        double var7 = par1IBlockSource.getY()
                                + (double)((float)var3.getFrontOffsetY() * 1.125F);
                        double var9 = par1IBlockSource.getZ()
                                + (double)((float)var3.getFrontOffsetZ() * 1.125F);
                        int var11 = par1IBlockSource.getXInt()
                                + var3.getFrontOffsetX();
                        int var12 = par1IBlockSource.getYInt()
                                + var3.getFrontOffsetY();
                        int var13 = par1IBlockSource.getZInt()
                                + var3.getFrontOffsetZ();
                        Material var14 = var4.getBlock(var11, var12, var13)
                                .getMaterial();
                        double var15;
                        ...
                        else
                        {
                            if (!Material.air.equals(var14)
                                    || !Material.field_151586_h.equals(var4
                                            .getBlock(var11, var12 - 1, var13)
                                            .getMaterial())) { return this.field_150842_b
                                    .dispense(par1IBlockSource, par2ItemStack); }

                            var15 = 0.0D;
                        }

                        EntityBoat var17 = new EntityBoat(var4, var5, var7
                                + var15, var9);
        ...
        BehaviorDefaultDispenseItem var0 = new BehaviorDefaultDispenseItem()
        {
                    ...
                    ItemStack par2ItemStack)
            {
                ...
                EnumFacing var7 = BlockDispenser.func_149937_b(par1IBlockSource
                        .getBlockMetadata());

                if (var3.tryPlaceContainedLiquid(par1IBlockSource.getWorld(),
                        var4 + var7.getFrontOffsetX(),
                ...
                {
                    return this.field_150841_b.dispense(par1IBlockSource,
                            par2ItemStack);
                }
            }
        };
        ...
        BlockDispenser.field_149943_a.putObject(Items.bucket,
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            ItemStack par2ItemStack)
                    {
                        EnumFacing var3 = BlockDispenser
                                .func_149937_b(par1IBlockSource
                                        .getBlockMetadata());
                        World var4 = par1IBlockSource.getWorld();
                        int var5 = par1IBlockSource.getXInt()
                                + var3.getFrontOffsetX();
                        int var6 = par1IBlockSource.getYInt()
                                + var3.getFrontOffsetY();
                        int var7 = par1IBlockSource.getZInt()
                                + var3.getFrontOffsetZ();
                        Material var8 = var4.getBlock(var5, var6, var7)
                                .getMaterial();
                        ...
                        {
                            if (!Material.field_151587_i.equals(var8)
                                    || var9 != 0) { return super.dispenseStack(
                                    par1IBlockSource, par2ItemStack); }
                        ...
                        else if (((TileEntityDispenser)par1IBlockSource
                                .getBlockTileEntity())
                                .func_146019_a(new ItemStack(var10)) < 0)
                        {
                            this.field_150840_b.dispense(par1IBlockSource,
                                    new ItemStack(var10));
                        }
        ...
        BlockDispenser.field_149943_a.putObject(Items.flint_and_steel,
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            IBlockSource par1IBlockSource)
                    {
                        ...
                        {
                            par1IBlockSource.getWorld().playAuxSFX(1001,
                                    par1IBlockSource.getXInt(),
                                    par1IBlockSource.getYInt(),
                                    par1IBlockSource.getZInt(), 0);
                        }
        ...
        BlockDispenser.field_149943_a.putObject(Items.dye,
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            ItemStack par2ItemStack)
                    {
                        if (par2ItemStack.getItemDamage() == 15)
                        {
                            ...
                            if (ItemDye.func_150919_a(par2ItemStack, var4,
                                    var5, var6, var7))
                            {
                                if (!var4.isClient)
                                {
                        ...
                        {
                            return super.dispenseStack(par1IBlockSource,
                                    par2ItemStack);
                        }
                    }
        ...
        BlockDispenser.field_149943_a.putObject(
                ...
                new BehaviorDefaultDispenseItem()
                {
                            ...
                            ItemStack par2ItemStack)
                    {
                        ...
                        int var7 = par1IBlockSource.getZInt()
                                + var3.getFrontOffsetZ();
                        EntityTNTPrimed var8 = new EntityTNTPrimed(var4,
