        ...
        BehaviorDefaultDispenseItem
{
            ...
            ItemStack par2ItemStack)
    {
        ...
        EnumFacing var5 = BlockDispenser.func_149937_b(par1IBlockSource
                .getBlockMetadata());
        IProjectile var6 = this.getProjectileEntity(var3, var4);
        var6.setThrowableHeading((double)var5.getFrontOffsetX(),
                (double)((float)var5.getFrontOffsetY() + 0.1F),
                (double)var5.getFrontOffsetZ(), this.func_82500_b(),
                this.func_82498_a());
     ...
     */
    protected abstract IProjectile getProjectileEntity(World var1,
            IPosition var2);
