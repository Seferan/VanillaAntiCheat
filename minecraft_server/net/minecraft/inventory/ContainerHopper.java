...
public class ContainerHopper extends Container
{
    ...
    public ContainerHopper(InventoryPlayer par1InventoryPlayer,
            IInventory par2IInventory)
    {
        ...
        {
            this.addSlotToContainer(new Slot(par2IInventory, var4,
                    44 + var4 * 18, 20));
        }
        ...
        for (var4 = 0; var4 < 3; ++var4)
        {
            for (int var5 = 0; var5 < 9; ++var5)
            {
                this.addSlotToContainer(new Slot(par1InventoryPlayer, var5
                        + var4 * 9 + 9, 8 + var5 * 18, var4 * 18 + var3));
            }
        }
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (var4 != null && var4.getHasStack())
        {
            ...
            else if (!this.mergeItemStack(var5, 0,
                    this.field_94538_a.getSizeInventory(), false)) { return null; }
