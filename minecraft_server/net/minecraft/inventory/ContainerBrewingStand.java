...
public class ContainerBrewingStand extends Container
{
    ...
    public ContainerBrewingStand(InventoryPlayer par1InventoryPlayer, TileEntityBrewingStand par2TileEntityBrewingStand)
    {
        ...
        addSlotToContainer(new ContainerBrewingStand.Potion(par1InventoryPlayer.player, par2TileEntityBrewingStand, 0, 56, 46));
        addSlotToContainer(new ContainerBrewingStand.Potion(par1InventoryPlayer.player, par2TileEntityBrewingStand, 1, 79, 53));
        addSlotToContainer(new ContainerBrewingStand.Potion(par1InventoryPlayer.player, par2TileEntityBrewingStand, 2, 102, 46));
        theSlot = addSlotToContainer(new ContainerBrewingStand.Ingredient(par2TileEntityBrewingStand, 3, 79, 17));
        int var3;
    ...
    public void onCraftGuiOpened(ICrafting par1ICrafting)
    {
        ...
        par1ICrafting.sendProgressBarUpdate(this, 0, tileBrewingStand.func_145935_i());
    }
    ...
    public void detectAndSendChanges()
    {
        ...
        for (int var1 = 0; var1 < crafters.size(); ++var1)
        {
            ...
            {
                var2.sendProgressBarUpdate(this, 0, tileBrewingStand.func_145935_i());
            }
        }
