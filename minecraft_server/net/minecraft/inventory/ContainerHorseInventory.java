...
public class ContainerHorseInventory extends Container
{
    ...
    public ContainerHorseInventory(IInventory par1IInventory, final IInventory par2IInventory, final EntityHorse par3EntityHorse)
    {
        ...
        theHorse = par3EntityHorse;
        byte var4 = 3;
        par2IInventory.openChest();
        int var5 = (var4 - 4) * 18;
        addSlotToContainer(new Slot(par2IInventory, 0, 8, 18)
        {
            private static final String __OBFID = "CL_00001752";

            public boolean isItemValid(ItemStack par1ItemStack)
            {
                return super.isItemValid(par1ItemStack) && par1ItemStack.getItem() == Items.saddle && !getHasStack();
            }
        });
        addSlotToContainer(new Slot(par2IInventory, 1, 8, 36)
        {
    ...
    {
        return field_111243_a.isUseableByPlayer(par1EntityPlayer) && theHorse.isEntityAlive() && theHorse.getDistanceToEntity(par1EntityPlayer) < 8.0F;
    }
