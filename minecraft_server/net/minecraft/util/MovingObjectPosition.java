...
public class MovingObjectPosition
{
            ...
            boolean p_i45481_6_)
    {
        ...
        this.hitVec = p_i45481_5_.myVec3LocalPool.getVecFromPool(
                p_i45481_5_.xCoord, p_i45481_5_.yCoord, p_i45481_5_.zCoord);
    }

    public MovingObjectPosition(Entity par1Entity)
    {
        this(par1Entity, par1Entity.worldObj.getWorldVec3Pool().getVecFromPool(
    ...
    {
        return "HitResult{type=" + this.typeOfHit + ", x=" + this.blockX
                + ", y=" + this.blockY + ", z=" + this.blockZ + ", f="
                + this.sideHit + ", pos=" + this.hitVec + ", entity="
                + this.entityHit + '}';
    }
