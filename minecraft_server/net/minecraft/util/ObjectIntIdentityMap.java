...
{
    private TIntIntHashMap field_148749_a = new TIntIntHashMap(256, 0.5F, -1,
            -1);
    ...
    {
        this.field_148749_a.put(System.identityHashCode(p_148746_1_),
                p_148746_2_);
    ...
    {
        return p_148745_1_ >= 0 && p_148745_1_ < this.field_148748_b.size() ? this.field_148748_b
                .get(p_148745_1_) : null;
    }

    public Iterator iterator()
    {
        return Iterators.filter(this.field_148748_b.iterator(),
                Predicates.notNull());
    }
