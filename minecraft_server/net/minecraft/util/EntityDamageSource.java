...
public class EntityDamageSource extends DamageSource
{
    ...
    {
        ItemStack var2 = this.damageSourceEntity instanceof EntityLivingBase ? ((EntityLivingBase)this.damageSourceEntity)
                .getHeldItem() : null;
        ...
        return var2 != null && var2.hasDisplayName()
                ...
                var4, new Object[] {p_151519_1_.getUsernameAsIChatComponent(),
                        this.damageSourceEntity.getUsernameAsIChatComponent(),
                        var2.func_151000_E()}) : new ChatComponentTranslation(
                var3, new Object[] {p_151519_1_.getUsernameAsIChatComponent(),
                        this.damageSourceEntity.getUsernameAsIChatComponent()});
    }
