...
public class TileEntityBrewingStand extends TileEntity implements ISidedInventory
{
    ...
    {
        return isInventoryNameLocalized() ? field_145942_n : "container.brewing";
    }
    ...
    public void updateEntity()
    {
        ...
        int var1 = func_145939_j();

        if (var1 != field_145943_l)
        {
            field_145943_l = var1;
            worldObj.setBlockMetadata(xCoord, yCoord, zCoord, var1, 2);
        }
    ...
    private boolean func_145934_k()
    {
        ...
        {
            ItemStack var1 = field_145945_j[3];
            ...
            else
            {
                ...
                {
                    if (field_145945_j[var3] != null && field_145945_j[var3].getItem() == Items.potionitem)
                    {
                        int var4 = field_145945_j[var3].getItemDamage();
    ...
    private void func_145940_l()
    {
        if (func_145934_k())
        {
            ...
            {
                if (field_145945_j[var2] != null && field_145945_j[var2].getItem() == Items.potionitem)
                {
                    int var3 = field_145945_j[var2].getItemDamage();
            ...
            {
                field_145945_j[3] = new ItemStack(var1.getItem().getContainerItem());
            }
            else
            {
    ...
    {
        return par1 >= 0 && par1 < field_145945_j.length ? field_145945_j[par1] : null;
    }
    ...
    {
        if (par1 >= 0 && par1 < field_145945_j.length)
        {
            ItemStack var3 = field_145945_j[par1];
            field_145945_j[par1] = null;
            return var3;
        }
        else
        {
    ...
    public ItemStack getStackInSlotOnClosing(int par1)
    {
        if (par1 >= 0 && par1 < field_145945_j.length)
        {
            ItemStack var2 = field_145945_j[par1];
            field_145945_j[par1] = null;
            return var2;
        }
        else
    ...
    public void setInventorySlotContents(int par1, ItemStack par2ItemStack)
    {
        if (par1 >= 0 && par1 < field_145945_j.length)
        {
            field_145945_j[par1] = par2ItemStack;
        }
    }
