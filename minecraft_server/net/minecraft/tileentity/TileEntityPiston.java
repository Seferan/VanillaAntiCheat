...
public class TileEntityPiston extends TileEntity
{
    ...
    public float func_145860_a(float p_145860_1_)
    {
        ...
        return this.field_145870_n
                + (this.field_145873_m - this.field_145870_n) * p_145860_1_;
    }
    ...
    private void func_145863_a(float p_145863_1_, float p_145863_2_)
    {
        ...
        AxisAlignedBB var3 = Blocks.piston_extension.func_149964_a(
                this.worldObj, this.xCoord, this.yCoord, this.zCoord,
                this.field_145869_a, p_145863_1_, this.field_145874_j);
        ...
        if (var3 != null)
        {
            ...
            if (!var4.isEmpty())
            {
                ...
                while (var5.hasNext())
                {
                    ...
                    var6.moveEntity(
                            (double)(p_145863_2_ * (float)Facing.offsetsXForSide[this.field_145874_j]),
    ...
    public void func_145866_f()
    {
        if (this.field_145870_n < 1.0F && this.worldObj != null)
        {
            ...
            if (this.worldObj.getBlock(this.xCoord, this.yCoord, this.zCoord) == Blocks.piston_extension)
            {
                ...
                this.worldObj.func_147460_e(this.xCoord, this.yCoord,
                        this.zCoord, this.field_145869_a);
            }
        }
    }
    ...
    public void updateEntity()
    {
        ...
        else
        {
            ...
            if (this.field_145875_k)
            {
                this.func_145863_a(this.field_145873_m, this.field_145873_m
                        - this.field_145870_n + 0.0625F);
            }
        }
    }
    ...
    public void readFromNBT(NBTTagCompound p_145839_1_)
    {
        ...
        this.field_145869_a = Block.getBlockById(p_145839_1_
                .getInteger("blockId"));
        this.field_145876_i = p_145839_1_.getInteger("blockData");
        this.field_145874_j = p_145839_1_.getInteger("facing");
        this.field_145870_n = this.field_145873_m = p_145839_1_
                .getFloat("progress");
    ...
    public void writeToNBT(NBTTagCompound p_145841_1_)
    {
        ...
        p_145841_1_.setInteger("blockId",
                Block.getIdFromBlock(this.field_145869_a));
