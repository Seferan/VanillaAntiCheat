...
public class ItemEnderEye extends Item
{
            ...
            int par6, int par7, float par8, float par9, float par10)
    {
                ...
                && !BlockEndPortalFrame.func_150020_b(var12))
        {
            ...
            else
            {
                ...
                par3World.func_147453_f(par4, par5, par6,
                ...
                {
                    double var14 = (double)((float)par4 + (5.0F + itemRand
                            .nextFloat() * 6.0F) / 16.0F);
                    double var16 = (double)((float)par5 + 0.8125F);
                    double var18 = (double)((float)par6 + (5.0F + itemRand
                            .nextFloat() * 6.0F) / 16.0F);
                    double var20 = 0.0D;
                    double var22 = 0.0D;
                    double var24 = 0.0D;
                    par3World.spawnParticle("smoke", var14, var16, var18,
                            var20, var22, var24);
                }
                ...
                for (var19 = -2; var19 <= 2; ++var19)
                {
                    ...
                    {
                        if (!BlockEndPortalFrame.func_150020_b(par3World
                                .getBlockMetadata(var29, par5, var21)))
                        {
                            var17 = false;
                            break;
                        }
                ...
                if (var17 && var15 == var26 + 2)
                {
                    for (var19 = var26; var19 <= var15; ++var19)
                    {
                        ...
                        if (par3World.getBlock(var29, par5, var21) != Blocks.end_portal_frame
                                || !BlockEndPortalFrame.func_150020_b(par3World
                                        .getBlockMetadata(var29, par5, var21)))
                        {
                            var17 = false;
                            break;
                    ...
                    for (var19 = var26 - 1; var19 <= var15 + 1; var19 += 4)
                    {
                        for (var29 = 1; var29 <= 3; ++var29)
                        {
                            ...
                            if (par3World.getBlock(var21, par5, var30) != Blocks.end_portal_frame
                                    || !BlockEndPortalFrame
                                            .func_150020_b(par3World
                    ...
                    if (var17)
                    {
                        for (var19 = var26; var19 <= var15; ++var19)
                        {
                            for (var29 = 1; var29 <= 3; ++var29)
                            {
                                ...
                                var21 += Direction.offsetX[var13] * var29;
                                var30 += Direction.offsetZ[var13] * var29;
                                par3World.setBlock(var21, par5, var30,
            ...
            EntityPlayer par3EntityPlayer)
    {
        ...
        if (var4 != null
                ...
                && par2World.getBlock(var4.blockX, var4.blockY, var4.blockZ) == Blocks.end_portal_frame)
        {
        ...
        else
        {
            ...
            {
                ChunkPosition var5 = par2World.findClosestStructure(
                        "Stronghold", (int)par3EntityPlayer.posX,
                        (int)par3EntityPlayer.posY, (int)par3EntityPlayer.posZ);

                if (var5 != null)
                {
                    EntityEnderEye var6 = new EntityEnderEye(par2World,
                            par3EntityPlayer.posX, par3EntityPlayer.posY
                                    + 1.62D - (double)par3EntityPlayer.yOffset,
                            par3EntityPlayer.posZ);
                    var6.moveTowards((double)var5.chunkPosX, var5.chunkPosY,
                            (double)var5.chunkPosZ);
