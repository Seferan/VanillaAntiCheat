...
public class ItemMap extends ItemMapBase
{
    ...
    public MapData getMapData(ItemStack par1ItemStack, World par2World)
    {
        ...
        if (var4 == null && !par2World.isClient)
        {
            ...
            var4.xCenter = Math.round((float)par2World.getWorldInfo()
                    .getSpawnX() / (float)var5)
                    * var5;
            var4.zCenter = Math.round((float)(par2World.getWorldInfo()
                    .getSpawnZ() / var5)) * var5;
            ...
            MapData par3MapData)
    {
                ...
                && par2Entity instanceof EntityPlayer)
        {
            ...
            int var7 = MathHelper.floor_double(par2Entity.posX - (double)var5)
                    / var4 + 64;
            int var8 = MathHelper.floor_double(par2Entity.posZ - (double)var6)
                    / var4 + 64;
            int var9 = 128 / var4;
            ...
            MapData.MapInfo var10 = par3MapData
                    .func_82568_a((EntityPlayer)par2Entity);
            ++var10.field_82569_d;
                    ...
                    for (int var16 = var8 - var9 - 1; var16 < var8 + var9; ++var16)
                    {
                                ...
                                && var16 < 128)
                        {
                            ...
                            if (!var23.isEmpty())
                            {
                                ...
                                {
                                    byte var37 = par3MapData.colors[var11
                                            + var16 * 128];
    ...
    {
        byte[] var4 = this.getMapData(p_150911_1_, p_150911_2_)
            ...
            EntityPlayer par3EntityPlayer)
    {
        ...
        {
            MapData var4 = Items.filled_map
                    .getMapData(par1ItemStack, par2World);
            par1ItemStack.setItemDamage(par2World.getUniqueDataId("map"));
