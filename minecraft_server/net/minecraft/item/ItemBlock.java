...
public class ItemBlock extends Item
{
            ...
            int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else if (par3World.func_147472_a(this.field_150939_a, par4, par5, par6,
                false, par7, par2EntityPlayer, par1ItemStack))
        {
            int var12 = this.getMetadata(par1ItemStack.getItemDamage());
            int var13 = this.field_150939_a.onBlockPlaced(par3World, par4,
                    par5, par6, par7, par8, par9, par10, var12);

            if (par3World.setBlock(par4, par5, par6, this.field_150939_a,
                    var13, 3))
            {
                if (par3World.getBlock(par4, par5, par6) == this.field_150939_a)
                {
                    this.field_150939_a.onBlockPlacedBy(par3World, par4, par5,
                            par6, par2EntityPlayer, par1ItemStack);
                    this.field_150939_a.onPostBlockPlaced(par3World, par4,
                            par5, par6, var13);
                }
                ...
                par3World
                        .playSoundEffect(
                                ...
                                this.field_150939_a.stepSound.getFrequency() * 0.8F);
