...
public class ItemFishFood extends ItemFood
{
    ...
    {
        ItemFishFood.FishType var2 = ItemFishFood.FishType
                .func_150978_a(p_150905_1_);
        return this.field_150907_b && var2.func_150973_i() ? var2
                .func_150970_e() : var2.func_150975_c();
    }
    ...
    public float func_150906_h(ItemStack p_150906_1_)
    {
        ...
        return this.field_150907_b && var2.func_150973_i() ? var2
                .func_150977_f() : var2.func_150967_d();
    }
    ...
    {
        ItemFishFood.FishType var4 = ItemFishFood.FishType
                .func_150978_a(par1ItemStack);

        if (var4 == ItemFishFood.FishType.PUFFERFISH)
        {
            par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.poison.id,
                    1200, 3));
            par3EntityPlayer.addPotionEffect(new PotionEffect(Potion.hunger.id,
                    300, 2));
            par3EntityPlayer.addPotionEffect(new PotionEffect(
                    Potion.confusion.id, 300, 1));
        }
    ...
    public String getUnlocalizedName(ItemStack par1ItemStack)
    {
        ...
        return this.getUnlocalizedName()
                ...
                + var2.func_150972_b()
                + "."
                + (this.field_150907_b && var2.func_150973_i() ? "cooked"
                        : "raw");
    }

    public static enum FishType
    {
        COD("COD", 0, 0, "cod", 2, 0.1F, 5, 0.6F), SALMON("SALMON", 1, 1,
                "salmon", 2, 0.1F, 6, 0.8F), CLOWNFISH("CLOWNFISH", 2, 2,
                "clownfish", 1, 0.1F), PUFFERFISH("PUFFERFISH", 3, 3,
                "pufferfish", 1, 0.1F);
        ...
        private static final ItemFishFood.FishType[] $VALUES = new ItemFishFood.FishType[] {
                COD, SALMON, CLOWNFISH, PUFFERFISH};
        ...
        {
            ItemFishFood.FishType var1 = (ItemFishFood.FishType)field_150983_e
