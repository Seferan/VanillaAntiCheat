...
public class ItemTool extends Item
{
            ...
            Set p_i45333_3_)
    {
        ...
        this.efficiencyOnProperMaterial = p_i45333_2_
    ...
    {
        return this.field_150914_c.contains(p_150893_2_) ? this.efficiencyOnProperMaterial
                : 1.0F;
    }
    ...
    public Multimap getItemAttributeModifiers()
    {
        ...
        var1.put(SharedMonsterAttributes.attackDamage
                ...
                new AttributeModifier(field_111210_e, "Tool modifier",
