...
public class ItemSlab extends ItemBlock
{
            ...
            int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            {
                return this.func_150946_a(par1ItemStack, par2EntityPlayer,
                        par3World, par4, par5, par6, par7) ? true : super
                        .onItemUse(par1ItemStack, par2EntityPlayer, par3World,
                                par4, par5, par6, par7, par8, par9, par10);
            }
        }
    }
            ...
            int p_150946_5_, int p_150946_6_, int p_150946_7_)
    {
        ...
        Block var8 = p_150946_3_
                .getBlock(p_150946_4_, p_150946_5_, p_150946_6_);
        int var9 = p_150946_3_.getBlockMetadata(p_150946_4_, p_150946_5_,
                p_150946_6_);
        int var10 = var9 & 7;

        if (var8 == this.field_150949_c && var10 == p_150946_1_.getItemDamage())
        {
            if (p_150946_3_.checkNoEntityCollision(this.field_150947_d
                    ...
                    && p_150946_3_.setBlock(p_150946_4_, p_150946_5_,
                            p_150946_6_, this.field_150947_d, var10, 3))
            {
                p_150946_3_
                        .playSoundEffect(
                                ...
                                (this.field_150947_d.stepSound.getVolume() + 1.0F) / 2.0F,
                                this.field_150947_d.stepSound.getFrequency() * 0.8F);
