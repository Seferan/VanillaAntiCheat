        ...
        for (int var2 = 0; var2 < this.recipeItems[0].length; ++var2)
        {
            ...
            for (int var4 = 0; var4 < this.recipeItems.length - 1; ++var4)
            {
                ...
                par1CraftingManager.addRecipe(new ItemStack(var5),
                        new Object[] {this.recipePatterns[var4], '#',
                                Items.stick, 'X', var3});
            }
        }

        par1CraftingManager.addRecipe(new ItemStack(Items.bow, 1),
                new Object[] {" #X", "# X", " #X", 'X', Items.string, '#',
                        Items.stick});
        par1CraftingManager.addRecipe(new ItemStack(Items.arrow, 4),
                new Object[] {"X", "#", "Y", 'Y', Items.feather, 'X',
