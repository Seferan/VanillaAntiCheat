...
public class CommandSpreadPlayers extends CommandBase
{
            ...
            String[] par2ArrayOfStr)
    {
        ...
        else
        {
            byte var3 = 0;
            int var17 = var3 + 1;
            double var4 = func_110666_a(par1ICommandSender, Double.NaN,
                    par2ArrayOfStr[var3]);
            double var6 = func_110666_a(par1ICommandSender, Double.NaN,
                    par2ArrayOfStr[var17++]);
            double var8 = parseDoubleWithMin(par1ICommandSender,
                    par2ArrayOfStr[var17++], 0.0D);
            double var10 = parseDoubleWithMin(par1ICommandSender,
                    par2ArrayOfStr[var17++], var8 + 1.0D);
            boolean var12 = parseBoolean(par1ICommandSender,
                    par2ArrayOfStr[var17++]);
            ...
            while (true)
            {
                while (var17 < par2ArrayOfStr.length)
                {
                    ...
                    {
                        EntityPlayerMP[] var18 = PlayerSelector.matchPlayers(
                                par1ICommandSender, var14);
                    ...
                    {
                        EntityPlayerMP var15 = MinecraftServer.getServer()
                                .getConfigurationManager()
                                .getPlayerEntity(var14);
                ...
                this.func_110669_a(par1ICommandSender, var13,
                        new CommandSpreadPlayers.Position(var4, var6), var8,
                        var10, ((EntityLivingBase)var13.get(0)).worldObj, var12);
                return;
            }
        }
    }

    private void func_110669_a(ICommandSender par1ICommandSender,
            List par2List,
            CommandSpreadPlayers.Position par3CommandSpreadPlayersPosition,
            double par4, double par6, World par8World, boolean par9)
    {
        ...
        CommandSpreadPlayers.Position[] var19 = this.func_110670_a(var10,
                par9 ? this.func_110667_a(par2List) : par2List.size(), var11,
                var13, var15, var17);
        int var20 = this.func_110668_a(par3CommandSpreadPlayersPosition, par4,
                par8World, var10, var11, var13, var15, var17, var19, par9);
        ...
        notifyAdmins(
                ...
                "commands.spreadplayers.success."
                        + (par9 ? "teams" : "players"),
                new Object[] {
                        Integer.valueOf(var19.length),
                        Double.valueOf(par3CommandSpreadPlayersPosition.field_111101_a),
                        Double.valueOf(par3CommandSpreadPlayersPosition.field_111100_b)});

        if (var19.length > 1)
        {
            par1ICommandSender.addChatMessage(new ChatComponentTranslation(
                    "commands.spreadplayers.info."
                            + (par9 ? "teams" : "players"), new Object[] {
                            String.format("%.2f",
    ...
    private int func_110668_a(
            CommandSpreadPlayers.Position par1CommandSpreadPlayersPosition,
            double par2,
            World par4World,
            Random par5Random,
            double par6,
            ...
            double par10,
            double par12,
            CommandSpreadPlayers.Position[] par14ArrayOfCommandSpreadPlayersPosition,
            boolean par15)
    {
        boolean var16 = true;
        ...
        for (var17 = 0; var17 < 10000 && var16; ++var17)
        {
            ...
            for (int var20 = 0; var20 < par14ArrayOfCommandSpreadPlayersPosition.length; ++var20)
            {
                ...
                if (var22 > 0)
                {
                    ...
                    {
                        var21.func_111097_a(par5Random, par6, par8, par10,
                                par12);
                    }
            ...
            if (!var16)
            {
                ...
                for (var22 = 0; var22 < var29; ++var22)
                {
                    ...
                    {
                        var23.func_111097_a(par5Random, par6, par8, par10,
                                par12);
                        var16 = true;
                    }
                }
        ...
        if (var17 >= 10000)
        {
            throw new CommandException(
                    "commands.spreadplayers.failure."
                            + (par15 ? "teams" : "players"),
                    new Object[] {
                            Integer.valueOf(par14ArrayOfCommandSpreadPlayersPosition.length),
                            Double.valueOf(par1CommandSpreadPlayersPosition.field_111101_a),
                            Double.valueOf(par1CommandSpreadPlayersPosition.field_111100_b),
                            String.format("%.2f",
    ...
    private double func_110671_a(
            List par1List,
            World par2World,
            CommandSpreadPlayers.Position[] par3ArrayOfCommandSpreadPlayersPosition,
            boolean par4)
    {
        double var5 = 0.0D;
        int var7 = 0;
        ...
        for (int var9 = 0; var9 < par1List.size(); ++var9)
        {
            ...
            if (par4)
            {
                Team var12 = var10 instanceof EntityPlayer ? var10.getTeam()
                        : null;

                if (!var8.containsKey(var12))
                {
                    var8.put(var12,
                            par3ArrayOfCommandSpreadPlayersPosition[var7++]);
                }
            ...
            var10.setPositionAndUpdate((double)((float)MathHelper
                    .floor_double(var11.field_111101_a) + 0.5F), (double)var11
                    .func_111092_a(par2World), (double)MathHelper
                    .floor_double(var11.field_111100_b) + 0.5D);
            ...
            for (int var14 = 0; var14 < par3ArrayOfCommandSpreadPlayersPosition.length; ++var14)
            {
                ...
                {
                    double var15 = var11
                            .func_111099_a(par3ArrayOfCommandSpreadPlayersPosition[var14]);
    ...
    private CommandSpreadPlayers.Position[] func_110670_a(Random par1Random,
            int par2, double par3, double par5, double par7, double par9)
    {
    ...
    static class Position
    {
        ...
        double func_111099_a(
                CommandSpreadPlayers.Position par1CommandSpreadPlayersPosition)
        {
            double var2 = this.field_111101_a
                    - par1CommandSpreadPlayersPosition.field_111101_a;
            double var4 = this.field_111100_b
                    - par1CommandSpreadPlayersPosition.field_111100_b;
        ...
        float func_111096_b()
        {
            return MathHelper.sqrt_double(this.field_111101_a
                    * this.field_111101_a + this.field_111100_b
                    * this.field_111100_b);
        }

        public void func_111094_b(
                CommandSpreadPlayers.Position par1CommandSpreadPlayersPosition)
        {
        ...
        public boolean func_111093_a(double par1, double par3, double par5,
                double par7)
        {
            boolean var9 = false;
        ...
        public int func_111092_a(World par1World)
        {
            ...
            {
                if (par1World.getBlock(var2, var4, var3).getMaterial() != Material.air) { return var4 + 1; }
            }
        ...
        public boolean func_111098_b(World par1World)
        {
            ...
            {
                Material var5 = par1World.getBlock(var2, var4, var3)
                        .getMaterial();
                return !var5.isLiquid() && var5 != Material.field_151581_o;
            }
        }

        public void func_111097_a(Random par1Random, double par2, double par4,
                double par6, double par8)
        {
            this.field_111101_a = MathHelper.getRandomDoubleInRange(par1Random,
                    par2, par6);
            this.field_111100_b = MathHelper.getRandomDoubleInRange(par1Random,
                    par4, par8);
        }
    }
}
