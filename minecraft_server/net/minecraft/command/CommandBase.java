...
public abstract class CommandBase implements ICommand
{
    ...
    public static IChatComponent func_147176_a(ICommandSender p_147176_0_, String[] p_147176_1_, int p_147176_2_, boolean p_147176_3_)
    {
        ...
        for (int var5 = p_147176_2_; var5 < p_147176_1_.length; ++var5)
        {
            ...
            if (p_147176_3_)
            {
                ...
                else if (PlayerSelector.hasArguments(p_147176_1_[var5])) { throw new PlayerNotFoundException(); }
            }
    ...
    public static void notifyAdmins(ICommandSender commandSender, String message)
    {
        notifyAdmins(commandSender, message, new Object[] {});
    }
    ...
    public boolean isTargetNonOp(EntityPlayerMP target, ICommandSender sender)
    {
        return !MinecraftServer.isPlayerOpped(target) && !MinecraftServer.isPlayerOwner(sender);
    }
}
