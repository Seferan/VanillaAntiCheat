...
public class CommandGameMode extends CommandBase
{
            ...
            String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length > 0)
        {
            ...
            EntityPlayerMP var4 = par2ArrayOfStr.length >= 2 ? getPlayer(
    ...
    {
        return !par2Str.equalsIgnoreCase(WorldSettings.GameType.SURVIVAL
                .getName()) && !par2Str.equalsIgnoreCase("s") ? (!par2Str
            ...
            String[] par2ArrayOfStr)
    {
        return par2ArrayOfStr.length == 1 ? getListOfStringsMatchingLastWord(
                par2ArrayOfStr, new String[] {"survival", "creative",
                        "adventure"})
                : (par2ArrayOfStr.length == 2 ? getListOfStringsMatchingLastWord(
                        par2ArrayOfStr, this.getListOfPlayerUsernames()) : null);
    }
