...
public class CommandSummon extends CommandBase
{
            ...
            String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length >= 1)
        {
            ...
            {
                var4 = func_110666_a(par1ICommandSender, var4,
                        par2ArrayOfStr[1]);
                var6 = func_110666_a(par1ICommandSender, var6,
                        par2ArrayOfStr[2]);
                var8 = func_110666_a(par1ICommandSender, var8,
                        par2ArrayOfStr[3]);
            }
            ...
            else
            {
                ...
                {
                    IChatComponent var13 = func_147178_a(par1ICommandSender,
                            par2ArrayOfStr, 4);

                    try
                    {
                        NBTBase var14 = JsonToNBT.func_150315_a(var13
                                .getUnformattedText());
                ...
                if (var18 != null)
                {
                    ...
                    for (NBTTagCompound var15 = var11; var15.func_150297_b(
            ...
            String[] par2ArrayOfStr)
    {
        return par2ArrayOfStr.length == 1 ? getListOfStringsMatchingLastWord(
                par2ArrayOfStr, this.func_147182_d()) : null;
    }
