...
public class CommandBanIp extends CommandBase
{
            ...
            String[] par2ArrayOfStr)
    {
        if (par2ArrayOfStr.length >= 1 && par2ArrayOfStr[0].length() > 1)
        {
            ...
            if (var3.matches())
            {
                this.func_147210_a(par1ICommandSender, par2ArrayOfStr[0],
                        var4 == null ? null : var4.getUnformattedText());
            }
            else
            {
                EntityPlayerMP var5 = MinecraftServer.getServer()
                        .getConfigurationManager()
                        .getPlayerEntity(par2ArrayOfStr[0]);

                if (var5 == null) { throw new PlayerNotFoundException(
                        "commands.banip.invalid", new Object[0]); }

                this.func_147210_a(par1ICommandSender, var5.getPlayerIP(),
                        var4 == null ? null : var4.getUnformattedText());
            }
        }
        else
            ...
            String p_147210_2_, String p_147210_3_)
    {
        ...
        MinecraftServer.getServer().getConfigurationManager().getBannedIPs()
                .put(var4);
        List var5 = MinecraftServer.getServer().getConfigurationManager()
                .getPlayerList(p_147210_2_);
        String[] var6 = new String[var5.size()];
        int var7 = 0;
        EntityPlayerMP var9;

        for (Iterator var8 = var5.iterator(); var8.hasNext(); var6[var7++] = var9
        ...
        if (var5.isEmpty())
        {
            notifyAdmins(p_147210_1_, "commands.banip.success",
                    new Object[] {p_147210_2_});
        }
        else
        {
            notifyAdmins(p_147210_1_, "commands.banip.success.players",
