...
public class CommandSetDefaultSpawnpoint extends CommandBase
{
    ...
    public void processCommand(ICommandSender par1ICommandSender, String[] par2ArrayOfStr)
    {
        ...
        {
            if (par1ICommandSender.getEntityWorld() == null) { throw new WrongUsageException("commands.setworldspawn.usage", new Object[0]); }
        ...
        {
            if (par2ArrayOfStr.length != 0) { throw new WrongUsageException("commands.setworldspawn.usage", new Object[0]); }

            ChunkCoordinates var9 = getCommandSenderAsPlayer(par1ICommandSender).getCommandSenderPosition();
            par1ICommandSender.getEntityWorld().func_72950_A(var9.posX, var9.posY, var9.posZ);
