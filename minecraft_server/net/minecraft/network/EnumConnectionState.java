...
public enum EnumConnectionState
{
    ...
    protected EnumConnectionState func_150751_a(int p_150751_1_, Class p_150751_2_)
    {
        ...
        {
            var3 = "Serverbound packet ID " + p_150751_1_ + " is already assigned to " + field_150769_h.get(Integer.valueOf(p_150751_1_)) + "; cannot re-assign to " + p_150751_2_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
        else if (field_150769_h.containsValue(p_150751_2_))
        {
            var3 = "Serverbound packet " + p_150751_2_ + " is already assigned to ID " + field_150769_h.inverse().get(p_150751_2_) + "; cannot re-assign to " + p_150751_1_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
        else
    ...
    protected EnumConnectionState func_150756_b(int p_150756_1_, Class p_150756_2_)
    {
        ...
        {
            var3 = "Clientbound packet ID " + p_150756_1_ + " is already assigned to " + field_150770_i.get(Integer.valueOf(p_150756_1_)) + "; cannot re-assign to " + p_150756_2_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
        else if (field_150770_i.containsValue(p_150756_2_))
        {
            var3 = "Clientbound packet " + p_150756_2_ + " is already assigned to ID " + field_150770_i.inverse().get(p_150756_2_) + "; cannot re-assign to " + p_150756_1_;
            LogManager.getLogger().fatal(var3);
            throw new IllegalArgumentException(var3);
        }
        else
