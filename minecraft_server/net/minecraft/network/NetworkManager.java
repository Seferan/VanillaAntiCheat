...
public class NetworkManager extends SimpleChannelInboundHandler
{
    ...
    {
        this.connectionState = (EnumConnectionState)this.channel.attr(
                attrKeyConnectionState).getAndSet(p_150723_1_);
        this.channel.attr(attrKeyReceivable).set(
                p_150723_1_.func_150757_a(this.isClientSide));
        this.channel.attr(attrKeySendable).set(
                p_150723_1_.func_150754_b(this.isClientSide));
    ...
    {
        this.closeChannel(new ChatComponentTranslation(
                "disconnect.endOfStream", new Object[0]));
    }
    ...
    protected void channelRead0(ChannelHandlerContext p_150728_1_,
            Packet p_150728_2_)
    {
            ...
            final GenericFutureListener[] p_150732_2_)
    {
        ...
        final EnumConnectionState var4 = (EnumConnectionState)this.channel
    ...
    {
        this.flushOutboundQueue();
        EnumConnectionState var1 = (EnumConnectionState)this.channel.attr(
        ...
        if (this.connectionState != var1)
        {
            ...
            {
                this.packetListener.onConnectionStateTransition(
        ...
        {
            for (int var2 = 1000; !this.receivedPacketsQueue.isEmpty()
                    && var2 >= 0; --var2)
            {
    ...
    {
        return this.channel instanceof LocalChannel
                || this.channel instanceof LocalServerChannel;
    }
