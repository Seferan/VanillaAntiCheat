...
public abstract class EntityAIDoorInteract extends EntityAIBase
{
        ...
        else
        {
            ...
            if (var2 != null && !var2.isFinished() && var1.getCanBreakDoors())
            {
                        ...
                        var2.getCurrentPathLength()); ++var3)
                {
                    ...
                    if (this.theEntity.getDistanceSq((double)this.entityPosX,
                            this.theEntity.posY, (double)this.entityPosZ) <= 2.25D)
                    {
                        this.field_151504_e = this.func_151503_a(
                                this.entityPosX, this.entityPosY,
                                this.entityPosZ);

                        if (this.field_151504_e != null) { return true; }
                    }
                }

                this.entityPosX = MathHelper.floor_double(this.theEntity.posX);
                this.entityPosY = MathHelper
                        .floor_double(this.theEntity.posY + 1.0D);
                this.entityPosZ = MathHelper.floor_double(this.theEntity.posZ);
                this.field_151504_e = this.func_151503_a(this.entityPosX,
    ...
    private BlockDoor func_151503_a(int p_151503_1_, int p_151503_2_,
            int p_151503_3_)
    {
        Block var4 = this.theEntity.worldObj.getBlock(p_151503_1_, p_151503_2_,
                p_151503_3_);
