...
public class EntityAIOcelotSit extends EntityAIBase
{
    ...
    {
        return this.field_151493_a.isTamed()
                && !this.field_151493_a.isSitting()
                && this.field_151493_a.getRNG().nextDouble() <= 0.006500000134110451D
                && this.func_151485_f();
    }
    ...
    public boolean continueExecuting()
    {
        return this.field_151492_c <= this.field_151490_e
                ...
                && this.func_151486_a(this.field_151493_a.worldObj,
                        this.field_151487_f, this.field_151488_g,
                        this.field_151494_h);
    }
    ...
    {
        this.field_151493_a.getNavigator().tryMoveToXYZ(
                (double)((float)this.field_151487_f) + 0.5D,
                (double)(this.field_151488_g + 1),
                (double)((float)this.field_151494_h) + 0.5D,
                this.field_151491_b);
        this.field_151492_c = 0;
        this.field_151489_d = 0;
        this.field_151490_e = this.field_151493_a.getRNG().nextInt(
                this.field_151493_a.getRNG().nextInt(1200) + 1200) + 1200;
    ...
    public void updateTask()
    {
        ...
        if (this.field_151493_a.getDistanceSq((double)this.field_151487_f,
                (double)(this.field_151488_g + 1), (double)this.field_151494_h) > 1.0D)
        {
            this.field_151493_a.setSitting(false);
            this.field_151493_a.getNavigator().tryMoveToXYZ(
                    (double)((float)this.field_151487_f) + 0.5D,
    ...
    private boolean func_151485_f()
    {
        ...
        for (int var4 = (int)this.field_151493_a.posX - 8; (double)var4 < this.field_151493_a.posX + 8.0D; ++var4)
        {
            ...
            {
                if (this.func_151486_a(this.field_151493_a.worldObj, var4,
                        var1, var5)
                        && this.field_151493_a.worldObj.isAirBlock(var4,
                                var1 + 1, var5))
                {
                    double var6 = this.field_151493_a.getDistanceSq(
                            (double)var4, (double)var1, (double)var5);
    ...
    {
        Block var5 = p_151486_1_
                .getBlock(p_151486_2_, p_151486_3_, p_151486_4_);
        int var6 = p_151486_1_.getBlockMetadata(p_151486_2_, p_151486_3_,
                p_151486_4_);

        if (var5 == Blocks.chest)
        {
            TileEntityChest var7 = (TileEntityChest)p_151486_1_.getTileEntity(
                    p_151486_2_, p_151486_3_, p_151486_4_);

            if (var7.field_145987_o < 1) { return true; }
        }
        else
        {
            if (var5 == Blocks.lit_furnace) { return true; }

            if (var5 == Blocks.bed && !BlockBed.func_149975_b(var6)) { return true; }
        }
