...
public class EntityBodyHelper
{
    ...
    public void func_75664_a()
    {
        ...
        if (var1 * var1 + var3 * var3 > 2.500000277905201E-7D)
        {
            ...
            this.theLiving.rotationYawHead = this.func_75665_a(
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    var5 = Math.max(
                            1.0F - (float)(this.field_75666_b - 10) / 10.0F,
                            0.0F) * 75.0F;
                }
            }

            this.theLiving.renderYawOffset = this.func_75665_a(
                    this.theLiving.rotationYawHead,
