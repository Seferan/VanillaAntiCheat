...
public class EntityZombie extends EntityMob
{
    ...
    {
        this.getDataWatcher().updateObject(12,
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, float par2)
    {
        ...
        else
        {
            ...
            if (var3 != null
                    ...
                    && (double)this.rand.nextFloat() < this.getEntityAttribute(
                            field_110186_bp).getAttributeValue())
            {
                ...
                {
                    int var9 = var4
                            + MathHelper.getRandomIntegerInRange(this.rand, 7,
                                    40)
                            * MathHelper.getRandomIntegerInRange(this.rand, -1,
                                    1);
                    int var10 = var5
                            + MathHelper.getRandomIntegerInRange(this.rand, 7,
                                    40)
                    ...
                    if (World.doesBlockHaveSolidTopSurface(this.worldObj, var9,
                            var10 - 1, var11)
                            && this.worldObj.getBlockLightValue(var9, var10,
                                    var11) < 10)
                    {
                        var7.setPosition((double)var9, (double)var10,
                                (double)var11);

                        if (this.worldObj
                                .checkNoEntityCollision(var7.boundingBox)
                                && this.worldObj.getCollidingBoundingBoxes(
                                        var7, var7.boundingBox).isEmpty()
    ...
    public boolean attackEntityAsMob(Entity par1Entity)
    {
        ...
        if (var2)
        {
            ...
            if (this.getHeldItem() == null && this.isBurning()
                    && this.rand.nextFloat() < (float)var3 * 0.3F)
            {
    ...
    protected void addRandomArmor()
    {
        ...
        if (this.rand.nextFloat() < (this.worldObj.difficultySetting == EnumDifficulty.HARD ? 0.05F
                : 0.01F))
        {
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setInteger("ConversionTime",
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.func_150297_b("ConversionTime", 99)
                && par1NBTTagCompound.getInteger("ConversionTime") > -1)
        {
            this.startConversion(par1NBTTagCompound
                    .getInteger("ConversionTime"));
        }
            ...
            IEntityLivingData par1EntityLivingData)
    {
        ...
        float var2 = this.worldObj.func_147462_b(this.posX, this.posY,
                this.posZ);
        this.setCanPickUpLoot(this.rand.nextFloat() < 0.55F * var2);

        if (par1EntityLivingData1 == null)
        {
            par1EntityLivingData1 = new EntityZombie.GroupData(
        ...
        if (this.getEquipmentInSlot(4) == null)
        {
            ...
            if (var6.get(2) + 1 == 10 && var6.get(5) == 31
        ...
        double var7 = this.rand.nextDouble()
                * 1.5D
    ...
    public boolean interact(EntityPlayer par1EntityPlayer)
    {
        ...
        if (var2 != null && var2.getItem() == Items.golden_apple
                && var2.getItemDamage() == 0 && this.isVillager()
    ...
    protected void startConversion(int par1)
    {
        ...
        this.addPotionEffect(new PotionEffect(Potion.damageBoost.id, par1, Math
                .min(this.worldObj.difficultySetting.func_151525_a() - 1, 0)));
    ...
    protected int getConversionTimeBoost()
    {
        ...
        if (this.rand.nextFloat() < 0.01F)
        {
            ...
            for (int var3 = (int)this.posX - 4; var3 < (int)this.posX + 4
                    && var2 < 14; ++var3)
            {
                for (int var4 = (int)this.posY - 4; var4 < (int)this.posY + 4
                        && var2 < 14; ++var4)
                {
                    for (int var5 = (int)this.posZ - 4; var5 < (int)this.posZ + 4
                            && var2 < 14; ++var5)
                    {
    ...
    {
        boolean var3 = this.field_146074_bv > 0.0F
