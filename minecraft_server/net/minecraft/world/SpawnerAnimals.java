...
public final class SpawnerAnimals
{
    ...
    {
        Chunk var3 = p_151350_0_.getChunkFromChunkCoords(p_151350_1_,
                p_151350_2_);
        int var4 = p_151350_1_ * 16 + p_151350_0_.rand.nextInt(16);
        int var5 = p_151350_2_ * 16 + p_151350_0_.rand.nextInt(16);
        int var6 = p_151350_0_.rand.nextInt(var3 == null ? p_151350_0_
            ...
            boolean par3, boolean par4)
    {
        ...
        else
        {
            ...
            {
                EntityPlayer var6 = (EntityPlayer)par1WorldServer.playerEntities
                        .get(var5);
                ...
                for (int var10 = -var9; var10 <= var9; ++var10)
                {
                    ...
                    {
                        boolean var12 = var10 == -var9 || var10 == var9
                                || var11 == -var9 || var11 == var9;
                        ChunkCoordIntPair var13 = new ChunkCoordIntPair(var10
                                + var7, var11 + var8);

                        if (!var12)
                        {
                            this.eligibleChunksForSpawning.put(var13,
            ...
            for (int var36 = 0; var36 < var8; ++var36)
            {
                ...
                if ((!var37.getPeacefulCreature() || par3)
                        && (var37.getPeacefulCreature() || par2)
                        && (!var37.getAnimal() || par4)
                        && par1WorldServer.countEntities(var37
                                .getCreatureClass()) <= var37
                                .getMaxNumberOfCreature()
                                * this.eligibleChunksForSpawning.size() / 256)
                {
                    Iterator var39 = this.eligibleChunksForSpawning.keySet()
                            .iterator();
                    label110:

                    while (var39.hasNext())
                    {
                        ChunkCoordIntPair var38 = (ChunkCoordIntPair)var39
                                .next();

                        if (!((Boolean)this.eligibleChunksForSpawning
                                .get(var38)).booleanValue())
                        {
                            ChunkPosition var40 = func_151350_a(
                                    par1WorldServer, var38.chunkXPos,
                                    var38.chunkZPos);
        ...
        if (!var7.isEmpty())
        {
                    ...
                    .getSpawningChance())
            {
                ...
                for (int var15 = 0; var15 < var10; ++var15)
                {
                    ...
                    {
                        int var18 = par0World.getTopSolidOrLiquidBlock(var11,
                                var12);
                                ...
                                var18, var12))
                        {
                            ...
                            var22.setLocationAndAngles((double)var19,
                                    (double)var20, (double)var21,
