...
public class WorldServer extends World
{
            ...
            Profiler p_i45284_6_)
    {
        ...
        this.thePlayerManager = new PlayerManager(this, p_i45284_1_
        ...
        ScoreboardSaveData var7 = (ScoreboardSaveData)this.mapStorage.loadData(
    ...
    public void tick()
    {
        ...
        if (this.getWorldInfo().isHardcoreModeEnabled()
        ...
        {
            this.animalSpawner.findChunksForSpawning(this,
                    this.spawnHostileMobs, this.spawnPeacefulMobs,
        ...
        this.worldInfo.incrementTotalWorldTime(this.worldInfo
                .getWorldTotalTime() + 1L);
        ...
        this.worldTeleporter.removeStalePortalLocations(this
                .getTotalWorldTime());
    ...
    protected void func_147456_g()
    {
        ...
        while (var3.hasNext())
        {
            ...
            Chunk var7 = this.getChunkFromChunkCoords(var4.chunkXPos,
                    var4.chunkZPos);
            ...
            if (this.rand.nextInt(100000) == 0 && this.isRaining()
                    && this.isThundering())
            {
                ...
                {
                    this.addWeatherEffect(new EntityLightningBolt(this,
            ...
            if (this.rand.nextInt(16) == 0)
            {
                ...
                if (this.isBlockFreezableNaturally(var9 + var5, var11 - 1,
                        var10 + var6))
                {
                ...
                if (this.isRaining()
                        && this.func_147478_e(var9 + var5, var11, var10 + var6,
                                true))
                {
                ...
                if (this.isRaining())
                {
                    BiomeGenBase var12 = this.getBiomeGenForCoords(var9 + var5,
                            var10 + var6);

                    if (var12.canSpawnLightningBolt())
                    {
                        this.getBlock(var9 + var5, var11 - 1, var10 + var6)
                    ...
                    for (int var19 = 0; var19 < 3; ++var19)
                    {
                        ...
                        if (var17.getTickRandomly())
                        {
                            ...
                            var17.updateTick(this, var14 + var5,
                                    var16 + var20.getYLocation(), var15 + var6,
                                    this.rand);
                        }
                    }
                }
    ...
    {
        NextTickListEntry var5 = new NextTickListEntry(p_147477_1_,
    ...
    {
        this.func_147454_a(p_147464_1_, p_147464_2_, p_147464_3_, p_147464_4_,
                p_147464_5_, 0);
    }
    ...
    {
        NextTickListEntry var7 = new NextTickListEntry(p_147454_1_,
                ...
                && p_147454_4_.getMaterial() != Material.air)
        {
            if (p_147454_4_.func_149698_L())
            {
                ...
                if (this.checkChunksExist(var7.xCoord - var8, var7.yCoord
                        - var8, var7.zCoord - var8, var7.xCoord + var8,
                        var7.yCoord + var8, var7.zCoord + var8))
                {
                    Block var9 = this.getBlock(var7.xCoord, var7.yCoord,
                            var7.zCoord);
        ...
        if (this.checkChunksExist(p_147454_1_ - var8, p_147454_2_ - var8,
                p_147454_3_ - var8, p_147454_1_ + var8, p_147454_2_ + var8,
                p_147454_3_ + var8))
        {
            if (p_147454_4_.getMaterial() != Material.air)
            {
                var7.setScheduledTime((long)p_147454_5_
                        + this.worldInfo.getWorldTotalTime());
    ...
    public void updateEntities()
    {
        ...
        {
            if (this.updateEntityTick++ >= 1200) { return; }
        }
        else
        {
    ...
    public boolean tickUpdates(boolean par1)
    {
        ...
        else
        {
            ...
            {
                var4 = (NextTickListEntry)this.pendingTickListEntriesTreeSet
                        .first();

                if (!par1
                        && var4.scheduledTime > this.worldInfo
                                .getWorldTotalTime())
                {
                    break;
                }
            ...
            while (var14.hasNext())
            {
                ...
                if (this.checkChunksExist(var4.xCoord - var5, var4.yCoord
                        - var5, var4.zCoord - var5, var4.xCoord + var5,
                        var4.yCoord + var5, var4.zCoord + var5))
                {
                    Block var6 = this.getBlock(var4.xCoord, var4.yCoord,
                            var4.zCoord);
                            ...
                            && Block.isEqualTo(var6, var4.func_151351_a()))
                    {
                        try
                        {
                            var6.updateTick(this, var4.xCoord, var4.yCoord,
                                    var4.zCoord, this.rand);
                        }
                        catch (Throwable var13)
                        {
                            CrashReport var8 = CrashReport.makeCrashReport(
                                    var13, "Exception while ticking a block");
                            ...
                            try
                            {
                                var10 = this.getBlockMetadata(var4.xCoord,
                ...
                {
                    this.scheduleBlockUpdate(var4.xCoord, var4.yCoord,
                            var4.zCoord, var4.func_151351_a(), 0);
                }
            }
    ...
    protected IChunkProvider createChunkProvider()
    {
        ...
        this.theChunkProviderServer = new ChunkProviderServer(this, var1,
            ...
            int p_147486_3_, int p_147486_4_, int p_147486_5_, int p_147486_6_)
    {
        ...
        for (int var8 = 0; var8 < this.field_147482_g.size(); ++var8)
        {
            ...
            if (var9.xCoord >= p_147486_1_ && var9.yCoord >= p_147486_2_
                    && var9.zCoord >= p_147486_3_ && var9.xCoord < p_147486_4_
                    && var9.yCoord < p_147486_5_ && var9.zCoord < p_147486_6_)
            {
                var7.add(var9);
            }
        }
    ...
    public boolean canMineBlock(EntityPlayer par1EntityPlayer, int par2,
            int par3, int par4)
    {
        return !this.mcServer.isBlockProtected(this, par2, par3, par4,
                par1EntityPlayer);
    }
    ...
    protected void createSpawnPosition(WorldSettings par1WorldSettings)
    {
        ...
        {
            this.worldInfo.setSpawnPosition(0,
                    this.provider.getAverageGroundLevel(), 0);
        }
        else
        {
    ...
    protected void createBonusChest()
    {
        ...
        {
            int var3 = this.worldInfo.getSpawnX() + this.rand.nextInt(6)
                    - this.rand.nextInt(6);
            int var4 = this.worldInfo.getSpawnZ() + this.rand.nextInt(6)
                    - this.rand.nextInt(6);
     ...
     */
    public void saveAllChunks(boolean par1, IProgressUpdate par2IProgressUpdate)
    ...
    protected void saveLevel() throws MinecraftException
    {
        ...
        this.saveHandler.saveWorldInfoWithPlayer(this.worldInfo, this.mcServer
    ...
    public boolean addWeatherEffect(Entity par1Entity)
    {
        ...
        {
            this.mcServer.getConfigurationManager().func_148541_a(
                    par1Entity.posX, par1Entity.posY, par1Entity.posZ, 512.0D,
                    this.provider.dimensionId,
                    new S2CPacketSpawnGlobalEntity(par1Entity));
            return true;
        }
        else
        {
    ...
    {
        this.getEntityTracker().func_151248_b(par1Entity,
                new S19PacketEntityStatus(par1Entity, par2));
    }
        ...
        while (var12.hasNext())
        {
            ...
            if (var13.getDistanceSq(par2, par4, par6) < 4096.0D)
            {
                ((EntityPlayerMP)var13).playerNetServerHandler
                        .sendPacket(new S27PacketExplosion(par2, par4, par6,
                                par8, var11.affectedBlockPositions, (Vec3)var11
    ...
    {
        BlockEventData var7 = new BlockEventData(p_147452_1_, p_147452_2_,
                p_147452_3_, p_147452_4_, p_147452_5_, p_147452_6_);
    ...
    {
        Block var2 = this.getBlock(p_147485_1_.func_151340_a(),
    ...
    protected void updateWeather()
    {
        ...
        if (this.prevRainingStrength != this.rainingStrength)
        {
            this.mcServer.getConfigurationManager()
                    .sendPacketToAllPlayersInDimension(
                            new S2BPacketChangeGameState(7,
        ...
        if (this.prevThunderingStrength != this.thunderingStrength)
        {
            this.mcServer.getConfigurationManager()
                    .sendPacketToAllPlayersInDimension(
                            new S2BPacketChangeGameState(8,
    ...
    public void func_147487_a(String p_147487_1_, double p_147487_2_,
            ...
            double p_147487_15_)
    {
        S2APacketParticles var17 = new S2APacketParticles(p_147487_1_,
                (float)p_147487_2_, (float)p_147487_4_, (float)p_147487_6_,
                (float)p_147487_9_, (float)p_147487_11_, (float)p_147487_13_,
                (float)p_147487_15_, p_147487_8_);

        for (int var18 = 0; var18 < this.playerEntities.size(); ++var18)
        {
            EntityPlayerMP var19 = (EntityPlayerMP)this.playerEntities
                    .get(var18);
