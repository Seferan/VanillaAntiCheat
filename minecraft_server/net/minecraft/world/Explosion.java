                ...
                for (var5 = 0; var5 < field_77289_h; ++var5)
                {
                    if (var3 == 0 || var3 == field_77289_h - 1 || var4 == 0 || var4 == field_77289_h - 1 || var5 == 0 || var5 == field_77289_h - 1)
                    {
                        ...
                        for (float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F)
                        {
                            ...
                            {
                                float var26 = exploder != null ? exploder.func_145772_a(this, worldObj, var22, var23, var24, var25) : var25.getExplosionResistance(exploder);
                                var14 -= (var26 + 0.3F) * var21;
                            }

                            if (var14 > 0.0F && (exploder == null || exploder.func_145774_a(this, worldObj, var22, var23, var24, var25, var14)))
                            {
    ...
    public void doExplosionB(boolean par1)
    {
        ...
        if (isSmoking)
        {
            ...
            while (var2.hasNext())
            {
                ...
                if (var7.getMaterial() != Material.air)
                {
                    ...
                    {
                        var7.dropBlockAsItemWithChance(worldObj, var4, var5, var6, worldObj.getBlockMetadata(var4, var5, var6), 1.0F / explosionSize, 0);
                    }
        ...
        if (isFlaming)
        {
            ...
            while (var2.hasNext())
            {
                ...
                var6 = var3.chunkPosZ;
                var7 = worldObj.getBlock(var4, var5, var6);
                Block var24 = worldObj.getBlock(var4, var5 - 1, var6);

                if (var7.getMaterial() == Material.air && var24.func_149730_j() && explosionRNG.nextInt(3) == 0)
                {
