...
public class Explosion
{
    ...
    public void doExplosionA()
    {
        ...
        List var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(
                this.exploder,
                AxisAlignedBB.getAABBPool().getAABB((double)var3, (double)var5,
                        (double)var7, (double)var4, (double)var29,
                        (double)var30));
        Vec3 var31 = this.worldObj.getWorldVec3Pool().getVecFromPool(
        ...
        for (int var11 = 0; var11 < var9.size(); ++var11)
        {
            ...
            if (var13 <= 1.0D)
            {
                ...
                double var34 = (double)MathHelper.sqrt_double(var15 * var15
                ...
                if (var34 != 0.0D)
                {
                    ...
                    var17 /= var34;
                    var19 /= var34;
                    double var33 = (double)this.worldObj.getBlockDensity(var31,
                            var32.boundingBox);
                    double var35 = (1.0D - var13) * var33;
                    var32.attackEntityFrom(
                            DamageSource.setExplosionSource(this),
                            (float)((int)((var35 * var35 + var35) / 2.0D * 8.0D
                                    * (double)this.explosionSize + 1.0D)));
                    ...
                    if (var32 instanceof EntityPlayer)
                    {
                        this.field_77288_k.put(
                                ...
                                this.worldObj.getWorldVec3Pool()
                                        .getVecFromPool(var15 * var35,
                                                var17 * var35, var19 * var35));
                    }
                }
            }
        }
        ...
        if (this.isSmoking)
        {
            ...
            while (var2.hasNext())
            {
                ...
                if (var7.getMaterial() != Material.air)
                {
                    ...
                    {
                        var7.dropBlockAsItemWithChance(this.worldObj, var4,
                    ...
                    var7.onBlockDestroyedByExplosion(this.worldObj, var4, var5,
                            var6, this);
                }
            }
        }
