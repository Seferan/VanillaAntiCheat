...
public class WorldChunkManagerHell extends WorldChunkManager
{
            ...
            int par4, int par5)
    {
        ...
        Arrays.fill(par1ArrayOfBiomeGenBase, 0, par4 * par5,
                this.biomeGenerator);
    ...
    {
        return this.loadBlockGeneratorData(par1ArrayOfBiomeGenBase, par2, par3,
                par4, par5);
    }
    ...
    {
        return p_150795_4_.contains(this.biomeGenerator) ? new ChunkPosition(
