...
public abstract class BiomeGenBase
{
    ...
    public static final BiomeGenBase ocean = (new BiomeGenOcean(0))
            .setColor(112).setBiomeName("Ocean").func_150570_a(field_150595_c);
    ...
    public static final BiomeGenBase river = (new BiomeGenRiver(7))
            .setColor(255).setBiomeName("River").func_150570_a(field_150594_b);
    ...
    public static final BiomeGenBase sky = (new BiomeGenEnd(9))
            .setColor(8421631).setBiomeName("Sky").setDisableRain();
    ...
    public static final BiomeGenBase jungleHills = (new BiomeGenJungle(22,
            false)).setColor(2900485).setBiomeName("JungleHills")
    ...
    public static final BiomeGenBase field_150576_N = (new BiomeGenStoneBeach(
            25)).setColor(10658436).setBiomeName("Stone Beach")
    ...
    protected BiomeGenBase(int par1)
    {
        ...
        this.spawnableCaveCreatureList.add(new BiomeGenBase.SpawnListEntry(
    ...
    public final float func_150564_a(int p_150564_1_, int p_150564_2_,
            int p_150564_3_)
    {
        if (p_150564_2_ > 64)
        {
            float var4 = (float)field_150605_ac.func_151601_a(
                    (double)p_150564_1_ * 1.0D / 8.0D,
                    (double)p_150564_3_ * 1.0D / 8.0D) * 4.0F;
            return this.temperature - (var4 + (float)p_150564_2_ - 64.0F)
                    * 0.05F / 30.0F;
        }
        else
        {
    ...
    {
        this.theBiomeDecorator.func_150512_a(par1World, par2Random, this, par3,
                par4);
    }
                ...
                if (var20 != null && var20.getMaterial() != Material.air)
                {
                    if (var20 == Blocks.stone)
                    {
                        if (var13 == -1)
                        {
                            ...
                            {
                                if (this.func_150564_a(p_150560_5_, var18,
                                        p_150560_6_) < 0.15F)
                                {
                                    var10 = Blocks.ice;
                                    var11 = 0;
    ...
    {
        return p_150569_1_ == this ? true : (p_150569_1_ == null ? false : this
    ...
    public static class SpawnListEntry extends WeightedRandom.Item
    {
        ...
        {
            return this.entityClass.getSimpleName() + "*(" + this.minGroupCount
                    + "-" + this.maxGroupCount + "):" + this.itemWeight;
        }
    }
    ...
    public static class Height
    {
        ...
        {
            return new BiomeGenBase.Height(this.field_150777_a * 0.8F,
                    this.field_150776_b * 0.6F);
        }
    }
    ...
    public static enum TempCategory
    {
        ...
        private static final BiomeGenBase.TempCategory[] $VALUES = new BiomeGenBase.TempCategory[] {
