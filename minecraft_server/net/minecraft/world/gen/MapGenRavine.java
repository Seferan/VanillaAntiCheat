...
public class MapGenRavine extends MapGenBase
{
            ...
            int p_151540_16_, double p_151540_17_)
    {
        ...
        {
            double var53 = 1.5D + (double)(MathHelper.sin((float)p_151540_15_
                    * (float)Math.PI / (float)p_151540_16_)
                    * p_151540_12_ * 1.0F);
            ...
            if (var54 || var19.nextInt(4) != 0)
            {
                ...
                if (p_151540_6_ >= var20 - 16.0D - var53 * 2.0D
                        && p_151540_10_ >= var22 - 16.0D - var53 * 2.0D
                        && p_151540_6_ <= var20 + 16.0D + var53 * 2.0D
                        && p_151540_10_ <= var22 + 16.0D + var53 * 2.0D)
                {
                    int var56 = MathHelper.floor_double(p_151540_6_ - var53)
                            - p_151540_3_ * 16 - 1;
                    int var35 = MathHelper.floor_double(p_151540_6_ + var53)
                            - p_151540_3_ * 16 + 1;
                    int var55 = MathHelper.floor_double(p_151540_8_ - var30) - 1;
                    int var37 = MathHelper.floor_double(p_151540_8_ + var30) + 1;
                    int var57 = MathHelper.floor_double(p_151540_10_ - var53)
                            - p_151540_4_ * 16 - 1;
                    int var39 = MathHelper.floor_double(p_151540_10_ + var53)
                            - p_151540_4_ * 16 + 1;
                    ...
                    if (!var58)
                    {
                        ...
                        {
                            double var60 = ((double)(var41 + p_151540_3_ * 16) + 0.5D - p_151540_6_)
                                    / var53;

                            for (var44 = var57; var44 < var39; ++var44)
                            {
                                double var59 = ((double)(var44 + p_151540_4_ * 16) + 0.5D - p_151540_10_)
                                        / var53;
                                ...
                                if (var60 * var60 + var59 * var59 < 1.0D)
                                {
                                    ...
                                    {
                                        double var50 = ((double)var49 + 0.5D - p_151540_8_)
                                                / var30;

                                        if ((var60 * var60 + var59 * var59)
                                                * (double)this.field_75046_d[var49]
                                                + var50 * var50 / 6.0D < 1.0D)
                                        {
                                                    ...
                                                    || var52 == Blocks.grass)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        p_151540_5_[var47 - 1] = this.worldObj
            ...
            Block[] p_151538_6_)
    {
        if (this.rand.nextInt(50) == 0)
        {
            ...
            for (int var14 = 0; var14 < var13; ++var14)
            {
                ...
                float var17 = (this.rand.nextFloat() * 2.0F + this.rand
                        .nextFloat()) * 2.0F;
                this.func_151540_a(this.rand.nextLong(), p_151538_4_,
                        p_151538_5_, p_151538_6_, var7, var9, var11, var17,
                        var15, var16, 0, 0, 3.0D);
            }
        }
    }
}
