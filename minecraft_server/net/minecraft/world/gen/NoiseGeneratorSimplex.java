...
public class NoiseGeneratorSimplex
{
    ...
    private static double func_151604_a(int[] p_151604_0_, double p_151604_1_,
            double p_151604_3_)
    {
        return (double)p_151604_0_[0] * p_151604_1_ + (double)p_151604_0_[1]
                * p_151604_3_;
    }
    ...
    public double func_151605_a(double p_151605_1_, double p_151605_3_)
    {
        ...
        int var42 = this.field_151608_f[var39 + var29
                + this.field_151608_f[var40 + var30]] % 12;
        int var43 = this.field_151608_f[var39 + 1
                + this.field_151608_f[var40 + 1]] % 12;
            ...
            double p_151606_8_, double p_151606_10_, double p_151606_12_)
    {
        ...
        {
            double var16 = (p_151606_4_ + (double)var15) * p_151606_10_
                    + this.field_151613_c;

            for (int var18 = 0; var18 < p_151606_6_; ++var18)
            {
                double var19 = (p_151606_2_ + (double)var18) * p_151606_8_
                        + this.field_151612_b;
                ...
                int var51 = var29 & 255;
                int var52 = var30 & 255;
                int var53 = this.field_151608_f[var51
                        + this.field_151608_f[var52]] % 12;
                int var54 = this.field_151608_f[var51 + var41
                        + this.field_151608_f[var52 + var42]] % 12;
                int var55 = this.field_151608_f[var51 + 1
                        + this.field_151608_f[var52 + 1]] % 12;
