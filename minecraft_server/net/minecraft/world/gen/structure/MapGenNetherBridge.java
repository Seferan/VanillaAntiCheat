...
public class MapGenNetherBridge extends MapGenStructure
{
    ...
    {
        this.spawnList.add(new BiomeGenBase.SpawnListEntry(EntityBlaze.class,
                10, 2, 3));
        this.spawnList.add(new BiomeGenBase.SpawnListEntry(
                EntityPigZombie.class, 5, 4, 4));
        this.spawnList.add(new BiomeGenBase.SpawnListEntry(
                EntitySkeleton.class, 10, 4, 4));
        this.spawnList.add(new BiomeGenBase.SpawnListEntry(
    ...
    protected boolean canSpawnStructureAtCoords(int par1, int par2)
    {
        ...
        this.rand.nextInt();
        return this.rand.nextInt(3) != 0 ? false : (par1 != (var3 << 4) + 4
                + this.rand.nextInt(8) ? false : par2 == (var4 << 4) + 4
                + this.rand.nextInt(8));
    }

    protected StructureStart getStructureStart(int par1, int par2)
    {
        return new MapGenNetherBridge.Start(this.worldObj, this.rand, par1,
                par2);
    }
    ...
    public static class Start extends StructureStart
    {
        ...
        {
            super(par3, par4);
            StructureNetherBridgePieces.Start var5 = new StructureNetherBridgePieces.Start(
