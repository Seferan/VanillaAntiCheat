...
public class StructureMineshaftPieces
{
            ...
            Random par1Random, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        if (var7 >= 80)
        {
            var8 = StructureMineshaftPieces.Cross.findValidPlacement(par0List,
                    par1Random, par2, par3, par4, par5);

            if (var8 != null) { return new StructureMineshaftPieces.Cross(par6,
                    par1Random, var8, par5); }
        }
        else if (var7 >= 70)
        {
            var8 = StructureMineshaftPieces.Stairs.findValidPlacement(par0List,
                    par1Random, par2, par3, par4, par5);

            if (var8 != null) { return new StructureMineshaftPieces.Stairs(
                    par6, par1Random, var8, par5); }
        }
        else
        {
            var8 = StructureMineshaftPieces.Corridor.findValidPlacement(
                    par0List, par1Random, par2, par3, par4, par5);

            if (var8 != null) { return new StructureMineshaftPieces.Corridor(
                    par6, par1Random, var8, par5); }
        }
            ...
            Random par2Random, int par3, int par4, int par5, int par6, int par7)
    {
        ...
        {
            StructureComponent var8 = getRandomComponent(par1List, par2Random,
                    par3, par4, par5, par6, par7 + 1);

            if (var8 != null)
            {
                par1List.add(var8);
                var8.buildComponent(par0StructureComponent, par1List,
                        par2Random);
            }
    ...
    public static class Cross extends StructureComponent
    {
        ...
        public Cross(int par1, Random par2Random,
        ...
        {
            StructureBoundingBox var6 = new StructureBoundingBox(par2, par3,
            ...
            return StructureComponent.findIntersecting(par0List, var6) != null ? null
                    : var6;
        }
                ...
                List par2List, Random par3Random)
        {
            ...
            case 0:
                ...
                StructureMineshaftPieces.getNextMineShaftComponent(
                        par1StructureComponent, par2List, par3Random,
                        this.boundingBox.minX - 1, this.boundingBox.minY,
                        this.boundingBox.minZ + 1, 1, var4);
                StructureMineshaftPieces.getNextMineShaftComponent(
                        par1StructureComponent, par2List, par3Random,
                        this.boundingBox.maxX + 1, this.boundingBox.minY,
                        this.boundingBox.minZ + 1, 3, var4);
                break;
            ...
            else
            {
                if (this.isMultipleFloors)
                {
                    this.func_151549_a(par1World, par3StructureBoundingBox,
                            this.boundingBox.minX + 1, this.boundingBox.minY,
                            this.boundingBox.minZ, this.boundingBox.maxX - 1,
                            this.boundingBox.minY + 3 - 1,
                            this.boundingBox.maxZ, Blocks.air, Blocks.air,
                            false);
                    this.func_151549_a(par1World, par3StructureBoundingBox,
                            this.boundingBox.minX, this.boundingBox.minY,
                            this.boundingBox.minZ + 1, this.boundingBox.maxX,
                            this.boundingBox.minY + 3 - 1,
                            this.boundingBox.maxZ - 1, Blocks.air, Blocks.air,
                            false);
                    this.func_151549_a(par1World, par3StructureBoundingBox,
                            this.boundingBox.minX + 1,
                            this.boundingBox.maxY - 2, this.boundingBox.minZ,
                            this.boundingBox.maxX - 1, this.boundingBox.maxY,
                            this.boundingBox.maxZ, Blocks.air, Blocks.air,
                            false);
                    this.func_151549_a(par1World, par3StructureBoundingBox,
                            this.boundingBox.minX, this.boundingBox.maxY - 2,
                            this.boundingBox.minZ + 1, this.boundingBox.maxX,
                            this.boundingBox.maxY, this.boundingBox.maxZ - 1,
                ...
                this.func_151549_a(par1World, par3StructureBoundingBox,
                        this.boundingBox.minX + 1, this.boundingBox.minY,
                        this.boundingBox.minZ + 1, this.boundingBox.minX + 1,
                        this.boundingBox.maxY, this.boundingBox.minZ + 1,
                        Blocks.planks, Blocks.air, false);
                this.func_151549_a(par1World, par3StructureBoundingBox,
                        this.boundingBox.minX + 1, this.boundingBox.minY,
                        this.boundingBox.maxZ - 1, this.boundingBox.minX + 1,
                        this.boundingBox.maxY, this.boundingBox.maxZ - 1,
                        Blocks.planks, Blocks.air, false);
                this.func_151549_a(par1World, par3StructureBoundingBox,
                        this.boundingBox.maxX - 1, this.boundingBox.minY,
                        this.boundingBox.minZ + 1, this.boundingBox.maxX - 1,
                        this.boundingBox.maxY, this.boundingBox.minZ + 1,
                        Blocks.planks, Blocks.air, false);
                this.func_151549_a(par1World, par3StructureBoundingBox,
                        this.boundingBox.maxX - 1, this.boundingBox.minY,
                        this.boundingBox.maxZ - 1, this.boundingBox.maxX - 1,
                        this.boundingBox.maxY, this.boundingBox.maxZ - 1,
                        Blocks.planks, Blocks.air, false);
                ...
                for (int var4 = this.boundingBox.minX; var4 <= this.boundingBox.maxX; ++var4)
                {
                    ...
                    {
                        if (this.func_151548_a(par1World, var4,
                                this.boundingBox.minY - 1, var5,
                                par3StructureBoundingBox).getMaterial() == Material.air)
                        {
                            this.func_151550_a(par1World, Blocks.planks, 0,
                                    var4, this.boundingBox.minY - 1, var5,
                                    par3StructureBoundingBox);
                        }
                    }
                }
    ...
    public static class Room extends StructureComponent
    {
        ...
        {
            super(par1);
            this.boundingBox = new StructureBoundingBox(par3, 50, par4, par3
                    + 7 + par2Random.nextInt(6), 54 + par2Random.nextInt(6),
                    par4 + 7 + par2Random.nextInt(6));
        }
                ...
                List par2List, Random par3Random)
        {
            ...
            for (var5 = 0; var5 < this.boundingBox.getXSize(); var5 += 4)
            {
                ...
                var7 = StructureMineshaftPieces.getNextMineShaftComponent(
                        par1StructureComponent, par2List, par3Random,
                        this.boundingBox.minX + var5, this.boundingBox.minY
                                + par3Random.nextInt(var6) + 1,
                        this.boundingBox.minZ - 1, 2, var4);

                if (var7 != null)
                {
                    var8 = var7.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
                            var8.minX, var8.minY, this.boundingBox.minZ,
            ...
            for (var5 = 0; var5 < this.boundingBox.getXSize(); var5 += 4)
            {
                ...
                if (var7 != null)
                {
                    var8 = var7.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
                            var8.minX, var8.minY, this.boundingBox.maxZ - 1,
            ...
            for (var5 = 0; var5 < this.boundingBox.getZSize(); var5 += 4)
            {
                ...
                if (var7 != null)
                {
                    var8 = var7.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
                            this.boundingBox.minX, var8.minY, var8.minZ,
            ...
            for (var5 = 0; var5 < this.boundingBox.getZSize(); var5 += 4)
            {
                ...
                if (var7 != null)
                {
                    var8 = var7.getBoundingBox();
                    this.roomsLinkedToTheRoom.add(new StructureBoundingBox(
                            this.boundingBox.maxX - 1, var8.minY, var8.minZ,
                ...
                StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            else
            {
                this.func_151549_a(par1World, par3StructureBoundingBox,
                        ...
                        this.boundingBox.minY, this.boundingBox.maxZ,
                        Blocks.dirt, Blocks.air, true);
                this.func_151549_a(par1World, par3StructureBoundingBox,
                        this.boundingBox.minX, this.boundingBox.minY + 1,
                        this.boundingBox.minZ, this.boundingBox.maxX, Math.min(
                                this.boundingBox.minY + 3,
                                this.boundingBox.maxY), this.boundingBox.maxZ,
                        Blocks.air, Blocks.air, false);
                ...
                while (var4.hasNext())
                {
                    StructureBoundingBox var5 = (StructureBoundingBox)var4
                            .next();
                    this.func_151549_a(par1World, par3StructureBoundingBox,
                            var5.minX, var5.maxY - 2, var5.minZ, var5.maxX,
                            var5.maxY, var5.maxZ, Blocks.air, Blocks.air, false);
                }

                this.func_151547_a(par1World, par3StructureBoundingBox,
                        this.boundingBox.minX, this.boundingBox.minY + 4,
                        this.boundingBox.minZ, this.boundingBox.maxX,
                        this.boundingBox.maxY, this.boundingBox.maxZ,
                        Blocks.air, false);
                return true;
        ...
        protected void func_143011_b(NBTTagCompound par1NBTTagCompound)
        {
            ...
            {
                this.roomsLinkedToTheRoom.add(new StructureBoundingBox(var2
                        .func_150306_c(var3)));
            }
        }
    }
    ...
    public static class Corridor extends StructureComponent
    {
            ...
            if (var4 < 8)
            {
                ...
                if (this.coordBaseMode != 2 && this.coordBaseMode != 0)
                {
                    for (var6 = this.boundingBox.minX + 3; var6 + 3 <= this.boundingBox.maxX; var6 += 5)
                    {
                        ...
                        {
                            StructureMineshaftPieces.getNextMineShaftComponent(
                                    par1StructureComponent, par2List,
                                    par3Random, var6, this.boundingBox.minY,
                                    this.boundingBox.minZ - 1, 2, var4 + 1);
                        }
                        else if (var7 == 1)
                        {
                            StructureMineshaftPieces.getNextMineShaftComponent(
                                    par1StructureComponent, par2List,
                                    par3Random, var6, this.boundingBox.minY,
                                    this.boundingBox.maxZ + 1, 0, var4 + 1);
                        }
                    }
                }
                else
                    ...
                    for (var6 = this.boundingBox.minZ + 3; var6 + 3 <= this.boundingBox.maxZ; var6 += 5)
                    {
                        ...
                        if (var7 == 0)
                        {
                            StructureMineshaftPieces.getNextMineShaftComponent(
                                    ...
                                    this.boundingBox.minY, var6, 1, var4 + 1);
                        }
                        else if (var7 == 1)
                        {
                            StructureMineshaftPieces.getNextMineShaftComponent(
                                    ...
                                    this.boundingBox.minY, var6, 3, var4 + 1);
                        }
                    }
                }
            }
                ...
                int par8)
        {
            ...
            if (par2StructureBoundingBox.isVecInside(var9, var10, var11)
                    && par1World.getBlock(var9, var10, var11).getMaterial() == Material.air)
            {
                int var12 = par3Random.nextBoolean() ? 1 : 0;
                par1World.setBlock(var9, var10, var11, Blocks.rail,
                        this.func_151555_a(Blocks.rail, var12), 2);
                EntityMinecartChest var13 = new EntityMinecartChest(par1World,
                        (double)((float)var9 + 0.5F),
                        (double)((float)var10 + 0.5F),
                        (double)((float)var11 + 0.5F));
                WeightedRandomChestContent.generateChestContents(par3Random,
                        par7ArrayOfWeightedRandomChestContent, var13, par8);
                ...
                StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            else
            {
                ...
                this.func_151549_a(par1World, par3StructureBoundingBox, 0, 0,
                        0, 2, 1, var8, Blocks.air, Blocks.air, false);
                this.func_151551_a(par1World, par3StructureBoundingBox,
                        par2Random, 0.8F, 0, 2, 0, 2, 2, var8, Blocks.air,
                        Blocks.air, false);

                if (this.hasSpiders)
                {
                    this.func_151551_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.6F, 0, 0, 0, 2, 1, var8, Blocks.web,
                            Blocks.air, false);
                }
                ...
                for (var9 = 0; var9 < this.sectionCount; ++var9)
                {
                    ...
                    this.func_151549_a(par1World, par3StructureBoundingBox, 0,
                            0, var10, 0, 1, var10, Blocks.fence, Blocks.air,
                            false);
                    this.func_151549_a(par1World, par3StructureBoundingBox, 2,
                            0, var10, 2, 1, var10, Blocks.fence, Blocks.air,
                            false);

                    if (par2Random.nextInt(4) == 0)
                    {
                        this.func_151549_a(par1World, par3StructureBoundingBox,
                                0, 2, var10, 0, 2, var10, Blocks.planks,
                                Blocks.air, false);
                        this.func_151549_a(par1World, par3StructureBoundingBox,
                                2, 2, var10, 2, 2, var10, Blocks.planks,
                                Blocks.air, false);
                    }
                    else
                    {
                        this.func_151549_a(par1World, par3StructureBoundingBox,
                                0, 2, var10, 2, 2, var10, Blocks.planks,
                                Blocks.air, false);
                    }

                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.1F, 0, 2, var10 - 1, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.1F, 2, 2, var10 - 1, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.1F, 0, 2, var10 + 1, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.1F, 2, 2, var10 + 1, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.05F, 0, 2, var10 - 2, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.05F, 2, 2, var10 - 2, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.05F, 0, 2, var10 + 2, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.05F, 2, 2, var10 + 2, Blocks.web, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.05F, 1, 2, var10 - 1, Blocks.torch, 0);
                    this.func_151552_a(par1World, par3StructureBoundingBox,
                            par2Random, 0.05F, 1, 2, var10 + 1, Blocks.torch, 0);
                    ...
                    if (this.hasSpiders && !this.spawnerPlaced)
                    {
                                ...
                                var12))
                        {
                            ...
                            TileEntityMobSpawner var14 = (TileEntityMobSpawner)par1World
                ...
                for (var9 = 0; var9 <= 2; ++var9)
                {
                    ...
                    {
                        byte var16 = -1;
                        Block var17 = this.func_151548_a(par1World, var9,
                                var16, var10, par3StructureBoundingBox);
                ...
                if (this.hasRails)
                {
                    ...
                    {
                        Block var15 = this.func_151548_a(par1World, 1, -1,
                                var9, par3StructureBoundingBox);

                        if (var15.getMaterial() != Material.air
                                && var15.func_149730_j())
                        {
                            this.func_151552_a(par1World,
                                    par3StructureBoundingBox, par2Random, 0.7F,
                                    1, 0, var9, Blocks.rail,
    ...
    public static class Stairs extends StructureComponent
    {
        ...
        public static StructureBoundingBox findValidPlacement(List par0List,
                Random par1Random, int par2, int par3, int par4, int par5)
        {
            StructureBoundingBox var6 = new StructureBoundingBox(par2,
                    par3 - 5, par4, par2, par3 + 2, par4);
                ...
                StructureBoundingBox par3StructureBoundingBox)
        {
            ...
            {
                this.func_151549_a(par1World, par3StructureBoundingBox, 0, 5,
                        0, 2, 7, 1, Blocks.air, Blocks.air, false);
                this.func_151549_a(par1World, par3StructureBoundingBox, 0, 0,
                        7, 2, 2, 8, Blocks.air, Blocks.air, false);

                for (int var4 = 0; var4 < 5; ++var4)
                {
                    this.func_151549_a(par1World, par3StructureBoundingBox, 0,
                            5 - var4 - (var4 < 4 ? 1 : 0), 2 + var4, 2,
                            7 - var4, 2 + var4, Blocks.air, Blocks.air, false);
                }
