...
public class MapGenStronghold extends MapGenStructure
{
    ...
    protected boolean canSpawnStructureAtCoords(int par1, int par2)
    {
        if (!ranBiomeCheck)
        {
            ...
            for (int var7 = 0; var7 < structureCoords.length; ++var7)
            {
                ...
                ChunkPosition var12 = worldObj.getWorldChunkManager().findBiomePosition((var10 << 4) + 8, (var11 << 4) + 8, 112, field_151546_e, var3);
        ...
        for (int var5 = 0; var5 < var14; ++var5)
        {
            ...
            if (par1 == var15.chunkXPos && par2 == var15.chunkZPos) { return true; }
        }
    ...
    protected StructureStart getStructureStart(int par1, int par2)
    {
        ...
        for (var3 = new MapGenStronghold.Start(worldObj, rand, par1, par2); var3.getComponents().isEmpty() || ((StructureStrongholdPieces.Stairs2)var3.getComponents().get(0)).strongholdPortalRoom == null; var3 = new MapGenStronghold.Start(worldObj, rand, par1, par2))
        {
            ;
        }
