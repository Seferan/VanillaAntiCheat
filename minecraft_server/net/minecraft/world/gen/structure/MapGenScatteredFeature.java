...
public class MapGenScatteredFeature extends MapGenStructure
{
    ...
    public MapGenScatteredFeature()
    {
        ...
        this.scatteredFeatureSpawnList.add(new BiomeGenBase.SpawnListEntry(
    ...
    protected boolean canSpawnStructureAtCoords(int par1, int par2)
    {
        ...
        var5 += var7.nextInt(this.maxDistanceBetweenScatteredFeatures
                - this.minDistanceBetweenScatteredFeatures);
        var6 += var7.nextInt(this.maxDistanceBetweenScatteredFeatures
                - this.minDistanceBetweenScatteredFeatures);
    ...
    {
        return new MapGenScatteredFeature.Start(this.worldObj, this.rand, par1,
                par2);
    }
    ...
    public boolean func_143030_a(int par1, int par2, int par3)
    {
        ...
        {
            StructureComponent var5 = (StructureComponent)var4.components
                    .getFirst();
    ...
    public static class Start extends StructureStart
    {
        ...
        {
            super(par3, par4);
            BiomeGenBase var5 = par1World.getBiomeGenForCoords(par3 * 16 + 8,
                    par4 * 16 + 8);
            ...
            if (var5 != BiomeGenBase.jungle && var5 != BiomeGenBase.jungleHills)
            {
                ...
                {
                    ComponentScatteredFeaturePieces.SwampHut var8 = new ComponentScatteredFeaturePieces.SwampHut(
                            par2Random, par3 * 16, par4 * 16);
                    this.components.add(var8);
                }
                else
                {
                    ComponentScatteredFeaturePieces.DesertPyramid var7 = new ComponentScatteredFeaturePieces.DesertPyramid(
                            par2Random, par3 * 16, par4 * 16);
