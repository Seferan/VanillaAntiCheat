...
public class WorldGenMegaJungle extends WorldGenHugeTrees
{
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        {
            func_150543_c(par1World, par3, par5, par4 + var6, 2, par2Random);
            ...
            for (int var7 = par4 + var6 - 2 - par2Random.nextInt(4); var7 > par4 + var6 / 2; var7 -= 2 + par2Random.nextInt(4))
            {
                ...
                {
                    var9 = par3 + (int)(1.5F + MathHelper.cos(var8) * var11);
                    var10 = par5 + (int)(1.5F + MathHelper.sin(var8) * var11);
                    func_150516_a(par1World, var9, var7 - 3 + var11 / 2, var10, Blocks.log, woodMetadata);
                }
                ...
                for (int var13 = var7 - var11; var13 <= var12; ++var13)
                {
                    ...
                    func_150534_b(par1World, var9, var13, var10, 1 - var14, par2Random);
                }
            }
            ...
            for (int var15 = 0; var15 < var6; ++var15)
            {
                ...
                {
                    func_150516_a(par1World, par3, par4 + var15, par5, Blocks.log, woodMetadata);

                    if (var15 > 0)
                    {
                        if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + var15, par5))
                        {
                            func_150516_a(par1World, par3 - 1, par4 + var15, par5, Blocks.vine, 8);
                        }

                        if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var15, par5 - 1))
                        {
                            func_150516_a(par1World, par3, par4 + var15, par5 - 1, Blocks.vine, 1);
                        }
                    }
                }
                ...
                if (var15 < var6 - 1)
                {
                    ...
                    if (var16.getMaterial() == Material.air || var16.getMaterial() == Material.field_151584_j)
                    {
                        func_150516_a(par1World, par3 + 1, par4 + var15, par5, Blocks.log, woodMetadata);

                        if (var15 > 0)
                        {
                            if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 2, par4 + var15, par5))
                            {
                                func_150516_a(par1World, par3 + 2, par4 + var15, par5, Blocks.vine, 2);
                            }

                            if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + var15, par5 - 1))
                            {
                                func_150516_a(par1World, par3 + 1, par4 + var15, par5 - 1, Blocks.vine, 1);
                            }
                        }
                    }
                    ...
                    if (var16.getMaterial() == Material.air || var16.getMaterial() == Material.field_151584_j)
                    {
                        func_150516_a(par1World, par3 + 1, par4 + var15, par5 + 1, Blocks.log, woodMetadata);

                        if (var15 > 0)
                        {
                            if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 2, par4 + var15, par5 + 1))
                            {
                                func_150516_a(par1World, par3 + 2, par4 + var15, par5 + 1, Blocks.vine, 2);
                            }

                            if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 + 1, par4 + var15, par5 + 2))
                            {
                                func_150516_a(par1World, par3 + 1, par4 + var15, par5 + 2, Blocks.vine, 4);
                            }
                        }
                    }
                    ...
                    if (var16.getMaterial() == Material.air || var16.getMaterial() == Material.field_151584_j)
                    {
                        func_150516_a(par1World, par3, par4 + var15, par5 + 1, Blocks.log, woodMetadata);

                        if (var15 > 0)
                        {
                            if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3 - 1, par4 + var15, par5 + 1))
                            {
                                func_150516_a(par1World, par3 - 1, par4 + var15, par5 + 1, Blocks.vine, 8);
                            }

                            if (par2Random.nextInt(3) > 0 && par1World.isAirBlock(par3, par4 + var15, par5 + 2))
                            {
                                func_150516_a(par1World, par3, par4 + var15, par5 + 2, Blocks.vine, 4);
                            }
                        }
                    }
                }
    ...
    private void func_150543_c(World p_150543_1_, int p_150543_2_, int p_150543_3_, int p_150543_4_, int p_150543_5_, Random p_150543_6_)
    {
        ...
        for (int var8 = p_150543_4_ - var7; var8 <= p_150543_4_; ++var8)
        {
            ...
            func_150535_a(p_150543_1_, p_150543_2_, var8, p_150543_3_, p_150543_5_ + 1 - var9, p_150543_6_);
        }
    }
}
