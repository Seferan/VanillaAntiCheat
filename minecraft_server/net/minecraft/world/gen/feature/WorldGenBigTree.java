...
public class WorldGenBigTree extends WorldGenAbstractTree
{
    ...
    void generateLeafNodeList()
    {
        ...
        int var1 = (int)(1.382D + Math.pow(this.leafDensity
                * (double)this.heightLimit / 13.0D, 2.0D));
        ...
        while (var6 >= 0)
        {
            ...
            else
            {
                ...
                {
                    double var11 = this.scaleWidth * (double)var8
                            * ((double)this.rand.nextFloat() + 0.328D);
                    double var13 = (double)this.rand.nextFloat() * 2.0D
                            * Math.PI;
                    int var15 = MathHelper.floor_double(var11 * Math.sin(var13)
                            + (double)this.basePos[0] + var9);
                    int var16 = MathHelper.floor_double(var11 * Math.cos(var13)
                            + (double)this.basePos[2] + var9);
                    ...
                    if (this.checkBlockLine(var17, var18) == -1)
                    {
                        ...
                        double var20 = Math.sqrt(Math.pow(
                                (double)Math.abs(this.basePos[0] - var17[0]),
                                2.0D)
                                + Math.pow(
                                        (double)Math.abs(this.basePos[2]
                                                - var17[2]), 2.0D));
        ...
        for (var11[p_150529_5_] = var10[p_150529_5_]; var12 <= var7; ++var12)
        {
            ...
            while (var13 <= var7)
            {
                ...
                else
                {
                    ...
                    Block var14 = this.worldObj.getBlock(var11[0], var11[1],
                            var11[2]);

                    if (var14.getMaterial() != Material.air
                            && var14.getMaterial() != Material.field_151584_j)
                    {
                        ++var13;
                    }
                    else
                    {
                        this.func_150516_a(this.worldObj, var11[0], var11[1],
                                var11[2], p_150529_6_, 0);
                        ++var13;
                    }
                }
            }
    ...
    float layerSize(int par1)
    {
        ...
        else
        {
            ...
            {
                var4 = (float)Math.sqrt(Math.pow((double)Math.abs(var2), 2.0D)
                        - Math.pow((double)Math.abs(var3), 2.0D));
            }
        ...
        if (var4[var6] != 0)
        {
            ...
            for (int var16 = var4[var6] + var9; var15 != var16; var15 += var9)
            {
                var14[var6] = MathHelper
                        .floor_double((double)(p_150530_1_[var6] + var15) + 0.5D);
                var14[var7] = MathHelper.floor_double((double)p_150530_1_[var7]
                        + (double)var15 * var10 + 0.5D);
                var14[var8] = MathHelper.floor_double((double)p_150530_1_[var8]
                        + (double)var15 * var12 + 0.5D);
                byte var17 = 0;
                ...
                this.func_150516_a(this.worldObj, var14[0], var14[1], var14[2],
                        p_150530_3_, var17);
            }
        }
    }
        ...
        else
        {
            ...
            for (var15 = var3[var5] + var8; var14 != var15; var14 += var8)
            {
                ...
                var13[var6] = MathHelper
                        .floor_double((double)par1ArrayOfInteger[var6]
                                + (double)var14 * var9);
                var13[var7] = MathHelper
                        .floor_double((double)par1ArrayOfInteger[var7]
                                + (double)var14 * var11);
                Block var16 = this.worldObj.getBlock(var13[0], var13[1],
                        var13[2]);
    ...
    boolean validTreeLocation()
    {
        ...
        Block var3 = this.worldObj.getBlock(this.basePos[0],
