...
public class WorldGeneratorBonusChest extends WorldGenerator
{
            ...
            int par4, int par5)
    {
        ...
        while (((var6 = par1World.getBlock(par3, par4, par5)).getMaterial() == Material.air || var6
                .getMaterial() == Material.field_151584_j) && par4 > 1)
        {
            --par4;
        }
        ...
        else
        {
            ...
            for (int var7 = 0; var7 < 4; ++var7)
            {
                ...
                int var10 = par5 + par2Random.nextInt(4)
                        - par2Random.nextInt(4);

                if (par1World.isAirBlock(var8, var9, var10)
                        && World.doesBlockHaveSolidTopSurface(par1World, var8,
                                var9 - 1, var10))
                {
                    par1World.setBlock(var8, var9, var10, Blocks.chest, 0, 2);
                    TileEntityChest var11 = (TileEntityChest)par1World
                            .getTileEntity(var8, var9, var10);

                    if (var11 != null && var11 != null)
                    {
                        WeightedRandomChestContent.generateChestContents(
                                par2Random, this.theBonusChestGenerator, var11,
                                this.itemsToGenerateInBonusChest);
                    }

                    if (par1World.isAirBlock(var8 - 1, var9, var10)
                            && World.doesBlockHaveSolidTopSurface(par1World,
                                    var8 - 1, var9 - 1, var10))
                    {
                        par1World.setBlock(var8 - 1, var9, var10, Blocks.torch,
                                0, 2);
                    }
                    ...
                    if (par1World.isAirBlock(var8, var9, var10 - 1)
                            && World.doesBlockHaveSolidTopSurface(par1World,
                                    var8 - 1, var9 - 1, var10))
                    {
                        par1World.setBlock(var8, var9, var10 - 1, Blocks.torch,
                                0, 2);
                    }
