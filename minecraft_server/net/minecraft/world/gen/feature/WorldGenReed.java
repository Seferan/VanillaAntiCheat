            ...
            if (par1World.isAirBlock(var7, par4, var9)
                    && (par1World.getBlock(var7 - 1, par4 - 1, var9)
                            ...
                            || par1World.getBlock(var7, par4 - 1, var9 - 1)
                                    .getMaterial() == Material.field_151586_h || par1World
                            .getBlock(var7, par4 - 1, var9 + 1).getMaterial() == Material.field_151586_h))
            {
                int var10 = 2 + par2Random.nextInt(par2Random.nextInt(3) + 1);

                for (int var11 = 0; var11 < var10; ++var11)
                {
                    if (Blocks.reeds.canBlockStay(par1World, var7,
                            var8 + var11, var9))
                    {
