...
public abstract class WorldGenHugeTrees extends WorldGenAbstractTree
{
            ...
            for (int var8 = p_150536_4_; var8 <= p_150536_4_ + 1 + p_150536_6_; ++var8)
            {
                        ...
                        && var7; ++var10)
                {
                            ...
                            && var7; ++var11)
                    {
                        if (var8 >= 0 && var8 < 256)
                        {
                            Block var12 = p_150536_1_.getBlock(var10, var8,
                                    var11);
    ...
    {
        Block var6 = p_150532_1_.getBlock(p_150532_3_, p_150532_4_ - 1,
                p_150532_5_);
    ...
    {
        return this.func_150536_b(p_150537_1_, p_150537_2_, p_150537_3_,
                p_150537_4_, p_150537_5_, p_150537_6_)
                && this.func_150532_c(p_150537_1_, p_150537_2_, p_150537_3_,
            ...
            Random p_150535_6_)
    {
                ...
                + p_150535_5_ + 1; ++var8)
        {
                    ...
                    + p_150535_5_ + 1; ++var10)
            {
                ...
                {
                    Block var14 = p_150535_1_
                            .getBlock(var8, p_150535_3_, var10);

                    if (var14.getMaterial() == Material.air
                            || var14.getMaterial() == Material.field_151584_j)
                    {
                        this.func_150516_a(p_150535_1_, var8, p_150535_3_,
                                var10, Blocks.leaves, this.leavesMetadata);
                    }
                }
            }
        }
            ...
            Random p_150534_6_)
    {
                ...
                + p_150534_5_; ++var8)
        {
                    ...
                    + p_150534_5_; ++var10)
            {
                ...
                if (var9 * var9 + var11 * var11 <= var7)
                {
                    Block var12 = p_150534_1_
                            .getBlock(var8, p_150534_3_, var10);

                    if (var12.getMaterial() == Material.air
                            || var12.getMaterial() == Material.field_151584_j)
                    {
                        this.func_150516_a(p_150534_1_, var8, p_150534_3_,
                                var10, Blocks.leaves, this.leavesMetadata);
                    }
                }
            }
