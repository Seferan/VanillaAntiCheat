...
public class WorldGenSpikes extends WorldGenerator
{
            ...
            int par4, int par5)
    {
        if (par1World.isAirBlock(par3, par4, par5)
                && par1World.getBlock(par3, par4 - 1, par5) == this.field_150520_a)
        {
            ...
            for (var8 = par3 - var7; var8 <= par3 + var7; ++var8)
            {
                for (var9 = par5 - var7; var9 <= par5 + var7; ++var9)
                {
                    ...
                    if (var10 * var10 + var11 * var11 <= var7 * var7 + 1
                            && par1World.getBlock(var8, par4 - 1, var9) != this.field_150520_a) { return false; }
                }
            }
            ...
            for (var8 = par4; var8 < par4 + var6 && var8 < 256; ++var8)
            {
                for (var9 = par3 - var7; var9 <= par3 + var7; ++var9)
                {
                    for (var10 = par5 - var7; var10 <= par5 + var7; ++var10)
                    {
                        ...
                        {
                            par1World.setBlock(var9, var8, var10,
                                    Blocks.obsidian, 0, 2);
                        }
                    }
                }
            ...
            var13.setLocationAndAngles((double)((float)par3 + 0.5F),
                    (double)(par4 + var6), (double)((float)par5 + 0.5F),
                    par2Random.nextFloat() * 360.0F, 0.0F);
