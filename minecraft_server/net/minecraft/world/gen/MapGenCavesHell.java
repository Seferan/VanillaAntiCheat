...
public class MapGenCavesHell extends MapGenBase
{
    ...
    {
        this.func_151543_a(p_151544_1_, p_151544_3_, p_151544_4_, p_151544_5_,
            ...
            int p_151543_16_, double p_151543_17_)
    {
        ...
        {
            double var29 = 1.5D + (double)(MathHelper.sin((float)p_151543_15_
                    * (float)Math.PI / (float)p_151543_16_)
                    * p_151543_12_ * 1.0F);
            ...
            {
                this.func_151543_a(var25.nextLong(), p_151543_3_, p_151543_4_,
            ...
            if (var53 || var25.nextInt(4) != 0)
            {
                        ...
                        && p_151543_10_ <= var21 + 16.0D + var29 * 2.0D)
                {
                    ...
                    int var55 = MathHelper.floor_double(p_151543_10_ - var29)
                            - p_151543_4_ * 16 - 1;
                    ...
                    if (!var57)
                    {
                        ...
                        {
                            double var59 = ((double)(var42 + p_151543_3_ * 16) + 0.5D - p_151543_6_)
                                    / var29;

                            for (var45 = var55; var45 < var40; ++var45)
                            {
                                double var58 = ((double)(var45 + p_151543_4_ * 16) + 0.5D - p_151543_10_)
                                        / var29;
                                int var48 = (var42 * 16 + var45) * 128 + var38;

                                for (int var49 = var38 - 1; var49 >= var56; --var49)
                                {
                                    double var50 = ((double)var49 + 0.5D - p_151543_8_)
                                            / var31;

                                    if (var50 > -0.7D
                                            && var59 * var59 + var50 * var50
                                                    + var58 * var58 < 1.0D)
                                    {
            ...
            Block[] p_151538_6_)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            {
                this.func_151544_a(this.rand.nextLong(), p_151538_4_,
                        p_151538_5_, p_151538_6_, var9, var11, var13);
            ...
            for (int var16 = 0; var16 < var15; ++var16)
            {
                ...
                float var19 = this.rand.nextFloat() * 2.0F
                        + this.rand.nextFloat();
                this.func_151543_a(this.rand.nextLong(), p_151538_4_,
                        p_151538_5_, p_151538_6_, var9, var11, var13,
