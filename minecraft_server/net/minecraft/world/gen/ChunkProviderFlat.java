...
public class ChunkProviderFlat implements IChunkProvider
{
            ...
            String par5Str)
    {
        ...
        this.flatWorldGenInfo = FlatGeneratorInfo
                .createFlatGeneratorFromString(par5Str);
        ...
        if (par4)
        {
            ...
            if (var6.containsKey("biome_1"))
            {
                this.structureGenerators.add(new MapGenScatteredFeature(
                        (Map)var6.get("biome_1")));
            }

            if (var6.containsKey("mineshaft"))
            {
                this.structureGenerators.add(new MapGenMineshaft((Map)var6
                        .get("mineshaft")));
            }

            if (var6.containsKey("stronghold"))
            {
                this.structureGenerators.add(new MapGenStronghold((Map)var6
                        .get("stronghold")));
            }
        }

        this.hasDecoration = this.flatWorldGenInfo.getWorldFeatures()
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        BiomeGenBase[] var10 = this.worldObj.getWorldChunkManager()
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        this.random.setSeed((long)par2 * var8 + (long)par3 * var10
        ...
        {
            MapGenStructure var13 = (MapGenStructure)var12.next();
            boolean var14 = var13.generateStructuresInChunk(this.worldObj,
                    this.random, par2, par3);
                ...
                && this.random.nextInt(4) == 0)
        {
            ...
            this.waterLakeGenerator.generate(this.worldObj, this.random, var16,
                    var17, var18);
        }

        if (this.lavaLakeGenerator != null && !var7
                && this.random.nextInt(8) == 0)
        {
            ...
            {
                this.lavaLakeGenerator.generate(this.worldObj, this.random,
                        var16, var17, var18);
            }
        }
            ...
            int p_147416_3_, int p_147416_4_, int p_147416_5_)
    {
        if ("Stronghold".equals(p_147416_2_))
        {
            ...
            while (var6.hasNext())
            {
                ...
                if (var7 instanceof MapGenStronghold) { return var7
