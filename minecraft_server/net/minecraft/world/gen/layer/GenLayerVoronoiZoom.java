...
public class GenLayerVoronoiZoom extends GenLayer
{
    ...
    public int[] getInts(int par1, int par2, int par3, int par4)
    {
        ...
        for (int var13 = 0; var13 < var8 - 1; ++var13)
        {
            ...
            for (int var16 = var9[var14 + 0 + (var13 + 1) * var7]; var14 < var7 - 1; ++var14)
            {
                ...
                for (int var37 = 0; var37 < 4; ++var37)
                {
                    ...
                    {
                        double var40 = ((double)var37 - var21)
                                * ((double)var37 - var21)
                                + ((double)var39 - var19)
                                * ((double)var39 - var19);
                        double var42 = ((double)var37 - var25)
                                * ((double)var37 - var25)
                                + ((double)var39 - var23)
                                * ((double)var39 - var23);
                        double var44 = ((double)var37 - var29)
                                * ((double)var37 - var29)
                                + ((double)var39 - var27)
                                * ((double)var39 - var27);
                        double var46 = ((double)var37 - var33)
                                * ((double)var37 - var33)
                                + ((double)var39 - var31)
                                * ((double)var39 - var31);
        ...
        {
            System.arraycopy(var12, (var14 + (par2 & 3)) * var10 + (par1 & 3),
                    var48, var14 * par3, par3);
        }
