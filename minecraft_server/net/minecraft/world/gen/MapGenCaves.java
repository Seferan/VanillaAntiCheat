...
public class MapGenCaves extends MapGenBase
{
            ...
            int p_151541_16_, double p_151541_17_)
    {
        ...
        {
            double var29 = 1.5D + (double)(MathHelper.sin((float)p_151541_15_
                    * (float)Math.PI / (float)p_151541_16_)
                    * p_151541_12_ * 1.0F);
            ...
            if (!var54 && p_151541_15_ == var27 && p_151541_12_ > 1.0F
                    && p_151541_16_ > 0)
            {
                this.func_151541_a(var25.nextLong(), p_151541_3_, p_151541_4_,
            ...
            if (var54 || var25.nextInt(4) != 0)
            {
                        ...
                        && p_151541_10_ <= var21 + 16.0D + var29 * 2.0D)
                {
                    ...
                    int var56 = MathHelper.floor_double(p_151541_10_ - var29)
                            - p_151541_4_ * 16 - 1;
                    ...
                    if (!var58)
                    {
                        ...
                        {
                            double var60 = ((double)(var42 + p_151541_3_ * 16) + 0.5D - p_151541_6_)
                                    / var29;

                            for (var45 = var56; var45 < var40; ++var45)
                            {
                                double var59 = ((double)(var45 + p_151541_4_ * 16) + 0.5D - p_151541_10_)
                                        / var29;
                                ...
                                if (var60 * var60 + var59 * var59 < 1.0D)
                                {
                                    ...
                                    {
                                        double var51 = ((double)var50 + 0.5D - p_151541_8_)
                                                / var31;

                                        if (var51 > -0.7D
                                                && var60 * var60 + var51
                                                        * var51 + var59 * var59 < 1.0D)
                                        {
                                                    ...
                                                    || var53 == Blocks.grass)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        p_151541_5_[var48 - 1] = this.worldObj
            ...
            Block[] p_151538_6_)
    {
        ...
        for (int var8 = 0; var8 < var7; ++var8)
        {
            ...
            double var11 = (double)this.rand
                    .nextInt(this.rand.nextInt(120) + 8);
            ...
            for (int var16 = 0; var16 < var15; ++var16)
            {
                ...
                this.func_151541_a(this.rand.nextLong(), p_151538_4_,
                        p_151538_5_, p_151538_6_, var9, var11, var13, var19,
