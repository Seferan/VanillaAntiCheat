...
public class BlockTNT extends Block
{
            ...
            int p_149726_3_, int p_149726_4_)
    {
        ...
        {
            this.onBlockDestroyedByPlayer(p_149726_1_, p_149726_2_,
                    p_149726_3_, p_149726_4_, 1);
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        {
            this.onBlockDestroyedByPlayer(p_149695_1_, p_149695_2_,
            ...
            int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
            EntityTNTPrimed var6 = new EntityTNTPrimed(p_149723_1_,
    ...
    {
        this.func_150114_a(p_149664_1_, p_149664_2_, p_149664_3_, p_149664_4_,
            ...
            EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.isClient)
        {
            if ((p_150114_5_ & 1) == 1)
            {
                EntityTNTPrimed var7 = new EntityTNTPrimed(p_150114_1_,
                        (double)((float)p_150114_2_ + 0.5F),
                        (double)((float)p_150114_3_ + 0.5F),
            ...
            float p_149727_9_)
    {
        ...
        {
            this.func_150114_a(p_149727_1_, p_149727_2_, p_149727_3_,
                    p_149727_4_, 1, p_149727_5_);
