...
public class BlockDragonEgg extends Block
{
            ...
            int p_149726_3_, int p_149726_4_)
    {
        p_149726_1_.scheduleBlockUpdate(p_149726_2_, p_149726_3_, p_149726_4_,
                this, this.func_149738_a(p_149726_1_));
    }
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        p_149695_1_.scheduleBlockUpdate(p_149695_2_, p_149695_3_, p_149695_4_,
                this, this.func_149738_a(p_149695_1_));
    }
            ...
            if (!BlockFalling.fallInstantly
                    && p_150018_1_.checkChunksExist(p_150018_2_ - var5,
                            p_150018_3_ - var5, p_150018_4_ - var5, p_150018_2_
                                    ...
                                    + var5))
            {
                EntityFallingBlock var6 = new EntityFallingBlock(p_150018_1_,
                        (double)((float)p_150018_2_ + 0.5F),
                        (double)((float)p_150018_3_ + 0.5F),
                        (double)((float)p_150018_4_ + 0.5F), this);
            ...
            int p_150019_3_, int p_150019_4_)
    {
        if (p_150019_1_.getBlock(p_150019_2_, p_150019_3_, p_150019_4_) == this)
        {
            ...
            {
                int var6 = p_150019_2_ + p_150019_1_.rand.nextInt(16)
                        - p_150019_1_.rand.nextInt(16);
                int var7 = p_150019_3_ + p_150019_1_.rand.nextInt(8)
                        - p_150019_1_.rand.nextInt(8);
                int var8 = p_150019_4_ + p_150019_1_.rand.nextInt(16)
                        - p_150019_1_.rand.nextInt(16);
                    ...
                    else
                    {
                        ...
                        for (int var10 = 0; var10 < var9; ++var10)
                        {
                            ...
                            double var16 = (double)var6
                                    + (double)(p_150019_2_ - var6) * var11
                                    + (p_150019_1_.rand.nextDouble() - 0.5D)
                                    * 1.0D + 0.5D;
                            double var18 = (double)var7
                                    + (double)(p_150019_3_ - var7) * var11
                                    + p_150019_1_.rand.nextDouble() * 1.0D
                                    - 0.5D;
                            double var20 = (double)var8
                                    + (double)(p_150019_4_ - var8) * var11
                                    + (p_150019_1_.rand.nextDouble() - 0.5D)
                                    * 1.0D + 0.5D;
                            p_150019_1_.spawnParticle("portal", var16, var18,
                                    var20, (double)var13, (double)var14,
                                    (double)var15);
                        }
                    }
