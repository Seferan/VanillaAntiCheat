...
public class BlockDragonEgg extends Block
{
    ...
    private void func_150018_e(World p_150018_1_, int p_150018_2_, int p_150018_3_, int p_150018_4_)
    {
        if (BlockFalling.func_149831_e(p_150018_1_, p_150018_2_, p_150018_3_ - 1, p_150018_4_) && p_150018_3_ >= 0)
        {
            ...
            {
                EntityFallingBlock var6 = new EntityFallingBlock(p_150018_1_, p_150018_2_ + 0.5F, p_150018_3_ + 0.5F, p_150018_4_ + 0.5F, this);
                ...
                if (p_150019_1_.getBlock(var6, var7, var8).blockMaterial == Material.air)
                {
                    ...
                    else
                    {
                        ...
                        for (int var10 = 0; var10 < var9; ++var10)
                        {
                            ...
                            double var16 = var6 + (p_150019_2_ - var6) * var11 + (p_150019_1_.rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
                            double var18 = var7 + (p_150019_3_ - var7) * var11 + p_150019_1_.rand.nextDouble() * 1.0D - 0.5D;
                            double var20 = var8 + (p_150019_4_ - var8) * var11 + (p_150019_1_.rand.nextDouble() - 0.5D) * 1.0D + 0.5D;
