...
public class BlockDoor extends Block
{
    ...
    {
        int var5 = this.func_150012_g(p_149655_1_, p_149655_2_, p_149655_3_,
                p_149655_4_);
        return (var5 & 4) != 0;
    }
    ...
    {
        this.func_150011_b(this.func_150012_g(p_149719_1_, p_149719_2_,
    ...
    {
        return this.func_150012_g(p_150013_1_, p_150013_2_, p_150013_3_,
                p_150013_4_) & 3;
    }
    ...
    {
        return (this.func_150012_g(p_150015_1_, p_150015_2_, p_150015_3_,
                p_150015_4_) & 4) != 0;
    }
    ...
    private void func_150011_b(int p_150011_1_)
    {
        ...
        if (var3 == 0)
        {
            if (var4)
            {
                ...
                {
                    this.setBlockBounds(0.0F, 0.0F, 1.0F - var2, 1.0F, 1.0F,
                            1.0F);
                }
            }
            else
        ...
        else if (var3 == 1)
        {
            if (var4)
            {
                if (!var5)
                {
                    this.setBlockBounds(1.0F - var2, 0.0F, 0.0F, 1.0F, 1.0F,
                            1.0F);
                }
                else
                {
            ...
            float p_149727_9_)
    {
        ...
        {
            int var10 = this.func_150012_g(p_149727_1_, p_149727_2_,
            ...
            if ((var10 & 8) == 0)
            {
                p_149727_1_.setBlockMetadata(p_149727_2_, p_149727_3_,
                        p_149727_4_, var11, 2);
            ...
            {
                p_149727_1_.setBlockMetadata(p_149727_2_, p_149727_3_ - 1,
                        p_149727_4_, var11, 2);
                p_149727_1_.markBlockRangeForRenderUpdate(p_149727_2_,
    ...
    {
        int var6 = this.func_150012_g(p_150014_1_, p_150014_2_, p_150014_3_,
                p_150014_4_);
        ...
        if (var7 != p_150014_5_)
        {
            ...
            if ((var6 & 8) == 0)
            {
                p_150014_1_.setBlockMetadata(p_150014_2_, p_150014_3_,
                        p_150014_4_, var8, 2);
            ...
            {
                p_150014_1_.setBlockMetadata(p_150014_2_, p_150014_3_ - 1,
                        p_150014_4_, var8, 2);
                p_150014_1_.markBlockRangeForRenderUpdate(p_150014_2_,
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if ((var6 & 8) == 0)
        {
            ...
            {
                boolean var8 = p_149695_1_.isBlockIndirectlyGettingPowered(
                ...
                if ((var8 || p_149695_5_.canProvidePower())
                        && p_149695_5_ != this)
                {
                    this.func_150014_a(p_149695_1_, p_149695_2_, p_149695_3_,
                            p_149695_4_, var8);
                }
            }
        }
        else
        {
            ...
            if (p_149695_5_ != this)
            {
                this.onNeighborBlockChange(p_149695_1_, p_149695_2_,
    ...
    {
        int var5 = p_150012_1_.getBlockMetadata(p_150012_2_, p_150012_3_,
                p_150012_4_);
