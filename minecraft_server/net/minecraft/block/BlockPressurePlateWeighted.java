...
public class BlockPressurePlateWeighted extends BlockBasePressurePlate
{
    ...
    {
        int var5 = Math.min(p_150065_1_.getEntitiesWithinAABB(Entity.class, func_150061_a(p_150065_2_, p_150065_3_, p_150065_4_)).size(), field_150068_a);
        ...
        {
            float var6 = (float)Math.min(field_150068_a, var5) / (float)field_150068_a;
