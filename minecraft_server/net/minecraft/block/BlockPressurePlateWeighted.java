...
public class BlockPressurePlateWeighted extends BlockBasePressurePlate
{
    ...
    {
        int var5 = Math.min(
                p_150065_1_.getEntitiesWithinAABB(
                        Entity.class,
                        this.func_150061_a(p_150065_2_, p_150065_3_,
                                p_150065_4_)).size(), this.field_150068_a);
        ...
        {
            float var6 = (float)Math.min(this.field_150068_a, var5)
