...
public class BlockCake extends Block
{
            ...
            int p_149668_2_, int p_149668_3_, int p_149668_4_)
    {
        ...
        return AxisAlignedBB.getAABBPool().getAABB(
                (double)((float)p_149668_2_ + var7), (double)p_149668_3_,
                (double)((float)p_149668_4_ + var6),
                (double)((float)(p_149668_2_ + 1) - var6),
                (double)((float)p_149668_3_ + var8 - var6),
                (double)((float)(p_149668_4_ + 1) - var6));
    }
    ...
    {
        this.func_150036_b(p_149699_1_, p_149699_2_, p_149699_3_, p_149699_4_,
                p_149699_5_);
    }
            ...
            int p_150036_3_, int p_150036_4_, EntityPlayer p_150036_5_)
    {
        if (p_150036_5_.canEat(false))
        {
            ...
            int var6 = p_150036_1_.getBlockMetadata(p_150036_2_, p_150036_3_,
                    p_150036_4_) + 1;
            ...
            {
                p_150036_1_.setBlockMetadata(p_150036_2_, p_150036_3_,
                        p_150036_4_, var6, 2);
            }
        }
    }
