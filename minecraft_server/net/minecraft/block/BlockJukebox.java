...
public class BlockJukebox extends BlockContainer
{
            ...
            float p_149727_9_)
    {
        ...
        {
            this.func_149925_e(p_149727_1_, p_149727_2_, p_149727_3_,
                    p_149727_4_);
            return true;
        }
    }
            ...
            int p_149926_3_, int p_149926_4_, ItemStack p_149926_5_)
    {
        if (!p_149926_1_.isClient)
        {
            ...
            if (var6 != null)
            {
                ...
                p_149926_1_.setBlockMetadata(p_149926_2_, p_149926_3_,
                        p_149926_4_, 1, 2);
            }
        }
    }
        ...
        if (!p_149925_1_.isClient)
        {
            ...
            if (var5 != null)
            {
                ...
                if (var6 != null)
                {
                    ...
                    p_149925_1_.setBlockMetadata(p_149925_2_, p_149925_3_,
                            p_149925_4_, 0, 2);
                    float var7 = 0.7F;
                    double var8 = (double)(p_149925_1_.rand.nextFloat() * var7)
                            + (double)(1.0F - var7) * 0.5D;
                    double var10 = (double)(p_149925_1_.rand.nextFloat() * var7)
                            + (double)(1.0F - var7) * 0.2D + 0.6D;
                    double var12 = (double)(p_149925_1_.rand.nextFloat() * var7)
                            + (double)(1.0F - var7) * 0.5D;
                    ItemStack var14 = var6.copy();
                    EntityItem var15 = new EntityItem(p_149925_1_,
                            (double)p_149925_2_ + var8, (double)p_149925_3_
                                    + var10, (double)p_149925_4_ + var12, var14);
    ...
    {
        ItemStack var6 = ((BlockJukebox.TileEntityJukebox)p_149736_1_
    ...
    public static class TileEntityJukebox extends TileEntity
    {
        ...
        public void readFromNBT(NBTTagCompound p_145839_1_)
        {
            ...
            {
                this.func_145857_a(ItemStack.loadItemStackFromNBT(p_145839_1_
                        .getCompoundTag("RecordItem")));
            }
            else if (p_145839_1_.getInteger("Record") > 0)
            {
                this.func_145857_a(new ItemStack(Item.getItemById(p_145839_1_
        ...
        public void writeToNBT(NBTTagCompound p_145841_1_)
        {
            ...
            {
                p_145841_1_.setTag("RecordItem", this.func_145856_a()
                        .writeToNBT(new NBTTagCompound()));
                p_145841_1_.setInteger("Record",
                        Item.getIdFromItem(this.func_145856_a().getItem()));
            }
        }
