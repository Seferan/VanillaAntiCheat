...
public abstract class BlockRedstoneDiode extends BlockDirectional
{
            ...
            int p_149674_4_, Random p_149674_5_)
    {
        ...
        if (!this.func_149910_g(p_149674_1_, p_149674_2_, p_149674_3_,
                p_149674_4_, var6))
        {
            boolean var7 = this.func_149900_a(p_149674_1_, p_149674_2_,
                    p_149674_3_, p_149674_4_, var6);

            if (this.field_149914_a && !var7)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_,
                        this.func_149898_i(), var6, 2);
            }
            else if (!this.field_149914_a)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_,
                        this.func_149906_e(), var6, 2);

                if (!var7)
                {
                    p_149674_1_.func_147454_a(p_149674_2_, p_149674_3_,
                            p_149674_4_, this.func_149906_e(),
    ...
    {
        return this.isProvidingWeakPower(p_149748_1_, p_149748_2_, p_149748_3_,
    ...
    {
        int var6 = p_149709_1_.getBlockMetadata(p_149709_2_, p_149709_3_,
                p_149709_4_);
        ...
        else
        {
            ...
            return var7 == 0 && p_149709_5_ == 3 ? this.func_149904_f(
                    p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_, var6)
                    : (var7 == 1 && p_149709_5_ == 4 ? this.func_149904_f(
                            p_149709_1_, p_149709_2_, p_149709_3_, p_149709_4_,
                            var6)
                            : (var7 == 2 && p_149709_5_ == 2 ? this
                                    .func_149904_f(p_149709_1_, p_149709_2_,
                                            p_149709_3_, p_149709_4_, var6)
                                    : (var7 == 3 && p_149709_5_ == 5 ? this
                                            .func_149904_f(p_149709_1_,
                                                    p_149709_2_, p_149709_3_,
                                                    p_149709_4_, var6) : 0)));
        }
    }
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        {
            this.func_149897_b(p_149695_1_, p_149695_2_, p_149695_3_,
    ...
    {
        int var6 = p_149897_1_.getBlockMetadata(p_149897_2_, p_149897_3_,
                p_149897_4_);

        if (!this.func_149910_g(p_149897_1_, p_149897_2_, p_149897_3_,
                p_149897_4_, var6))
        {
            boolean var7 = this.func_149900_a(p_149897_1_, p_149897_2_,
                            ...
                            p_149897_4_, this))
            {
                ...
                if (this.func_149912_i(p_149897_1_, p_149897_2_, p_149897_3_,
                        p_149897_4_, var6))
                {
                    var8 = -3;
                }
                ...
                p_149897_1_.func_147454_a(p_149897_2_, p_149897_3_,
                        p_149897_4_, this, this.func_149901_b(var6), var8);
            }
        }
    }
    ...
    {
        return this.func_149903_h(p_149900_1_, p_149900_2_, p_149900_3_,
            ...
            int p_149903_3_, int p_149903_4_, int p_149903_5_)
    {
        ...
        int var9 = p_149903_1_.getIndirectPowerLevelTo(var7, p_149903_3_, var8,
            ...
            int p_149902_3_, int p_149902_4_, int p_149902_5_)
    {
        ...
        case 0:
        case 2:
            return Math.max(this.func_149913_i(p_149902_1_, p_149902_2_ - 1,
                    p_149902_3_, p_149902_4_, 4), this.func_149913_i(
                    p_149902_1_, p_149902_2_ + 1, p_149902_3_, p_149902_4_, 5));

        case 1:
        case 3:
            return Math.max(this.func_149913_i(p_149902_1_, p_149902_2_,
                    p_149902_3_, p_149902_4_ + 1, 3), this.func_149913_i(
                    p_149902_1_, p_149902_2_, p_149902_3_, p_149902_4_ - 1, 2));
    ...
    {
        Block var6 = p_149913_1_
                .getBlock(p_149913_2_, p_149913_3_, p_149913_4_);
        return this.func_149908_a(var6) ? (var6 == Blocks.redstone_wire ? p_149913_1_
                .getBlockMetadata(p_149913_2_, p_149913_3_, p_149913_4_)
                : p_149913_1_.isBlockProvidingPowerTo(p_149913_2_, p_149913_3_,
                        p_149913_4_, p_149913_5_))
                : 0;
    }
            ...
            ItemStack p_149689_6_)
    {
        ...
        p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_, p_149689_4_,
                var7, 3);
        boolean var8 = this.func_149900_a(p_149689_1_, p_149689_2_,
    ...
    {
        int var5 = func_149895_l(p_149911_1_.getBlockMetadata(p_149911_2_,
                p_149911_3_, p_149911_4_));
    ...
    {
        return p_149907_1_ == this.func_149906_e()
                || p_149907_1_ == this.func_149898_i();
    }
            ...
            int p_149912_3_, int p_149912_4_, int p_149912_5_)
    {
        ...
        {
            int var7 = p_149912_1_.getBlockMetadata(p_149912_2_
                    - Direction.offsetX[var6], p_149912_3_, p_149912_4_
                    - Direction.offsetZ[var6]);
