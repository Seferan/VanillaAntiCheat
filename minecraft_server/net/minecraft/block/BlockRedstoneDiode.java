...
public abstract class BlockRedstoneDiode extends BlockDirectional
{
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        if (!func_149910_g(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, var6))
        {
            boolean var7 = func_149900_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, var6);

            if (field_149914_a && !var7)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, func_149898_i(), var6, 2);
            }
            else if (!field_149914_a)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, func_149906_e(), var6, 2);

                if (!var7)
                {
                    p_149674_1_.func_147454_a(p_149674_2_, p_149674_3_, p_149674_4_, func_149906_e(), func_149899_k(var6), -1);
                }
            }
        }
    }
    ...
    protected void func_149897_b(World p_149897_1_, int p_149897_2_, int p_149897_3_, int p_149897_4_, Block p_149897_5_)
    {
        ...
        if (!func_149910_g(p_149897_1_, p_149897_2_, p_149897_3_, p_149897_4_, var6))
        {
            boolean var7 = func_149900_a(p_149897_1_, p_149897_2_, p_149897_3_, p_149897_4_, var6);

            if ((field_149914_a && !var7 || !field_149914_a && var7) && !p_149897_1_.func_147477_a(p_149897_2_, p_149897_3_, p_149897_4_, this))
            {
                byte var8 = -1;
                ...
                p_149897_1_.func_147454_a(p_149897_2_, p_149897_3_, p_149897_4_, this, func_149901_b(var6), var8);
            }
        }
    }
    ...
    {
        return func_149903_h(p_149900_1_, p_149900_2_, p_149900_3_, p_149900_4_, p_149900_5_) > 0;
    }
    ...
    protected int func_149902_h(IBlockAccess p_149902_1_, int p_149902_2_, int p_149902_3_, int p_149902_4_, int p_149902_5_)
    {
        ...
        case 0:
        case 2:
            return Math.max(func_149913_i(p_149902_1_, p_149902_2_ - 1, p_149902_3_, p_149902_4_, 4), func_149913_i(p_149902_1_, p_149902_2_ + 1, p_149902_3_, p_149902_4_, 5));

        case 1:
        case 3:
            return Math.max(func_149913_i(p_149902_1_, p_149902_2_, p_149902_3_, p_149902_4_ + 1, 3), func_149913_i(p_149902_1_, p_149902_2_, p_149902_3_, p_149902_4_ - 1, 2));
    ...
    protected int func_149913_i(IBlockAccess p_149913_1_, int p_149913_2_, int p_149913_3_, int p_149913_4_, int p_149913_5_)
    {
        ...
        return func_149908_a(var6) ? (var6 == Blocks.redstone_wire ? p_149913_1_.getBlockMetadata(p_149913_2_, p_149913_3_, p_149913_4_) : p_149913_1_.isBlockProvidingPowerTo(p_149913_2_, p_149913_3_, p_149913_4_, p_149913_5_)) : 0;
    }
    ...
    public void onBlockPlacedBy(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        boolean var8 = func_149900_a(p_149689_1_, p_149689_2_, p_149689_3_, p_149689_4_, var7);
