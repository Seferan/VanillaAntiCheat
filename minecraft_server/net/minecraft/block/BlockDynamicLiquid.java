...
public class BlockDynamicLiquid extends BlockLiquid
{
    ...
    {
        int var5 = p_149811_1_.getBlockMetadata(p_149811_2_, p_149811_3_,
                p_149811_4_);
    ...
    {
        int var6 = this.func_149804_e(p_149674_1_, p_149674_2_, p_149674_3_,
                p_149674_4_);
        byte var7 = 1;

        if (this.blockMaterial == Material.field_151587_i
                && !p_149674_1_.provider.isHellWorld)
        {
            var7 = 2;
        }
        ...
        if (var6 > 0)
        {
            ...
            int var13 = this.func_149810_a(p_149674_1_, p_149674_2_ - 1,
                    p_149674_3_, p_149674_4_, var10);
            var13 = this.func_149810_a(p_149674_1_, p_149674_2_ + 1,
                    p_149674_3_, p_149674_4_, var13);
            var13 = this.func_149810_a(p_149674_1_, p_149674_2_, p_149674_3_,
                    p_149674_4_ - 1, var13);
            var13 = this.func_149810_a(p_149674_1_, p_149674_2_, p_149674_3_,
                    p_149674_4_ + 1, var13);
            var11 = var13 + var7;
            ...
            if (this.func_149804_e(p_149674_1_, p_149674_2_, p_149674_3_ + 1,
                    p_149674_4_) >= 0)
            {
                int var12 = this.func_149804_e(p_149674_1_, p_149674_2_,
                    ...
                    && this.blockMaterial == Material.field_151586_h)
            {
                        ...
                        .getMaterial().isSolid())
                {
                    var11 = 0;
                        ...
                        p_149674_4_).getMaterial() == this.blockMaterial
            ...
            if (this.blockMaterial == Material.field_151587_i && var6 < 8
                    && var11 < 8 && var11 > var6 && p_149674_5_.nextInt(4) != 0)
            {
                var9 *= 4;
            }
            ...
            if (var11 == var6)
            {
                if (var8)
                {
                    this.func_149811_n(p_149674_1_, p_149674_2_, p_149674_3_,
                            p_149674_4_);
                }
            }
            else
        ...
        if (this.func_149809_q(p_149674_1_, p_149674_2_, p_149674_3_ - 1,
                p_149674_4_))
        {
            if (this.blockMaterial == Material.field_151587_i
                    && p_149674_1_.getBlock(p_149674_2_, p_149674_3_ - 1,
                            p_149674_4_).getMaterial() == Material.field_151586_h)
            {
                p_149674_1_.setBlock(p_149674_2_, p_149674_3_ - 1, p_149674_4_,
                        Blocks.stone);
                this.func_149799_m(p_149674_1_, p_149674_2_, p_149674_3_ - 1,
                        p_149674_4_);
                return;
            }
            ...
            if (var6 >= 8)
            {
                this.func_149813_h(p_149674_1_, p_149674_2_, p_149674_3_ - 1,
                        p_149674_4_, var6);
            }
            else
            {
                ...
                && (var6 == 0 || this.func_149807_p(p_149674_1_, p_149674_2_,
                        p_149674_3_ - 1, p_149674_4_)))
        {
            boolean[] var14 = this.func_149808_o(p_149674_1_, p_149674_2_,
            ...
            if (var14[0])
            {
                this.func_149813_h(p_149674_1_, p_149674_2_ - 1, p_149674_3_,
                        p_149674_4_, var11);
            }
            ...
            if (var14[2])
            {
                this.func_149813_h(p_149674_1_, p_149674_2_, p_149674_3_,
                        p_149674_4_ - 1, var11);
            }
    ...
    {
        if (this.func_149809_q(p_149813_1_, p_149813_2_, p_149813_3_,
                p_149813_4_))
        {
            Block var6 = p_149813_1_.getBlock(p_149813_2_, p_149813_3_,
                    p_149813_4_);

            if (this.blockMaterial == Material.field_151587_i)
            {
                this.func_149799_m(p_149813_1_, p_149813_2_, p_149813_3_,
                        p_149813_4_);
            }
            else
            {
                    ...
                    && (var8 != 3 || p_149812_6_ != 2))
            {
                ...
                if (!this.func_149807_p(p_149812_1_, var9, p_149812_3_, var11)
                        && (p_149812_1_.getBlock(var9, p_149812_3_, var11)
                                .getMaterial() != this.blockMaterial || p_149812_1_
                                .getBlockMetadata(var9, p_149812_3_, var11) != 0))
                {
                    if (!this.func_149807_p(p_149812_1_, var9, p_149812_3_ - 1,
                            var11)) { return p_149812_5_; }

                    if (p_149812_5_ < 4)
                    {
                        int var12 = this.func_149812_c(p_149812_1_, var9,
        ...
        for (var5 = 0; var5 < 4; ++var5)
        {
            ...
            if (!this.func_149807_p(p_149808_1_, var6, p_149808_3_, var8)
                    && (p_149808_1_.getBlock(var6, p_149808_3_, var8)
                            .getMaterial() != this.blockMaterial || p_149808_1_
                            .getBlockMetadata(var6, p_149808_3_, var8) != 0))
            {
                if (this.func_149807_p(p_149808_1_, var6, p_149808_3_ - 1, var8))
                {
                    this.field_149816_M[var5] = this.func_149812_c(p_149808_1_,
                            var6, p_149808_3_, var8, 1, var5);
                }
                else
                {
    ...
    {
        Block var5 = p_149807_1_
                .getBlock(p_149807_2_, p_149807_3_, p_149807_4_);
        return var5 != Blocks.wooden_door && var5 != Blocks.iron_door
                && var5 != Blocks.standing_sign && var5 != Blocks.ladder
                && var5 != Blocks.reeds ? (var5.blockMaterial == Material.field_151567_E ? true
    ...
    {
        int var6 = this.func_149804_e(p_149810_1_, p_149810_2_, p_149810_3_,
                p_149810_4_);
            ...
            int p_149809_3_, int p_149809_4_)
    {
        ...
        return var5 == this.blockMaterial ? false
                : (var5 == Material.field_151587_i ? false : !this
            ...
            int p_149726_3_, int p_149726_4_)
    {
        ...
        if (p_149726_1_.getBlock(p_149726_2_, p_149726_3_, p_149726_4_) == this)
        {
            p_149726_1_.scheduleBlockUpdate(p_149726_2_, p_149726_3_,
                    p_149726_4_, this, this.func_149738_a(p_149726_1_));
        }
    }
