...
public class BlockTripWireHook extends Block
{
    ...
    {
        this.func_150136_a(p_149714_1_, p_149714_2_, p_149714_3_, p_149714_4_,
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        if (p_149695_5_ != this)
        {
            if (this.func_150137_e(p_149695_1_, p_149695_2_, p_149695_3_,
                    p_149695_4_))
            {
                int var6 = p_149695_1_.getBlockMetadata(p_149695_2_,
            ...
            int p_150136_9_)
    {
        ...
        boolean var14 = false;
        boolean var15 = !World.doesBlockHaveSolidTopSurface(p_150136_1_,
            ...
            else
            {
                ...
                if (var20 == p_150136_8_)
                {
                    p_150136_1_.scheduleBlockUpdate(p_150136_2_, p_150136_3_,
                            p_150136_4_, this, this.func_149738_a(p_150136_1_));
                    var13 &= var25;
                }
            }
        }
        ...
        if (var18 > 0)
        {
            ...
            p_150136_1_.setBlockMetadata(var21, p_150136_3_, var22, var28
                    | var20, 3);
            this.func_150134_a(p_150136_1_, var21, p_150136_3_, var22, var28);
            this.func_150135_a(p_150136_1_, var21, p_150136_3_, var22, var13,
                    var14, var11, var12);
        }

        this.func_150135_a(p_150136_1_, p_150136_2_, p_150136_3_, p_150136_4_,
                var13, var14, var11, var12);

        if (!p_150136_5_)
        {
            p_150136_1_.setBlockMetadata(p_150136_2_, p_150136_3_, p_150136_4_,
                    p_150136_6_, 3);

            if (p_150136_7_)
            {
                this.func_150134_a(p_150136_1_, p_150136_2_, p_150136_3_,
                        p_150136_4_, var10);
            }
        }
        ...
        if (var11 != var13)
        {
            for (var21 = 1; var21 < var18; ++var21)
            {
                ...
                if (var24 >= 0)
                {
                    ...
                    p_150136_1_.setBlockMetadata(var22, p_150136_3_, var28,
                            var24, 3);
                }
            }
        }
    ...
    {
        this.func_150136_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_,
            ...
            boolean p_150135_6_, boolean p_150135_7_, boolean p_150135_8_)
    {
        ...
        {
            p_150135_1_.playSoundEffect((double)p_150135_2_ + 0.5D,
                    (double)p_150135_3_ + 0.1D, (double)p_150135_4_ + 0.5D,
    ...
    {
        if (!this.canPlaceBlockAt(p_150137_1_, p_150137_2_, p_150137_3_,
                p_150137_4_))
        {
            this.dropBlockAsItem(p_150137_1_, p_150137_2_, p_150137_3_,
                    p_150137_4_, p_150137_1_.getBlockMetadata(p_150137_2_,
                            p_150137_3_, p_150137_4_), 0);
            ...
            int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        ...
        if (var7 || var8)
        {
            this.func_150136_a(p_149749_1_, p_149749_2_, p_149749_3_,
                    p_149749_4_, true, p_149749_6_, false, -1, 0);
        }
