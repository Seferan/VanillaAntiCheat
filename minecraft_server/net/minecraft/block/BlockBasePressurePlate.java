...
public abstract class BlockBasePressurePlate extends Block
{
    ...
    {
        this.func_150063_b(p_149719_1_.getBlockMetadata(p_149719_2_,
    ...
    protected void func_150063_b(int p_150063_1_)
    {
        ...
        if (var2)
        {
            this.setBlockBounds(var3, 0.0F, var3, 1.0F - var3, 0.03125F,
                    1.0F - var3);
        }
        else
        {
            this.setBlockBounds(var3, 0.0F, var3, 1.0F - var3, 0.0625F,
                    1.0F - var3);
        }
    }
            ...
            int p_149674_4_, Random p_149674_5_)
    {
        ...
        {
            int var6 = this.func_150060_c(p_149674_1_.getBlockMetadata(
                    p_149674_2_, p_149674_3_, p_149674_4_));

            if (var6 > 0)
            {
                this.func_150062_a(p_149674_1_, p_149674_2_, p_149674_3_,
                        p_149674_4_, var6);
            }
        }
    }
            ...
            int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        ...
        {
            int var6 = this.func_150060_c(p_149670_1_.getBlockMetadata(
                    p_149670_2_, p_149670_3_, p_149670_4_));

            if (var6 == 0)
            {
                this.func_150062_a(p_149670_1_, p_149670_2_, p_149670_3_,
                        p_149670_4_, var6);
            }
        }
    }
    ...
    {
        int var6 = this.func_150065_e(p_150062_1_, p_150062_2_, p_150062_3_,
                p_150062_4_);
        ...
        if (p_150062_5_ != var6)
        {
            p_150062_1_.setBlockMetadata(p_150062_2_, p_150062_3_, p_150062_4_,
                    this.func_150066_d(var6), 2);
            this.func_150064_a_(p_150062_1_, p_150062_2_, p_150062_3_,
                    p_150062_4_);
        ...
        if (!var8 && var7)
        {
            p_150062_1_.playSoundEffect((double)p_150062_2_ + 0.5D,
                    (double)p_150062_3_ + 0.1D, (double)p_150062_4_ + 0.5D,
        ...
        if (var8)
        {
            p_150062_1_.scheduleBlockUpdate(p_150062_2_, p_150062_3_,
                    p_150062_4_, this, this.func_149738_a(p_150062_1_));
        }
    }
            ...
            int p_150061_3_)
    {
        ...
        return AxisAlignedBB.getAABBPool().getAABB(
                (double)((float)p_150061_1_ + var4), (double)p_150061_2_,
                (double)((float)p_150061_3_ + var4),
                (double)((float)(p_150061_1_ + 1) - var4),
                (double)p_150061_2_ + 0.25D,
                (double)((float)(p_150061_3_ + 1) - var4));
    }
            ...
            int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        ...
        {
            this.func_150064_a_(p_149749_1_, p_149749_2_, p_149749_3_,
                    p_149749_4_);
        }
    ...
    {
        return this.func_150060_c(p_149709_1_.getBlockMetadata(p_149709_2_,
    ...
    {
        return p_149748_5_ == 1 ? this.func_150060_c(p_149748_1_
                .getBlockMetadata(p_149748_2_, p_149748_3_, p_149748_4_)) : 0;
    }
    ...
    protected abstract int func_150065_e(World var1, int var2, int var3,
            int var4);
