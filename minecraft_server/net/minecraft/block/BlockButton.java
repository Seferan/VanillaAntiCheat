...
public abstract class BlockButton extends Block
{
            ...
            int p_149660_9_)
    {
        ...
        {
            var10 = this.func_150045_e(p_149660_1_, p_149660_2_, p_149660_3_,
                    p_149660_4_);
        }
    ...
    {
        if (this.func_150044_m(p_149695_1_, p_149695_2_, p_149695_3_,
                p_149695_4_))
        {
    ...
    {
        if (!this.canPlaceBlockAt(p_150044_1_, p_150044_2_, p_150044_3_,
                p_150044_4_))
        {
            this.dropBlockAsItem(p_150044_1_, p_150044_2_, p_150044_3_,
                    p_150044_4_, p_150044_1_.getBlockMetadata(p_150044_2_,
                            p_150044_3_, p_150044_4_), 0);
    ...
    private void func_150043_b(int p_150043_1_)
    {
        ...
        if (var2 == 1)
        {
            this.setBlockBounds(0.0F, var4, 0.5F - var6, var7, var5,
                    0.5F + var6);
        }
        else if (var2 == 2)
        {
            this.setBlockBounds(1.0F - var7, var4, 0.5F - var6, 1.0F, var5,
                    0.5F + var6);
        }
        else if (var2 == 3)
        {
            this.setBlockBounds(0.5F - var6, var4, 0.0F, 0.5F + var6, var5,
                    var7);
        }
        else if (var2 == 4)
        {
            this.setBlockBounds(0.5F - var6, var4, 1.0F - var7, 0.5F + var6,
                    var5, 1.0F);
        }
    }
            ...
            float p_149727_9_)
    {
        ...
        else
        {
            ...
            p_149727_1_.playSoundEffect((double)p_149727_2_ + 0.5D,
                    (double)p_149727_3_ + 0.5D, (double)p_149727_4_ + 0.5D,
                    "random.click", 0.3F, 0.6F);
            this.func_150042_a(p_149727_1_, p_149727_2_, p_149727_3_,
                    p_149727_4_, var11);
            p_149727_1_.scheduleBlockUpdate(p_149727_2_, p_149727_3_,
                    p_149727_4_, this, this.func_149738_a(p_149727_1_));
            return true;
        }
    }
            ...
            int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        if ((p_149749_6_ & 8) > 0)
        {
            ...
            this.func_150042_a(p_149749_1_, p_149749_2_, p_149749_3_,
                    p_149749_4_, var7);
        }
    ...
    {
        int var6 = p_149748_1_.getBlockMetadata(p_149748_2_, p_149748_3_,
                p_149748_4_);
            ...
            int p_149674_4_, Random p_149674_5_)
    {
        if (!p_149674_1_.isClient)
        {
            ...
            if ((var6 & 8) != 0)
            {
                ...
                {
                    this.func_150046_n(p_149674_1_, p_149674_2_, p_149674_3_,
                            p_149674_4_);
                }
                else
                {
                    p_149674_1_.setBlockMetadata(p_149674_2_, p_149674_3_,
                            p_149674_4_, var6 & 7, 3);
                    int var7 = var6 & 7;
                    this.func_150042_a(p_149674_1_, p_149674_2_, p_149674_3_,
                            p_149674_4_, var7);
                    p_149674_1_.playSoundEffect((double)p_149674_2_ + 0.5D,
                            (double)p_149674_3_ + 0.5D,
                            (double)p_149674_4_ + 0.5D, "random.click", 0.3F,
                            0.5F);
        ...
        if (!p_149670_1_.isClient)
        {
            if (this.field_150047_a)
            {
                if ((p_149670_1_.getBlockMetadata(p_149670_2_, p_149670_3_,
                        p_149670_4_) & 8) == 0)
                {
                    this.func_150046_n(p_149670_1_, p_149670_2_, p_149670_3_,
                            p_149670_4_);
                }
            }
        }
    ...
    {
        int var5 = p_150046_1_.getBlockMetadata(p_150046_2_, p_150046_3_,
                p_150046_4_);
        int var6 = var5 & 7;
        ...
        List var9 = p_150046_1_.getEntitiesWithinAABB(
                ...
                AxisAlignedBB.getAABBPool().getAABB(
                        (double)p_150046_2_ + this.minX,
                        (double)p_150046_3_ + this.minY,
                        (double)p_150046_4_ + this.minZ,
                        (double)p_150046_2_ + this.maxX,
                        (double)p_150046_3_ + this.maxY,
                        (double)p_150046_4_ + this.maxZ));
        boolean var8 = !var9.isEmpty();

        if (var8 && !var7)
        {
            p_150046_1_.setBlockMetadata(p_150046_2_, p_150046_3_, p_150046_4_,
                    var6 | 8, 3);
            this.func_150042_a(p_150046_1_, p_150046_2_, p_150046_3_,
                    p_150046_4_, var6);
            p_150046_1_.markBlockRangeForRenderUpdate(p_150046_2_, p_150046_3_,
                    p_150046_4_, p_150046_2_, p_150046_3_, p_150046_4_);
            p_150046_1_.playSoundEffect((double)p_150046_2_ + 0.5D,
                    (double)p_150046_3_ + 0.5D, (double)p_150046_4_ + 0.5D,
                    "random.click", 0.3F, 0.6F);
        }
        ...
        if (var8)
        {
            p_150046_1_.scheduleBlockUpdate(p_150046_2_, p_150046_3_,
                    p_150046_4_, this, this.func_149738_a(p_150046_1_));
        }
    }
