...
public class BlockFlowerPot extends BlockContainer
{
            ...
            float p_149727_9_)
    {
        ...
        {
            if (p_149727_1_.getBlockMetadata(p_149727_2_, p_149727_3_,
                    p_149727_4_) != 0)
            {
                return false;
            }
            ...
            {
                TileEntityFlowerPot var11 = this.func_149929_e(p_149727_1_,
                ...
                if (var11 != null)
                {
                    ...
                    else
                    {
                        ...
                        if (!p_149727_1_.setBlockMetadata(p_149727_2_,
                                p_149727_3_, p_149727_4_,
                                var10.getItemDamage(), 2))
                        {
                            p_149727_1_.markBlockForUpdate(p_149727_2_,
                                    p_149727_3_, p_149727_4_);
                        }
    ...
    {
        TileEntityFlowerPot var5 = this.func_149929_e(p_149643_1_, p_149643_2_,
            ...
            float p_149690_6_, int p_149690_7_)
    {
        ...
        TileEntityFlowerPot var8 = this.func_149929_e(p_149690_1_, p_149690_2_,
        ...
        if (var8 != null && var8.func_145965_a() != null)
        {
            this.dropBlockAsItem_do(
                    ...
                    p_149690_3_,
                    p_149690_4_,
                    new ItemStack(var8.func_145965_a(), 1, var8.func_145966_b()));
        }
    }
    ...
    {
        TileEntityFlowerPot var7 = this.func_149929_e(p_149749_1_, p_149749_2_,
            ...
            EntityPlayer p_149681_6_)
    {
        ...
        {
            TileEntityFlowerPot var7 = this.func_149929_e(p_149681_1_,
    ...
    {
        TileEntity var5 = p_149929_1_.getTileEntity(p_149929_2_, p_149929_3_,
                p_149929_4_);
