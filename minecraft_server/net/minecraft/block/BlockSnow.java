...
public class BlockSnow extends Block
{
    ...
    {
        int var5 = p_149668_1_.getBlockMetadata(p_149668_2_, p_149668_3_,
                p_149668_4_) & 7;
        float var6 = 0.125F;
        return AxisAlignedBB.getAABBPool().getAABB(
                ...
                (double)((float)p_149668_3_ + (float)var5 * var6),
    ...
    {
        this.func_150154_b(p_149719_1_.getBlockMetadata(p_149719_2_,
    ...
    {
        Block var5 = p_149742_1_.getBlock(p_149742_2_, p_149742_3_ - 1,
                p_149742_4_);
        return var5 != Blocks.ice && var5 != Blocks.packed_ice ? (var5
                .getMaterial() == Material.field_151584_j ? true
                : (var5 == this
                        && (p_149742_1_.getBlockMetadata(p_149742_2_,
                                p_149742_3_ - 1, p_149742_4_) & 7) == 7 ? true
                        : var5.isOpaqueCube()
            ...
            int p_150155_3_, int p_150155_4_)
    {
        if (!this.canPlaceBlockAt(p_150155_1_, p_150155_2_, p_150155_3_,
                p_150155_4_))
        {
            this.dropBlockAsItem(p_150155_1_, p_150155_2_, p_150155_3_,
                    p_150155_4_, p_150155_1_.getBlockMetadata(p_150155_2_,
                            p_150155_3_, p_150155_4_), 0);
            ...
            int p_149636_3_, int p_149636_4_, int p_149636_5_, int p_149636_6_)
    {
        ...
        this.dropBlockAsItem_do(p_149636_1_, p_149636_3_, p_149636_4_,
                p_149636_5_, new ItemStack(Items.snowball, var7 + 1, 0));
