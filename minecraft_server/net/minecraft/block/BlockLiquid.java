...
public abstract class BlockLiquid extends Block
{
    ...
    protected BlockLiquid(Material p_i45413_1_)
    {
        ...
        float var2 = 0.0F;
        float var3 = 0.0F;
        this.setBlockBounds(0.0F + var3, 0.0F + var2, 0.0F + var3, 1.0F + var3,
                1.0F + var2, 1.0F + var3);
            ...
            int p_149804_3_, int p_149804_4_)
    {
        return p_149804_1_.getBlock(p_149804_2_, p_149804_3_, p_149804_4_)
                .getMaterial() == this.blockMaterial ? p_149804_1_
                .getBlockMetadata(p_149804_2_, p_149804_3_, p_149804_4_) : -1;
    }
    ...
    {
        Material var6 = p_149747_1_.getBlock(p_149747_2_, p_149747_3_,
                p_149747_4_).getMaterial();
        return var6 == this.blockMaterial ? false : (p_149747_5_ == 1 ? true
                : (var6 == Material.field_151588_w ? false : super
                        .isBlockSolid(p_149747_1_, p_149747_2_, p_149747_3_,
                                p_149747_4_, p_149747_5_)));
    }
    ...
    {
        Vec3 var5 = p_149800_1_.getWorldVec3Pool().getVecFromPool(0.0D, 0.0D,
                0.0D);
        int var6 = this.func_149798_e(p_149800_1_, p_149800_2_, p_149800_3_,
                p_149800_4_);
        ...
        for (int var7 = 0; var7 < 4; ++var7)
        {
            ...
            int var11 = this.func_149798_e(p_149800_1_, var8, p_149800_3_,
                    var10);
            int var12;
            ...
            if (var11 < 0)
            {
                ...
                {
                    var11 = this.func_149798_e(p_149800_1_, var8,
                            p_149800_3_ - 1, var10);
        ...
        if (p_149800_1_.getBlockMetadata(p_149800_2_, p_149800_3_, p_149800_4_) >= 8)
        {
            ...
            if (var13
                    || this.isBlockSolid(p_149800_1_, p_149800_2_, p_149800_3_,
                            p_149800_4_ - 1, 2))
            {
                var13 = true;
            }
            ...
            if (var13
                    || this.isBlockSolid(p_149800_1_, p_149800_2_ - 1,
                            p_149800_3_, p_149800_4_, 4))
            {
                var13 = true;
            }
            ...
            if (var13
                    || this.isBlockSolid(p_149800_1_, p_149800_2_ + 1,
                            p_149800_3_, p_149800_4_, 5))
            {
                var13 = true;
            }

            if (var13
                    || this.isBlockSolid(p_149800_1_, p_149800_2_,
                            p_149800_3_ + 1, p_149800_4_ - 1, 2))
            {
                var13 = true;
            }
    ...
    public void velocityToAddToEntity(World p_149640_1_, int p_149640_2_,
            ...
            Vec3 p_149640_6_)
    {
        Vec3 var7 = this.func_149800_f(p_149640_1_, p_149640_2_, p_149640_3_,
                p_149640_4_);
    ...
    {
        return this.blockMaterial == Material.field_151586_h ? 5
                : (this.blockMaterial == Material.field_151587_i ? (p_149738_1_.provider.hasNoSky ? 10
                        : 30)
                        : 0);
    }
            ...
            if (this.blockMaterial == Material.field_151587_i)
            {
                ...
                if (var5
                        || p_149805_1_.getBlock(p_149805_2_, p_149805_3_,
                                p_149805_4_ - 1).getMaterial() == Material.field_151586_h)
                {
                    var5 = true;
                }
                ...
                if (var5
                        || p_149805_1_.getBlock(p_149805_2_ - 1, p_149805_3_,
                                p_149805_4_).getMaterial() == Material.field_151586_h)
                {
                    var5 = true;
                }
                ...
                if (var5)
                {
                    int var6 = p_149805_1_.getBlockMetadata(p_149805_2_,
                    ...
                    this.func_149799_m(p_149805_1_, p_149805_2_, p_149805_3_,
                            p_149805_4_);
                }
            }
        }
    ...
    {
        p_149799_1_.playSoundEffect((double)((float)p_149799_2_ + 0.5F),
