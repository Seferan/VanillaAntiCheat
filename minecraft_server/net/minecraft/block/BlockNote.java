...
public class BlockNote extends BlockContainer
{
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityNote var7 = (TileEntityNote)p_149695_1_.getTileEntity(
            ...
            float p_149727_9_)
    {
        ...
        {
            TileEntityNote var10 = (TileEntityNote)p_149727_1_.getTileEntity(
            ...
            int p_149699_3_, int p_149699_4_, EntityPlayer p_149699_5_)
    {
        ...
        {
            TileEntityNote var6 = (TileEntityNote)p_149699_1_.getTileEntity(
                    p_149699_2_, p_149699_3_, p_149699_4_);
            ...
            int p_149696_3_, int p_149696_4_, int p_149696_5_, int p_149696_6_)
    {
        ...
        p_149696_1_.playSoundEffect((double)p_149696_2_ + 0.5D,
                (double)p_149696_3_ + 0.5D, (double)p_149696_4_ + 0.5D, "note."
                        + var8, 3.0F, var7);
        p_149696_1_.spawnParticle("note", (double)p_149696_2_ + 0.5D,
                (double)p_149696_3_ + 1.2D, (double)p_149696_4_ + 0.5D,
                (double)p_149696_6_ / 24.0D, 0.0D, 0.0D);
        return true;
    }
}
