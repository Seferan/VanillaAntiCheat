...
public class BlockChest extends BlockContainer
{
            ...
            int p_149719_2_, int p_149719_3_, int p_149719_4_)
    {
        if (p_149719_1_.getBlock(p_149719_2_, p_149719_3_, p_149719_4_ - 1) == this)
        {
            this.setBlockBounds(0.0625F, 0.0F, 0.0F, 0.9375F, 0.875F, 0.9375F);
                ...
                .getBlock(p_149719_2_, p_149719_3_, p_149719_4_ + 1) == this)
        {
            this.setBlockBounds(0.0625F, 0.0F, 0.0625F, 0.9375F, 0.875F, 1.0F);
        }
        else if (p_149719_1_
                .getBlock(p_149719_2_ - 1, p_149719_3_, p_149719_4_) == this)
        {
            ...
            int p_149726_3_, int p_149726_4_)
    {
        ...
        Block var5 = p_149726_1_.getBlock(p_149726_2_, p_149726_3_,
                p_149726_4_ - 1);
        Block var6 = p_149726_1_.getBlock(p_149726_2_, p_149726_3_,
                p_149726_4_ + 1);
        Block var7 = p_149726_1_.getBlock(p_149726_2_ - 1, p_149726_3_,
                p_149726_4_);
        Block var8 = p_149726_1_.getBlock(p_149726_2_ + 1, p_149726_3_,
                p_149726_4_);

        if (var5 == this)
        {
            this.func_149954_e(p_149726_1_, p_149726_2_, p_149726_3_,
                    p_149726_4_ - 1);
        }
        ...
        if (var7 == this)
        {
            this.func_149954_e(p_149726_1_, p_149726_2_ - 1, p_149726_3_,
                    p_149726_4_);
        }
    ...
    {
        Block var7 = p_149689_1_.getBlock(p_149689_2_, p_149689_3_,
                p_149689_4_ - 1);
        Block var8 = p_149689_1_.getBlock(p_149689_2_, p_149689_3_,
                p_149689_4_ + 1);
        Block var9 = p_149689_1_.getBlock(p_149689_2_ - 1, p_149689_3_,
                p_149689_4_);
        Block var10 = p_149689_1_.getBlock(p_149689_2_ + 1, p_149689_3_,
                p_149689_4_);
        byte var11 = 0;
        ...
        else
        {
            if ((var7 == this || var8 == this) && (var11 == 4 || var11 == 5))
            {
                if (var7 == this)
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_,
                            p_149689_4_ - 1, var11, 3);
                }
                else
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_,
            ...
            if ((var9 == this || var10 == this) && (var11 == 2 || var11 == 3))
            {
                if (var9 == this)
                {
                    p_149689_1_.setBlockMetadata(p_149689_2_ - 1, p_149689_3_,
                            p_149689_4_, var11, 3);
                }
                else
                {
            ...
            int p_149954_3_, int p_149954_4_)
    {
        ...
        {
            Block var5 = p_149954_1_.getBlock(p_149954_2_, p_149954_3_,
                    p_149954_4_ - 1);
            Block var6 = p_149954_1_.getBlock(p_149954_2_, p_149954_3_,
                    p_149954_4_ + 1);
            Block var7 = p_149954_1_.getBlock(p_149954_2_ - 1, p_149954_3_,
                    p_149954_4_);
            Block var8 = p_149954_1_.getBlock(p_149954_2_ + 1, p_149954_3_,
                    p_149954_4_);
            boolean var9 = true;
            int var10;
            Block var11;
            ...
            p_149954_1_.setBlockMetadata(p_149954_2_, p_149954_3_, p_149954_4_,
                    var15, 3);
        }
    }
            ...
            int p_149742_3_, int p_149742_4_)
    {
        ...
        return var5 > 1 ? false : (this.func_149952_n(p_149742_1_,
                p_149742_2_ - 1, p_149742_3_, p_149742_4_) ? false : (this
                .func_149952_n(p_149742_1_, p_149742_2_ + 1, p_149742_3_,
                        p_149742_4_) ? false : (this.func_149952_n(p_149742_1_,
                p_149742_2_, p_149742_3_, p_149742_4_ - 1) ? false : !this
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        TileEntityChest var6 = (TileEntityChest)p_149695_1_.getTileEntity(
    ...
    {
        TileEntityChest var7 = (TileEntityChest)p_149749_1_.getTileEntity(
                            ...
                            .spawnEntityInWorld(var14))
                    {
                        ...
                        var14 = new EntityItem(p_149749_1_,
                                ...
                                new ItemStack(var9.getItem(), var13,
                                        var9.getItemDamage()));
                        float var15 = 0.05F;
                        var14.motionX = (double)((float)this.field_149955_b
                                .nextGaussian() * var15);
                        var14.motionY = (double)((float)this.field_149955_b
                                .nextGaussian() * var15 + 0.2F);
                        var14.motionZ = (double)((float)this.field_149955_b
                                .nextGaussian() * var15);
            ...
            float p_149727_9_)
    {
        ...
        {
            IInventory var10 = this.func_149951_m(p_149727_1_, p_149727_2_,
    ...
    {
        Object var5 = (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_,
        ...
        else
        {
            ...
            {
                var5 = new InventoryLargeChest("container.chestDouble",
                        (TileEntityChest)p_149951_1_.getTileEntity(p_149951_2_,
                                p_149951_3_, p_149951_4_ - 1), (IInventory)var5);
            }
            ...
            int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int var6 = ((TileEntityChest)p_149709_1_.getTileEntity(p_149709_2_,
                    p_149709_3_, p_149709_4_)).field_145987_o;
    ...
    {
        return p_149748_5_ == 1 ? this.isProvidingWeakPower(p_149748_1_,
    ...
    {
        Iterator var4 = p_149953_0_.getEntitiesWithinAABB(
                EntityOcelot.class,
    ...
    {
        return Container.calcRedstoneFromInventory(this.func_149951_m(
                p_149736_1_, p_149736_2_, p_149736_3_, p_149736_4_));
    }
}
