...
public class BlockCauldron extends Block
{
    ...
    {
        int var6 = func_150027_b(p_149670_1_.getBlockMetadata(p_149670_2_,
                ...
                && p_149670_5_.boundingBox.minY <= (double)var7)
        {
            ...
            this.func_150024_a(p_149670_1_, p_149670_2_, p_149670_3_,
                    p_149670_4_, var6 - 1);
        }
    }
            ...
            float p_149727_9_)
    {
        ...
        else
        {
            ...
            {
                int var11 = p_149727_1_.getBlockMetadata(p_149727_2_,
                ...
                if (var10.getItem() == Items.water_bucket)
                {
                    if (var12 < 3)
                    {
                        ...
                        this.func_150024_a(p_149727_1_, p_149727_2_,
                                p_149727_3_, p_149727_4_, 3);
                    }
                                        ...
                                        .addItemStackToInventory(var13))
                                {
                                    p_149727_1_
                                            .spawnEntityInWorld(new EntityItem(
                                                    p_149727_1_,
                                                    (double)p_149727_2_ + 0.5D,
                                                    (double)p_149727_3_ + 1.5D,
                                                    (double)p_149727_4_ + 0.5D,
                                                    var13));
                                }
    ...
    {
        p_150024_1_.setBlockMetadata(p_150024_2_, p_150024_3_, p_150024_4_,
            ...
            int p_149639_3_, int p_149639_4_)
    {
        ...
        {
            int var5 = p_149639_1_.getBlockMetadata(p_149639_2_, p_149639_3_,
                    p_149639_4_);

            if (var5 < 3)
            {
                p_149639_1_.setBlockMetadata(p_149639_2_, p_149639_3_,
                        p_149639_4_, var5 + 1, 2);
            }
        }
    }
    ...
    {
        int var6 = p_149736_1_.getBlockMetadata(p_149736_2_, p_149736_3_,
                p_149736_4_);
