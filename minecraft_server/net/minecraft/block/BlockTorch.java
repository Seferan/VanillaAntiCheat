...
public class BlockTorch extends Block
{
            ...
            int p_150107_3_, int p_150107_4_)
    {
        ...
        {
            Block var5 = p_150107_1_.getBlock(p_150107_2_, p_150107_3_,
                    p_150107_4_);
            ...
            int p_149742_3_, int p_149742_4_)
    {
        return p_149742_1_.isBlockNormalCubeDefault(p_149742_2_ - 1,
                ...
                .isBlockNormalCubeDefault(p_149742_2_, p_149742_3_,
                        p_149742_4_ + 1, true) ? true : this.func_150107_m(
            ...
            int p_149726_3_, int p_149726_4_)
    {
        if (p_149726_1_.getBlockMetadata(p_149726_2_, p_149726_3_, p_149726_4_) == 0)
        {
            ...
            {
                p_149726_1_.setBlockMetadata(p_149726_2_, p_149726_3_,
                        p_149726_4_, 1, 2);
            }
            ...
            int p_150108_3_, int p_150108_4_, Block p_150108_5_)
    {
        if (this.func_150109_e(p_150108_1_, p_150108_2_, p_150108_3_,
                p_150108_4_))
        {
            int var6 = p_150108_1_.getBlockMetadata(p_150108_2_, p_150108_3_,
                    p_150108_4_);
            boolean var7 = false;
    ...
    {
        int var7 = p_149731_1_.getBlockMetadata(p_149731_2_, p_149731_3_,
                p_149731_4_) & 7;
        float var8 = 0.15F;
