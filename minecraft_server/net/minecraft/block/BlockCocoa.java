...
public class BlockCocoa extends BlockDirectional implements IGrowable
{
    ...
    {
        if (!this.canBlockStay(p_149674_1_, p_149674_2_, p_149674_3_,
                p_149674_4_))
        {
            this.dropBlockAsItem(p_149674_1_, p_149674_2_, p_149674_3_,
                    p_149674_4_, p_149674_1_.getBlockMetadata(p_149674_2_,
                            p_149674_3_, p_149674_4_), 0);
        ...
        else if (p_149674_1_.rand.nextInt(5) == 0)
        {
            ...
            if (var7 < 2)
            {
                ...
                p_149674_1_.setBlockMetadata(p_149674_2_, p_149674_3_,
                        p_149674_4_, var7 << 2 | func_149895_l(var6), 2);
            }
        }
    }
    ...
    {
        int var5 = func_149895_l(p_149718_1_.getBlockMetadata(p_149718_2_,
                p_149718_3_, p_149718_4_));
        p_149718_2_ += Direction.offsetX[var5];
        p_149718_4_ += Direction.offsetZ[var5];
        Block var6 = p_149718_1_
                .getBlock(p_149718_2_, p_149718_3_, p_149718_4_);
            ...
            int p_149719_2_, int p_149719_3_, int p_149719_4_)
    {
        ...
        {
        case 0:
            this.setBlockBounds((8.0F - var10) / 16.0F,
                    (12.0F - (float)var9) / 16.0F,
                    (15.0F - (float)var8) / 16.0F, (8.0F + var10) / 16.0F,
                    0.75F, 0.9375F);
            break;

        case 1:
            this.setBlockBounds(0.0625F, (12.0F - (float)var9) / 16.0F,
                    (8.0F - var10) / 16.0F, (1.0F + (float)var8) / 16.0F,
                    0.75F, (8.0F + var10) / 16.0F);
            break;

        case 2:
            this.setBlockBounds((8.0F - var10) / 16.0F,
                    (12.0F - (float)var9) / 16.0F, 0.0625F,
                    (8.0F + var10) / 16.0F, 0.75F, (1.0F + (float)var8) / 16.0F);
            break;

        case 3:
            this.setBlockBounds((15.0F - (float)var8) / 16.0F,
                    (12.0F - (float)var9) / 16.0F, (8.0F - var10) / 16.0F,
    ...
    {
        int var7 = ((MathHelper
                .floor_double((double)(p_149689_5_.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3) + 0) % 4;
    ...
    {
        int var6 = p_149851_1_.getBlockMetadata(p_149851_2_, p_149851_3_,
                p_149851_4_);
        int var7 = func_149987_c(var6);
        return var7 < 2;
    }
    ...
    {
        int var6 = p_149853_1_.getBlockMetadata(p_149853_3_, p_149853_4_,
                p_149853_5_);
        int var7 = BlockDirectional.func_149895_l(var6);
        int var8 = func_149987_c(var6);
        ++var8;
        p_149853_1_.setBlockMetadata(p_149853_3_, p_149853_4_, p_149853_5_,
                var8 << 2 | var7, 2);
    }
}
