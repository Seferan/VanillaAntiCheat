        ...
        ITileEntityProvider
{
    ...
    {
        return this.func_149971_e(p_149904_1_, p_149904_2_, p_149904_3_,
                p_149904_4_).func_145996_a();
    }

    private int func_149970_j(World p_149970_1_, int p_149970_2_,
            int p_149970_3_, int p_149970_4_, int p_149970_5_)
    {
        return !this.func_149969_d(p_149970_5_) ? this
                .func_149903_h(p_149970_1_, p_149970_2_, p_149970_3_,
                        p_149970_4_, p_149970_5_) : Math.max(
                this.func_149903_h(p_149970_1_, p_149970_2_, p_149970_3_,
                        p_149970_4_, p_149970_5_)
                        - this.func_149902_h(p_149970_1_, p_149970_2_,
                                p_149970_3_, p_149970_4_, p_149970_5_), 0);
    }
    ...
    {
        int var6 = this.func_149903_h(p_149900_1_, p_149900_2_, p_149900_3_,
        ...
        {
            int var7 = this.func_149902_h(p_149900_1_, p_149900_2_,
            ...
            float p_149727_9_)
    {
        ...
        p_149727_1_.setBlockMetadata(p_149727_2_, p_149727_3_, p_149727_4_,
                var13 | var10 & 3, 2);
        this.func_149972_c(p_149727_1_, p_149727_2_, p_149727_3_, p_149727_4_,
                p_149727_1_.rand);
        return true;
    }
            ...
            int p_149897_3_, int p_149897_4_, Block p_149897_5_)
    {
                ...
                this))
        {
            int var6 = p_149897_1_.getBlockMetadata(p_149897_2_, p_149897_3_,
                    p_149897_4_);
            int var7 = this.func_149970_j(p_149897_1_, p_149897_2_,
                    p_149897_3_, p_149897_4_, var6);
            int var8 = this.func_149971_e(p_149897_1_, p_149897_2_,
                    p_149897_3_, p_149897_4_).func_145996_a();

            if (var7 != var8
                    || this.func_149905_c(var6) != this.func_149900_a(
                            ...
                            var6))
            {
                        ...
                        p_149897_4_, var6))
                {
                    p_149897_1_.func_147454_a(p_149897_2_, p_149897_3_,
                            p_149897_4_, this, this.func_149901_b(0), -1);
                }
                else
                {
                    p_149897_1_.func_147454_a(p_149897_2_, p_149897_3_,
                            p_149897_4_, this, this.func_149901_b(0), 0);
                }
            }
        }
    }
    ...
    {
        int var6 = p_149972_1_.getBlockMetadata(p_149972_2_, p_149972_3_,
                p_149972_4_);
        int var7 = this.func_149970_j(p_149972_1_, p_149972_2_, p_149972_3_,
                p_149972_4_, var6);
        int var8 = this.func_149971_e(p_149972_1_, p_149972_2_, p_149972_3_,
                p_149972_4_).func_145996_a();
        this.func_149971_e(p_149972_1_, p_149972_2_, p_149972_3_, p_149972_4_)
                .func_145995_a(var7);

        if (var8 != var7 || !this.func_149969_d(var6))
        {
            boolean var9 = this.func_149900_a(p_149972_1_, p_149972_2_,
                    p_149972_3_, p_149972_4_, var6);
            boolean var10 = this.field_149914_a || (var6 & 8) != 0;

            if (var10 && !var9)
            {
                p_149972_1_.setBlockMetadata(p_149972_2_, p_149972_3_,
                        p_149972_4_, var6 & -9, 2);
            }
            else if (!var10 && var9)
            {
                p_149972_1_.setBlockMetadata(p_149972_2_, p_149972_3_,
                        p_149972_4_, var6 | 8, 2);
            }

            this.func_149911_e(p_149972_1_, p_149972_2_, p_149972_3_,
                    p_149972_4_);
        }
    }
            ...
            int p_149674_4_, Random p_149674_5_)
    {
        if (this.field_149914_a)
        {
            ...
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_,
                    this.func_149898_i(), var6 | 8, 4);
        }

        this.func_149972_c(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_,
                p_149674_5_);
    }
            ...
            int p_149726_3_, int p_149726_4_)
    {
        ...
        p_149726_1_.setTileEntity(p_149726_2_, p_149726_3_, p_149726_4_,
                this.createNewTileEntity(p_149726_1_, 0));
    }
            ...
            int p_149696_3_, int p_149696_4_, int p_149696_5_, int p_149696_6_)
    {
        ...
        TileEntity var7 = p_149696_1_.getTileEntity(p_149696_2_, p_149696_3_,
                p_149696_4_);
