...
public class BlockReed extends Block
{
    ...
    protected BlockReed()
    {
        ...
        float var1 = 0.375F;
        this.setBlockBounds(0.5F - var1, 0.0F, 0.5F - var1, 0.5F + var1, 1.0F,
                0.5F + var1);
        ...
        return var5 == this ? true
                : (var5 != Blocks.grass && var5 != Blocks.dirt
                        ...
                        : (p_149742_1_.getBlock(p_149742_2_ - 1,
                                p_149742_3_ - 1, p_149742_4_).getMaterial() == Material.field_151586_h ? true
                                : (p_149742_1_.getBlock(p_149742_2_ + 1,
                                        p_149742_3_ - 1, p_149742_4_)
                                        .getMaterial() == Material.field_151586_h ? true
                                        : (p_149742_1_.getBlock(p_149742_2_,
                                                p_149742_3_ - 1,
                                                p_149742_4_ - 1).getMaterial() == Material.field_151586_h ? true
    ...
    {
        if (!this.canBlockStay(p_150170_1_, p_150170_2_, p_150170_3_,
                p_150170_4_))
        {
            this.dropBlockAsItem(p_150170_1_, p_150170_2_, p_150170_3_,
                    p_150170_4_, p_150170_1_.getBlockMetadata(p_150170_2_,
                            p_150170_3_, p_150170_4_), 0);
    ...
    {
        return this.canPlaceBlockAt(p_149718_1_, p_149718_2_, p_149718_3_,
                p_149718_4_);
    }
