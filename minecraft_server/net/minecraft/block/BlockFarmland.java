...
public class BlockFarmland extends Block
{
    ...
    {
        return AxisAlignedBB.getAABBPool().getAABB((double)(p_149668_2_ + 0),
                (double)(p_149668_3_ + 0), (double)(p_149668_4_ + 0),
                (double)(p_149668_2_ + 1), (double)(p_149668_3_ + 1),
    ...
    {
        if (!this.func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_,
                p_149674_4_)
                        ...
                        p_149674_3_ + 1, p_149674_4_))
        {
            ...
            if (var6 > 0)
            {
                p_149674_1_.setBlockMetadata(p_149674_2_, p_149674_3_,
                        p_149674_4_, var6 - 1, 2);
            }
            else if (!this.func_149822_e(p_149674_1_, p_149674_2_, p_149674_3_,
                    p_149674_4_))
            {
        ...
        for (int var6 = p_149822_2_ - var5; var6 <= p_149822_2_ + var5; ++var6)
        {
            for (int var7 = p_149822_4_ - var5; var7 <= p_149822_4_ + var5; ++var7)
            {
                ...
                if (var8 == Blocks.wheat || var8 == Blocks.melon_stem
                        ...
                        || var8 == Blocks.potatoes || var8 == Blocks.carrots) { return true; }
            }
        }
            ...
            int p_149821_3_, int p_149821_4_)
    {
        for (int var5 = p_149821_2_ - 4; var5 <= p_149821_2_ + 4; ++var5)
        {
            for (int var6 = p_149821_3_; var6 <= p_149821_3_ + 1; ++var6)
            {
                ...
                {
                    if (p_149821_1_.getBlock(var5, var6, var7).getMaterial() == Material.field_151586_h) { return true; }
                }
            }
        }
            ...
            int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        Material var6 = p_149695_1_.getBlock(p_149695_2_, p_149695_3_ + 1,
                p_149695_4_).getMaterial();
