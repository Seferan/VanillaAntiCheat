...
public class BlockLever extends Block
{
            ...
            int p_149707_3_, int p_149707_4_, int p_149707_5_)
    {
        return p_149707_5_ == 0
                && p_149707_1_.getBlock(p_149707_2_, p_149707_3_ + 1,
                        p_149707_4_).isNormalCube() ? true
                : (p_149707_5_ == 1
                        && World.doesBlockHaveSolidTopSurface(p_149707_1_,
                                p_149707_2_, p_149707_3_ - 1, p_149707_4_) ? true
                        : (p_149707_5_ == 2
                                && p_149707_1_.getBlock(p_149707_2_,
                                        p_149707_3_, p_149707_4_ + 1)
                                        .isNormalCube() ? true
                                : (p_149707_5_ == 3
                                        && p_149707_1_.getBlock(p_149707_2_,
                                                p_149707_3_, p_149707_4_ - 1)
    ...
    {
        int var7 = p_149689_1_.getBlockMetadata(p_149689_2_, p_149689_3_,
                p_149689_4_);
        int var8 = var7 & 7;
        int var9 = var7 & 8;
        ...
        {
            if ((MathHelper
                    .floor_double((double)(p_149689_5_.rotationYaw * 4.0F / 360.0F) + 0.5D) & 1) == 0)
            {
                p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_,
                        p_149689_4_, 5 | var9, 2);
            }
            else
            {
                p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_,
                        p_149689_4_, 6 | var9, 2);
            }
        }
        else if (var8 == func_149819_b(0))
        {
            ...
            {
                p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_,
                        p_149689_4_, 7 | var9, 2);
            }
            else
            {
                p_149689_1_.setBlockMetadata(p_149689_2_, p_149689_3_,
                        p_149689_4_, 0 | var9, 2);
            }
        }
    }
    ...
    {
        if (this.func_149820_e(p_149695_1_, p_149695_2_, p_149695_3_,
                p_149695_4_))
        {
    ...
    {
        if (!this.canPlaceBlockAt(p_149820_1_, p_149820_2_, p_149820_3_,
                p_149820_4_))
        {
            this.dropBlockAsItem(p_149820_1_, p_149820_2_, p_149820_3_,
                    p_149820_4_, p_149820_1_.getBlockMetadata(p_149820_2_,
                            p_149820_3_, p_149820_4_), 0);
            ...
            int p_149719_2_, int p_149719_3_, int p_149719_4_)
    {
        ...
        else if (var5 != 5 && var5 != 6)
        {
            ...
            {
                var6 = 0.25F;
                this.setBlockBounds(0.5F - var6, 0.4F, 0.5F - var6,
                        0.5F + var6, 1.0F, 0.5F + var6);
            }
        }
        else
        {
            ...
            float p_149727_9_)
    {
        ...
        else
        {
            ...
            p_149727_1_.playSoundEffect((double)p_149727_2_ + 0.5D,
                    ...
                    "random.click", 0.3F, var12 > 0 ? 0.6F : 0.5F);
