...
public class BlockPistonMoving extends BlockContainer
{
    ...
    {
        TileEntity var7 = p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_,
                p_149749_4_);
            ...
            float p_149690_6_, int p_149690_7_)
    {
        ...
        {
            TileEntityPiston var8 = this.func_149963_e(p_149690_1_,
    ...
    {
        TileEntityPiston var5 = this.func_149963_e(p_149668_1_, p_149668_2_,
        ...
        else
        {
            ...
            return this.func_149964_a(p_149668_1_, p_149668_2_, p_149668_3_,
    ...
    {
        TileEntityPiston var5 = this.func_149963_e(p_149719_1_, p_149719_2_,
        ...
        if (var5 != null)
        {
            ...
            if (var6 == this || var6.getMaterial() == Material.air) { return; }
            ...
            this.minX = var6.getBlockBoundsMinX()
                    - (double)((float)Facing.offsetsXForSide[var8] * var7);
            this.minY = var6.getBlockBoundsMinY()
                    - (double)((float)Facing.offsetsYForSide[var8] * var7);
            this.minZ = var6.getBlockBoundsMinZ()
                    - (double)((float)Facing.offsetsZForSide[var8] * var7);
            this.maxX = var6.getBlockBoundsMaxX()
                    - (double)((float)Facing.offsetsXForSide[var8] * var7);
            this.maxY = var6.getBlockBoundsMaxY()
                    - (double)((float)Facing.offsetsYForSide[var8] * var7);
            this.maxZ = var6.getBlockBoundsMaxZ()
                    - (double)((float)Facing.offsetsZForSide[var8] * var7);
        }
    }
            ...
            float p_149964_6_, int p_149964_7_)
    {
        ...
        {
            AxisAlignedBB var8 = p_149964_5_.getCollisionBoundingBoxFromPool(
                    p_149964_1_, p_149964_2_, p_149964_3_, p_149964_4_);
    ...
    {
        TileEntity var5 = p_149963_1_.getTileEntity(p_149963_2_, p_149963_3_,
                p_149963_4_);
