...
public class BlockRailDetector extends BlockRailBase
{
            ...
            int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        ...
        {
            int var6 = p_149670_1_.getBlockMetadata(p_149670_2_, p_149670_3_,
                    p_149670_4_);

            if ((var6 & 8) == 0)
            {
                this.func_150054_a(p_149670_1_, p_149670_2_, p_149670_3_,
                        p_149670_4_, var6);
            }
        }
    }
            ...
            int p_149674_4_, Random p_149674_5_)
    {
        if (!p_149674_1_.isClient)
        {
            ...
            if ((var6 & 8) != 0)
            {
                this.func_150054_a(p_149674_1_, p_149674_2_, p_149674_3_,
                        p_149674_4_, var6);
            }
        }
    }
            ...
            int p_150054_3_, int p_150054_4_, int p_150054_5_)
    {
        ...
        boolean var7 = false;
        float var8 = 0.125F;
        List var9 = p_150054_1_.getEntitiesWithinAABB(
                EntityMinecart.class,
                AxisAlignedBB.getAABBPool().getAABB(
                        (double)((float)p_150054_2_ + var8),
                        (double)p_150054_3_,
                        (double)((float)p_150054_4_ + var8),
                        (double)((float)(p_150054_2_ + 1) - var8),
                        (double)((float)(p_150054_3_ + 1) - var8),
                        (double)((float)(p_150054_4_ + 1) - var8)));
        ...
        if (var7 && !var6)
        {
            p_150054_1_.setBlockMetadata(p_150054_2_, p_150054_3_, p_150054_4_,
                    p_150054_5_ | 8, 3);
        ...
        if (var7)
        {
            p_150054_1_.scheduleBlockUpdate(p_150054_2_, p_150054_3_,
                    p_150054_4_, this, this.func_149738_a(p_150054_1_));
        }
            ...
            int p_149736_3_, int p_149736_4_, int p_149736_5_)
    {
        ...
        {
            float var6 = 0.125F;
            List var7 = p_149736_1_.getEntitiesWithinAABB(
                    EntityMinecartCommandBlock.class,
                    AxisAlignedBB.getAABBPool().getAABB(
                            (double)((float)p_149736_2_ + var6),
                            (double)p_149736_3_,
                            (double)((float)p_149736_4_ + var6),
                            (double)((float)(p_149736_2_ + 1) - var6),
                            (double)((float)(p_149736_3_ + 1) - var6),
                            (double)((float)(p_149736_4_ + 1) - var6)));

            if (var7.size() > 0) { return ((EntityMinecartCommandBlock)var7
                    .get(0)).func_145822_e().func_145760_g(); }
            ...
            if (var8.size() > 0) { return Container
                    .calcRedstoneFromInventory((IInventory)var8.get(0)); }
        }
