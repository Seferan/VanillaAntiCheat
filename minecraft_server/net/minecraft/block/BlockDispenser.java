...
{
    public static final IRegistry field_149943_a = new RegistryDefaulted(
            ...
            int p_149938_3_, int p_149938_4_)
    {
        ...
        {
            Block var5 = p_149938_1_.getBlock(p_149938_2_, p_149938_3_,
                    p_149938_4_ - 1);
            Block var6 = p_149938_1_.getBlock(p_149938_2_, p_149938_3_,
                    p_149938_4_ + 1);
            Block var7 = p_149938_1_.getBlock(p_149938_2_ - 1, p_149938_3_,
                    p_149938_4_);
            Block var8 = p_149938_1_.getBlock(p_149938_2_ + 1, p_149938_3_,
                    p_149938_4_);
            byte var9 = 3;
            ...
            p_149938_1_.setBlockMetadata(p_149938_2_, p_149938_3_, p_149938_4_,
                    var9, 2);
        }
    }
            ...
            float p_149727_9_)
    {
        ...
        {
            TileEntityDispenser var10 = (TileEntityDispenser)p_149727_1_
    ...
    {
        BlockSourceImpl var5 = new BlockSourceImpl(p_149941_1_, p_149941_2_,
                p_149941_3_, p_149941_4_);
        TileEntityDispenser var6 = (TileEntityDispenser)var5
                .getBlockTileEntity();
    ...
    {
        return (IBehaviorDispenseItem)field_149943_a.getObject(p_149940_1_
                .getItem());
    }
    ...
    {
        boolean var6 = p_149695_1_.isBlockIndirectlyGettingPowered(p_149695_2_,
        ...
        if (var6 && !var8)
        {
            ...
            p_149695_1_.setBlockMetadata(p_149695_2_, p_149695_3_, p_149695_4_,
                    var7 | 8, 4);
        }
        else if (!var6 && var8)
        {
            ...
            int p_149674_4_, Random p_149674_5_)
    {
        ...
        {
            this.func_149941_e(p_149674_1_, p_149674_2_, p_149674_3_,
                    p_149674_4_);
        }
    }
    ...
    {
        int var7 = BlockPistonBase.func_150071_a(p_149689_1_, p_149689_2_,
                p_149689_3_, p_149689_4_, p_149689_5_);
    ...
    {
        TileEntityDispenser var7 = (TileEntityDispenser)p_149749_1_
            ...
            for (int var8 = 0; var8 < var7.getSizeInventory(); ++var8)
            {
                ...
                if (var9 != null)
                {
                    ...
                    while (var9.stackSize > 0)
                    {
                        ...
                        float var15 = 0.05F;
                        var14.motionX = (double)((float)this.field_149942_b
                                .nextGaussian() * var15);
                        var14.motionY = (double)((float)this.field_149942_b
                                .nextGaussian() * var15 + 0.2F);
                        var14.motionZ = (double)((float)this.field_149942_b
                                .nextGaussian() * var15);
    ...
    public static IPosition func_149939_a(IBlockSource p_149939_0_)
    {
        ...
        double var2 = p_149939_0_.getX() + 0.7D
                * (double)var1.getFrontOffsetX();
        double var4 = p_149939_0_.getY() + 0.7D
                * (double)var1.getFrontOffsetY();
        double var6 = p_149939_0_.getZ() + 0.7D
                * (double)var1.getFrontOffsetZ();
