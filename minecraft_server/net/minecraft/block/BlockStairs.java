...
{
    private static final int[][] field_150150_a = new int[][] { {2, 6}, {3, 7},
            {2, 3}, {6, 7}, {0, 4}, {1, 5}, {0, 1}, {4, 5}};
            ...
            int p_149719_2_, int p_149719_3_, int p_149719_4_)
    {
        ...
        {
            this.setBlockBounds(0.5F * (float)(this.field_150153_O % 2),
    ...
    {
        int var5 = p_150147_1_.getBlockMetadata(p_150147_2_, p_150147_3_,
                p_150147_4_);
    ...
    {
        Block var6 = p_150146_1_
                .getBlock(p_150146_2_, p_150146_3_, p_150146_4_);
    ...
    {
        int var5 = p_150145_1_.getBlockMetadata(p_150145_2_, p_150145_3_,
                p_150145_4_);
        int var6 = var5 & 3;
        float var7 = 0.5F;
        float var8 = 1.0F;
        ...
        if (var6 == 0)
        {
            ...
            if (func_150148_a(var14) && (var5 & 4) == (var15 & 4))
            {
                ...
                if (var16 == 3
                        && !this.func_150146_f(p_150145_1_, p_150145_2_,
        ...
        else if (var6 == 2)
        {
            ...
            if (func_150148_a(var14) && (var5 & 4) == (var15 & 4))
            {
                ...
                if (var16 == 1
                        && !this.func_150146_f(p_150145_1_, p_150145_2_ + 1,
    ...
    {
        int var5 = p_150144_1_.getBlockMetadata(p_150144_2_, p_150144_3_,
                p_150144_4_);
        int var6 = var5 & 3;
        float var7 = 0.5F;
        float var8 = 1.0F;
        ...
        if (var6 == 0)
        {
            ...
            if (func_150148_a(var14) && (var5 & 4) == (var15 & 4))
            {
                ...
                if (var16 == 3
                        && !this.func_150146_f(p_150144_1_, p_150144_2_,
        ...
        else if (var6 == 2)
        {
            ...
            if (func_150148_a(var14) && (var5 & 4) == (var15 & 4))
            {
                ...
                if (var16 == 1
                        && !this.func_150146_f(p_150144_1_, p_150144_2_ - 1,
            ...
            List p_149743_6_, Entity p_149743_7_)
    {
        ...
        boolean var8 = this.func_150145_f(p_149743_1_, p_149743_2_,
                p_149743_3_, p_149743_4_);
        super.addCollisionBoxesToList(p_149743_1_, p_149743_2_, p_149743_3_,
                p_149743_4_, p_149743_5_, p_149743_6_, p_149743_7_);

        if (var8
                && this.func_150144_g(p_149743_1_, p_149743_2_, p_149743_3_,
                        p_149743_4_))
        {
    ...
    {
        this.field_150149_b.onBlockClicked(p_149699_1_, p_149699_2_,
                p_149699_3_, p_149699_4_, p_149699_5_);
    }

    public void onBlockDestroyedByPlayer(World p_149664_1_, int p_149664_2_,
            int p_149664_3_, int p_149664_4_, int p_149664_5_)
    {
        this.field_150149_b.onBlockDestroyedByPlayer(p_149664_1_, p_149664_2_,
    ...
    public void velocityToAddToEntity(World p_149640_1_, int p_149640_2_,
            ...
            Vec3 p_149640_6_)
    {
        this.field_150149_b.velocityToAddToEntity(p_149640_1_, p_149640_2_,
    ...
    {
        return this.field_150149_b.canPlaceBlockAt(p_149742_1_, p_149742_2_,
    ...
    {
        this.onNeighborBlockChange(p_149726_1_, p_149726_2_, p_149726_3_,
                p_149726_4_, Blocks.air);
        this.field_150149_b.onBlockAdded(p_149726_1_, p_149726_2_, p_149726_3_,
                p_149726_4_);
    }
    ...
    {
        this.field_150149_b.breakBlock(p_149749_1_, p_149749_2_, p_149749_3_,
    ...
    {
        this.field_150149_b.onEntityWalking(p_149724_1_, p_149724_2_,
                p_149724_3_, p_149724_4_, p_149724_5_);
    }
    ...
    {
        this.field_150149_b.updateTick(p_149674_1_, p_149674_2_, p_149674_3_,
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_,
            ...
            float p_149727_9_)
    {
        return this.field_150149_b.onBlockActivated(p_149727_1_, p_149727_2_,
    ...
    {
        this.field_150149_b.onBlockDestroyedByExplosion(p_149723_1_,
                p_149723_2_, p_149723_3_, p_149723_4_, p_149723_5_);
    }
            ...
            ItemStack p_149689_6_)
    {
        ...
        int var8 = p_149689_1_.getBlockMetadata(p_149689_2_, p_149689_3_,
                p_149689_4_) & 4;
            ...
            Vec3 p_149731_5_, Vec3 p_149731_6_)
    {
        ...
        int var8 = p_149731_1_.getBlockMetadata(p_149731_2_, p_149731_3_,
                p_149731_4_);
        int var9 = var8 & 3;
